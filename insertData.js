...
const insertCountryGeneralInfo = `
  ...
  "country", "capitalCity", "largestCity", "populationGrowthAnnual", "officialName", "continent", 
"landlockedStatus", "nationalAnthemEnglish", "nationalAnthemNative", "currencyName", 
"currencySymbol", "nationalBird", "nationalColors", "nationalFlower", "nationalSport", 
"nationalAnimal", "demonyms", "drivingSide", "callingCode", "ISO3166Code", 
"internetTLD", "latitude", "longitude", "areaInSqKm", "areaInSqMile", 
"waterPercentage", "officialLanguages", "majorReligion", "majorReligionPercentage", 
"governmentStatus", "totalTimezones", "timezoneNormal", "timezoneSummer", 
"DST", "DSTStart", "DSTEnd", "DSTDuration", "population", 
"age0_14", "age15_64", "age65Plus", "fertilityRate", "mortalityRateFemale", 
"mortalityRateMale", "infantMortalityRate", "topCauseOfDeath", "topCauseOfDeathNumber", 
"lowestCauseOfDeath", "lowestCauseOfDeathNumber", "roadTrafficDeaths", "suicideDeaths", 
"numberOfNewHIVInfections", "prevalenceOfHypertensionPercentage", "adultObesityPercentage", 
"tobaccoConsumptionPercentage", "alcoholConsumptionPercentage", "startOfWeek", 
"unitValueInUSD"
) 
...
const insertCountryStandardInfo = `
    INSERT INTO country_standard_info ("country", "GDPNominal", "GDPPerCapita", "GINI", "inflationOnConsumerPrices", "centralGovernmentDebt", 
"HDI", "humanCapitalIndex", "literacyRate", "lifeExpectancyRatio", "healthyLifeExpectancyRatio", 
"povertyRatio", "unemploymentPercentageOfTotalLabourForce", "grossNationalExpenditure", 
"currentHealthExpenditurePercentage", "researchAndDevelopmentExpenditure", "governmentExpenditureOnEducation", 
"internationalTourismExpenditureUSD", "numberOfInternationalTouristsArrival", "militaryExpenditure", 
"densityOfDoctorsNumber", "densityOfNursesNumber", "densityOfPharmacistsNumber", "hospitalBedsPer1000Peoples", 
"pregnantWomenReceivingPrenatalCare", "agriculturalLand", "forestArea", "CO2Emission", "accessToElectricity", 
"accessToInternet", "annualFreshWaterWithdrawls", "timeRequiredToStartABusinessDays", 
"newBusinessesRegisteredNumber", "newBusinessesRegistrationDensityPer1000People", 
"costOfBusinessStartUpProcedures", "importsOfGoodsAndServicesPercentageOfGDP", 
"fuelImportsPercentageOfMerchandiseImports", "costToImportBorderComplianceUSD", 
"costToImportDocumentryComplianceUSD", "timeToImportBorderComplianceHours", 
"timeToImportDocumentryComplianceHours", "exportsOfGoodsAndServicesPercentageOfGDP", 
"fuelExportsPercentageOfMerchandiseExports", "costToExportBorderComplianceUSD", 
"costToExportDocumentryComplianceUSD", "timeToExportBorderComplianceHours", 
"timeToExportDocumentryComplianceHours", "grossNationalSavings", "taxRevenue", 
"taxesOnExportsPercentageOfTaxRevenue", "taxesOnGoodsAndServicesPercentageOfRevenue", 
"taxesOnInternationalTradePercentageOfRevenue", "timeToPrepareAndPayTaxesHours", 
"customsAndOtherImportDutiesPercentageOfTaxRevenue", "corporateTaxRates", "incomeTaxRates", 
"salesTaxRates", "propertyTaxRates", "currencySymbol"
)
...
"rent1bedroomflatOutsideCityCenter", "rent2bedroomflatOutsideCityCenter", "rent3bedroomflatOutsideCityCenter", 
"mortgageRatesPerMonth", "realEstateAgentsCommissionFees", "homeFurnishing", "electricityCostPerMonth", 
"heatingCostPerMonth", "coolingCostPerMonth", "waterCostPerMonth", "wifiCostPerMonth", 
"mobilePhonePlanCostPerMonth", "cableTVServicePerMonth", "landlinePhoneServicePerMonth", 
"milk1Liter", "water1Liter", "bread500g", "rice1Kg", "eggsDozen", "cheese1Kg", "chickenBreasts1Kg", 
"beef1Kg", "apples1Kg", "bananas1Kg", "oranges1Kg", "tomatoes1Kg", "potatoes1Kg", "lemons1Kg", 
"onions1Kg", "lentils1Kg", "wineMidRangeBottle", "glassOfWine", "domesticBeerHalfLiter", 
"importedBeerHalfLiter", "domesticAlcohol1Liter", "brandedAlcohol1Liter", "mealAtInexpensiveRestaurant", 
"threeCourseMealForTwo", "fastFoodComboMeal", "coffee", "softDrink", "pizza", "takeoutDeliveryMeal", 
"cigarettesPackOf20", "publicTransportPass", "singlePublicTransportTicket", "trainTickets", "airfareDomestic", 
"taxiStartFare", "taxiRatePerKm", "carRentalPerDay", "parkingFeesCityCenterPerHour", 
"parkingFeesOutsideCityCenterPerHour", "fuelPerLiter", "fuelPerGallon", "carInsurance", 
"carMaintenance", "vehicleRegistration", "tollFees", "carLoanInterestRates", "vehiclePurchasePrice", 
"drivingLicenseFees", "doctorsVisit", "specialistsVisit", "dentistsVisit", "eyeExam", 
"prescriptionMedication", "overTheCounterMedication", "healthInsurancePremiums", 
"healthInsuranceDeductibles", "emergencyRoomVisit", "hospitalStayPerNight", "physicalTherapy", 
"mentalHealthCounseling", "vaccinations", "preventiveHealthScreenings", "cosmeticProcedures", 
"opticalGlasses", "contactLenses", "shampooPrice", "toothpastePrice", "haircuts", "hairColoring", 
"manicurePedicureCost", "spaTreatment", "pairOfNikeRunningShoes", "mensDressShirt", "mensSuit", 
"mensJeans", "mensCasualShoes", "mensFormalShoes", "womensDress", "womensJeans", "womensCasualShoes", 
"womensFormalShoes", "winterCoatForAdults", "summerDress", "sweater", "underwearMen", 
"underwearWomen", "socksMen", "socksWomen", "sportsWear", "movieTicket", "theaterTicket", 
"concertTicket", "sportsEventTicket", "gymMembership", "swimmingPoolAccess", "museumEntry", 
"zooEntry", "amusementParkEntry", "bowling", "miniGolf", "videoGames", "streamingServices", 
"outdoorEquipmentRental", "themeParkAnnualPass", "childrensJeans", "childrensSneakers", 
"childrensWinterCoat", "daycareInfant", "daycareToddler", "childcareForSickDays", 
"earlyChildhoodEducationPrograms", "extracurricularActivities", "summerCamp", "preSchool", 
"primarySchoolFees", "secondarySchoolFees", "privateSchoolFees", "universityTuition", 
"universityTuitionPrivate", "afterSchoolActivities", "specialEducationServices", "tutoring", 
"textbooks", "schoolSupplies", "languageClasses", "parentingClasses", "fitnessClass", "musicLessons", 
"danceLessons", "artClasses", "readingMaterials", "educationalSoftware", "averageGrossSalary", 
"averageNetSalary", "minimumWage", "socialSecurityContributions", "pensionContributions", 
"costOfLivingIndex", "medianHouseholdIncome", "averageBonus", "legalConsultationPerHourRate", 
"accountingServicesPerHourRate", "ITSupportServicesPerHourRate", "technicianServicesPerHourRate"
...
const insertUSStateStandardInfo = `
    INSERT INTO us_state_standard_info (
        "state", "population", "HDI", "literacyRate", "lifeExpectancyRatio", "povertyRatio", "employmentRate", 
"GDPNominal", "GDPPerCapita", "GINI", "totalRegisteredPhysicians", "totalRegisteredNurses", 
"availableHospitalBeds", "disabilityPercentage", "populationWithoutHealthInsuranceCoverage", 
"salesTaxRates", "propertyTaxRates", "gasAndFuelTaxRatesPerGallon", "beerTaxPerGallon", 
"incomeTaxRates", "corporateTaxRates", "medianAge", "sexRatioMalesPer100Females", "age60to64", 
"age65to74", "age75to84", "age85AndOver", "medianIncomeDollars", "agricultureForestryFishing", 
"construction", "manufacturing", "wholesaleTrade", "retailTrade", "transportationAndWarehousing", 
"ITAndInformation", "financeAndRealEstate", "educationAndHealthCare", "artsEntertainmentRecreation", 
"publicAdministration", "workFromHome", "meanTravelTimeToWorkMinutes", "privateWageandSalaryWorkers", 
"governmentWorkers", "selfEmployedInNotOwnIncorporatedBusiness", "accessToInternet", 
"accessToElectricity", "forestArea", "agriculturalLand", "highSchoolGraduate", "associateDegreePercentage", 
"bachelorsDegreePercentage", "graduateDegreePercentage", "onlyEnglishSpeakingPercentage", "whiteRace", 
"blackOrAfricanAmericanRace", "americanIndianAndAlaskaNativeRace", "asianRace", 
"hawaiianAndPacificIslanderRace", "twoOrMoreRaces", "hispanicOrLatino", "marriedCoupleHouseholdPercentage", 
"maleHouseholderPercentage", "femaleHouseholderPercentage", "averageFamilySize", "homeOwnershipRate", 
"medianGrossRent", "totalHousingUnits", "marriedNotSeparatedPopulationPercentageMale", 
"marriedNotSeparatedPopulationPercentageFemale", "neverMarriedPopulationPercentageMale", 
"neverMarriedPopulationPercentageFemale", "separatedPopulationPercentageMale", 
"separatedPopulationPercentageFemale", "divorcedPopulationPercentageMale", 
"divorcedPopulationPercentageFemale", "widowedPopulationPercentageMale", "widowedPopulationPercentageFemale"

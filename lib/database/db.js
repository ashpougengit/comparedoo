...
export async function fetchIndicatorInfo(locationType, indicator, tableType) {
    ...
    try {
      ...
      `;
        ...
        // Debug: log the table and column name being checked
        console.log(`Checking column "${indicatorValue}" in table "${tableName}"`);
        ...
        // Special case for 'population' for countries
        ...
        // Special case for 'DST' in states
        ...
        // Return the result for other indicators
        return result.rows.map(row => ({

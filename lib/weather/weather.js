...
const weatherImages = ['clear-sky', 'clouds', 'drizzle', 'drizzle-rain', 'heavy-snow', 'light-rain', 'light-snow', 'mist', 'moderate-rain', 'sand', 'sleet', 'snow', 'sunny', 'thunderstrom', 'tornado', 'very-heavy-rain']

const possibilities = ['haze', 'Broken Clouds', 'Overcast Clouds']
...
const getWeatherImage = (description) => {
  ...
  if (!weatherImage && formattedDescription.includes('haze')) {
    weatherImage = 'mist'
  }

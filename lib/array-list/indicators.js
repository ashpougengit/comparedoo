...
export const indicatorsStandard = ["GDPNominal", "GDPPerCapita", "centralGovernmentDebt", "HDI", "humanCapitalIndex", "literacyRate", "lifeExpectancyRatio", "healthyLifeExpectancyRatio", "povertyRatio", "unemploymentPercentageOfTotalLabourForce", "CO2Emission", "numberOfInternationalTouristsArrival", "accessToElectricity", "accessToInternet",
    ...
    "population", "employmentRate", "unemploymentPercentageOfTotalLabourForce", "averageFamilySize"
]
...
export const countriesUniqueIndicators = ["nationalBird", "nationalColors", "nationalFlower", "nationalSport", "nationalAnimal", "internetTLD", "majorReligion", "governmentStatus", "unitValueInUSD", "nationalAnthemNative", "nationalAnthemEnglish", "healthyLifeExpectancyRatio", "centralGovernmentDebt", "numberOfInternationalTouristsArrival", "currencyName", "drivingSide", "callingCode", "officialLanguages", "humanCapitalIndex", "CO2Emission"]

export const statesUniqueIndicators = ["nicknames", "mottoLatin", "mottoEnglish", "stateTree", "stateBird", "stateColors", "stateFlower", "stateSport", "stateAnimal", "population", "employmentRate", "averageFamilySize", "stateAnthemNative", "stateAnthemEnglish", "officialWebsite"]

export const commonIndicators = ["capitalCity", "largestCity", "officialName", "landlockedStatus", "demonyms", "callingCode", "ISO3166Code", "latitude", "longitude", "areaInSqKm", "areaInSqMile", "totalTimezones", "timezoneSummer", "DST", "DSTStart", "DSTEnd", "DSTDuration", "startOfWeek", "GDPNominal", "GDPPerCapita", "HDI", "literacyRate", "lifeExpectancyRatio", "povertyRatio", "accessToElectricity", "accessToInternet", "population", "unemploymentPercentageOfTotalLabourForce", "employmentRate"]

...
export default function SearchBox({ userCountry, slug1, slug2 = null }) {
    ...
    // const [input2, setInput2] = useState(isSlug2 ? titleCased(slug2) : '');
    const [input2, setInput2] = useState('');

    const [tempInput1, setTempInput1] = useState(userCountry ? userCountry : titleCased(slug1));
    // const [tempInput2, setTempInput2] = useState(isSlug2 ? titleCased(slug2) : '');
    ...
    // const previousInput2 = useRef(isSlug2 ? titleCased(slug2) : '');
    ...
    useEffect(() => {
        setFilteredCountries1(
            allEntities.filter(entity => entity !== input2).sort()
        );
        setFilteredCountries2(
            allEntities.filter(entity => entity !== input1).sort()
        );
    }, [input1, input2]);

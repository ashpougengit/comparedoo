                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Visual representation of the Largest City of any country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="official-languages-answer-first-entity all-indicator-answers">
                                {slug1OfficialLanguages ?? 'Yet to Update'}
                            </td>
                            <td
                                className="official-languages-answer-second-entity all-indicator-answers">
                        ...
                        <tr>
                            ...
                            <td
                                className="currency-name-answer-second-entity all-indicator-answers">
                        ...
                        <tr>
                            ...
                            <td
                                className="currency-symbol-answer-first-entity all-indicator-answers">
                                {slug1CurrencySymbol ?? 'Yet to Update'}
                            </td>
                            <td
                                className="currency-symbol-answer-second-entity all-indicator-answers">
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        are called
                        <strong>
                            <span className="demonyms-answer-first-entity"> {slug1Demonyms}</span>
                        </strong>
                        , and the people of{' '}
                        <strong>
                        ...
                        are called
                        <strong>
                            <span className="demonyms-answer-second-entity"> {slug2Demonyms}</span>
                        </strong>
                        .
                    </p>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image depicting calling code of any specific country" />
                                </div>
                            </td>

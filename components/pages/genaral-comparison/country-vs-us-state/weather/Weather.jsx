                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Visual representation of place of any country" />
                                </div>
                            </td>
                            ...
                            <td
                                className="place-weather-answer-second-entity all-indicator-answers">
                        ...
                        <tr>
                            ...
                            <td
                                className="current-weather-answer-first-entity all-indicator-answers">
                                {slug1CurrentWeather ?? 'Yet to Update'}
                            </td>
                            <td
                                className="current-weather-answer-second-entity all-indicator-answers">
                                {slug2CurrentWeather ?? 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="current-temperature-answer-first-entity all-indicator-answers">
                                {slug1CurrentTemperature ?? 'Yet to Update'}
                            </td>
                            <td
                                className="current-temperature-answer-second-entity all-indicator-answers">

                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                className="country-official-name-first-entity all-indicator-answers">
                                {slug1OfficialName ?? 'Yet to Update'}
                            </td>
                            <td
                                className="country-official-name-second-entity all-indicator-answers">
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting Latitide lines in World Map" />
                                </div>
                            </td>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting Longitude lines in World Map" />
                                </div>
                            </td>

...
function CountryVsUSStateGeneral({
  ...
  const capitalCity2 = convertLatLongToDecimal(
    slug2GeneralInfo.latitude,
    slug2GeneralInfo.longitude
  );
  const pageType = 'comparison';

  return (
    <>
      <TopDescription slug1={slug1} slug2={slug2} />
      <ThreeTabs entity1={slug1} entity2={slug2} />
      ...
      <Weather
        ...
        slug2WeatherInfo={slug2WeatherInfo}
      />
      <LastParagraph slug1={slug1} slug2={slug2} />
      <ComparisonLinks
        entity={slug1}

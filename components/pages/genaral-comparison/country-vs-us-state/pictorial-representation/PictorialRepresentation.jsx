            ...
            <div className="map-flag-emblem-country-state-first-entity">
              ...
              <div className="coat-arms-coat-arms-text">
                ...
                <div className="first-entity-emblem">
                  <Image
                    src={`/images/${slug1URLCase}-${
                      value1 === 'country' ? 'coat-of-arms' : 'us-state-seal'
                    }-medium.png`}
                    layout="fill"
                    objectFit="contain"
                    alt={`Image showing the ${
                      value1 === 'country' ? 'Coat of Arms' : 'State Seal'
                    } of ${slug1}`}
                  />
                </div>
              </div>
            ...
            <div className="map-flag-emblem-country-state-second-entity">
              ...
              <div className="coat-arms-coat-arms-text">
                ...
                <div className="second-entity-emblem">
                  <Image
                    src={`/images/${slug2URLCase}-${
                      value2 === 'country' ? 'coat-of-arms' : 'us-state-seal'
                    }-medium.png`}
                    layout="fill"
                    objectFit="contain"
                    alt={`Image showing the ${
                      value2 === 'country' ? 'Coat of Arms' : 'State Seal'
                    } of ${slug2}`}
                  />
                </div>
              </div>

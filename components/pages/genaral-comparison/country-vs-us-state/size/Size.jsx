            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        <strong>
                            is
                            <span className="area-in-square-kilometers-first-entity"> {slug1TotalAreasqkmStr} </span>
                            sq km
                        </strong>
                        ...
                        <strong>
                            is
                            <span className="area-in-square-kilometers-second-entity"> {slug2TotalAreasqkmStr} </span>
                            sq km
                        </strong>
                        .
                        <span className="first-entity-name-pages-paragraph"> {slug1} </span>
                        ...
                        by
                        <strong>
                            <span className="area-in-km-differences"> {differenceSqKm} </span>
                            sq km
                        </strong>
                        .
                        <span className="first-entity-name-pages-paragraph"> {slug1} </span>
                        is around
                        <strong><span className="country-area-division"> {biggerTimes} </span></strong>
                        times
                        <span className="smaller-or-bigger"> {biggerOrSmaller} </span>
                        than
                        <span className="second-entity-name-pages-paragraph"> {slug2}</span>
                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                className="area-in-square-kilometers-first-entity all-indicator-answers">
                                {slug1TotalAreasqkmStr ? `${slug1TotalAreasqkmStr} Sq km` : 'Yet to Update'}
                            </td>
                            <td
                                className="area-in-square-kilometers-second-entity all-indicator-answers">
                                {slug2TotalAreasqkmStr ? `${slug2TotalAreasqkmStr} Sq km` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colSpan="2">
                                <strong>
                                    ...
                                    {differenceSqKm ? `${differenceSqKm} Square Kilometers` : 'Yet to Update'}
                                    ]
                                </strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="area-in-square-mile-first-entity all-indicator-answers">
                                {slug1AreaInSqMileStr ? `${slug1AreaInSqMileStr} Sq mi` : 'Yet to Update'}
                            </td>
                            <td className="area-in-square-mile-second-entity all-indicator-answers">
                                {slug2AreaInSqMileStr ? `${slug2AreaInSqMileStr} Sq mi` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="all-indicators">Difference</td>
                            <td colSpan="2">
                                <strong>
                                    [
                                    <span className="area-in-km-differences"></span>
                                    {differenceSqMi ? `${differenceSqMi} Square Mile` : 'Yet to Update'}
                                    ]
                                </strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="water-percentage-area-first-entity all-indicator-answers">
                                {slug1WaterPercentage ?? 'Yet to Update'}
                            </td>
                            <td
                                className="water-percentage-area-second-entity all-indicator-answers">

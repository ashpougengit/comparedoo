                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/country-name-image.png" fill alt="Visual representation of official name of any country" />
                                </div>
                            </td>
                            <td className="country-official-name-first-entity all-indicator-answers">{country1OfficialName ?? 'Yet to Update'}</td>
                            <td className="country-official-name-second-entity all-indicator-answers">{country2OfficialName ?? 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Continent</div>
                                <div className="basic-information-images">
                                    <Image src="/images/continent-image.png" fill alt="Visual representation of all continents in the world" />
                                </div>
                            </td>
                            <td className="continent-first-entity all-indicator-answers">{country1Continent ?? 'Yet to Update'}</td>
                            <td className="continent-second-entity all-indicator-answers">{country2Continent ?? 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Landlocked Status</div>
                                <div className="basic-information-images">
                                    <Image src="/images/landlocked-image.png" fill alt="Image Depicting whether the status is landlocked or not." />
                                </div>
                            </td>
                            <td className="landlocked-answer-first-entity all-indicator-answers">{country1LandlockedStatus ?? 'Yet to Update'}</td>
                            <td className="landlocked-answer-second-entity all-indicator-answers">{country2LandlockedStatus ?? 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Capital City</div>
                                <div className="basic-information-images">
                                    <Image src="/images/capital-city-image.png" fill alt="Visual representation of a capital city of any specific country" />
                                </div>
                            </td>
                            <td className="capital-city-answer-first-entity all-indicator-answers">{country1CapitalCity ?? 'Yet to Update'}</td>
                            <td className="capital-city-answer-second-entity all-indicator-answers">{country2CapitalCity ?? 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                            ...
                            <td className="latitude-answer-first-entity all-indicator-answers">{country1Latitude ?? 'Yet to Update'}</td>
                            <td className="latitude-answer-second-entity all-indicator-answers">{country2Latitude ?? 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                            ...
                            <td className="longitude-answer-first-entity all-indicator-answers">{country1Longitude ?? 'Yet to Update'}</td>
                            <td className="longitude-answer-second-entity all-indicator-answers">{country2Longitude ?? 'Yet to Update'}</td>
                        </tr>
                    </tbody>
                </table>
            </div>

                        ...
                        <div className="globe-globe-text">
                            ...
                            <div className="first-entity-globe">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of the map of ${country1} in the world map`} />
                            </div>
                        </div>
                        ...
                        <div className="map-map-text">
                            ...
                            <div className="first-entity-map">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of map of ${country1}`} />
                            </div>
                        </div>
                        ...
                        <div className="flag-flag-text">
                            ...
                            <div className="first-entity-flag">
                                <Image
                                    ...
                                    fill alt={`Image illustrating the flag of ${country1}`} />
                            </div>
                        </div>
                        ...
                        <div className="coat-arms-coat-arms-text">
                            ...
                            <div className="first-entity-emblem">
                                <Image
                                    ...
                                    fill alt={`Image showing the coat of arms of ${country1}`} />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="globe-globe-text">
                            ...
                            <div className="second-entity-globe">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of the map of ${country2} in the world map`} />
                            </div>
                        </div>
                        ...
                        <div className="map-map-text">
                            ...
                            <div className="second-entity-map">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of map of ${country2}`} />
                            </div>
                        </div>
                        ...
                        <div className="flag-flag-text">
                            ...
                            <div className="second-entity-flag">
                                <Image
                                    ...
                                    fill alt={`Image illustrating the flag of ${country2}`} />
                            </div>
                        </div>
                        ...
                        <div className="coat-arms-coat-arms-text">
                            ...
                            <div className="second-entity-emblem">
                                <Image
                                    ...
                                    fill alt={`Image showing the coat of arms of ${country2}`} />
                            </div>
                        </div>
                    </div>
                </div>

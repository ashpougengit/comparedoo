                    ...
                    <tbody>
                        ...
                        {/* <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/smallest-city-image.png" fill alt="Visual representation of the Smallest City of any country" />
                                </div>
                            </td>
                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/currency-name-image.png" fill alt="Visual representation of currency name of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/driving-side-image.png" fill alt="Visual representation of driving side of any specific country" />
                                </div>
                            </td>

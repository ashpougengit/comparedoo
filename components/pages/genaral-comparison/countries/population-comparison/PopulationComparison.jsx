        ...
        <>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        Based on the elaboration of latest World Bank Data, the total population of
                        <strong>
                            <span className="first-entity-name-pages-paragraph"> {country1} </span> </strong>as of {lastYear} is estimated to be
                        around
                        <strong>
                            <span className="population-of-first-entity-name"> {country1PopString}</span></strong>, and the total population of
                        <strong>
                            <span className="second-entity-name-pages-paragraph"> {country2} </span> </strong>as of {lastYear} is estimated to be around
                        <strong>
                            <span className="population-of-second-entity-name"> {country2PopString}</span>.</strong>
                    </p>
            ...
            <div className="population-comparison-layout">
                <div className="first-entity-population-comparison">
                    <div className="first-entity-map-text-flag-population-comparison">
                        ...
                        <div className="first-entity-name-population-comparison">{country1}</div>
                    ...
                    <div className="population-graph-text">Population Graph ({dateRange})</div>

                    <div className="population-growth-graph">
                        <PopulationChart popInfo={country1PopInfo} ariaLabel={country1ChartDescription} />
                    </div>
                </div>
                ...
                <div className="second-entity-population-comparison">
                    ...
                    <div className="population-growth-graph">
                        <PopulationChart popInfo={country2PopInfo} ariaLabel={country2ChartDescription} />
                    </div>
                </div>
            </div>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        <span className="first-entity-name-pages-paragraph"> {country1} </span> is <strong> <span
                            className="annual-population-growth-first-entity"> {country1PopGrowthRate}</span>% </strong> and the annual population growth in <span className="second-entity-name-pages-paragraph"> {country2} </span> is <strong><span
                                className="annual-population-growth-second-entity"> {country2PopGrowthRate}</span>%.</strong>
                    </p>
                </div>

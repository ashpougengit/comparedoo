...
function GeneralComparisonUSStates({ state1GeneralInfo, state2GeneralInfo, state1WeatherInfo, state2WeatherInfo, timeDifference, aheadOrBehind, listForLinks }) {
    ...
    const capitalCity1 = convertLatLongToDecimal(state1GeneralInfo.latitude, state1GeneralInfo.longitude)
    const capitalCity2 = convertLatLongToDecimal(state2GeneralInfo.latitude, state2GeneralInfo.longitude)

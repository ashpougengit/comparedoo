        ...
        <>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>The total area of <span className="first-entity-name-pages-paragraph"> {state1} </span><strong>
                        is <span className="area-in-square-mile-first-entity"> {state1AreaInSqMileStr} </span> Square Mile</strong>, and the total
                        area of
                        <span className="second-entity-name-pages-paragraph"> {state2} </span><strong>
                            is <span className="area-in-square-mile-second-entity"> {state2AreaInSqMileStr} </span> Square Mile</strong>. <span
                                className="first-entity-name-pages-paragraph"> {state1} </span> is
                        <span className="smaller-or-bigger"> {biggerOrSmaller} </span> than
                        <span className="second-entity-name-pages-paragraph"> {state2} </span> by
                        <strong><span className="area-in-sq-mile-differences"> {differenceSqMi} </span> sq mile</strong>.
                        <span className="first-entity-name-pages-paragraph"> {state1} </span> is around
                        <strong><span className="state-area-division"> {biggerTimes} </span> </strong>times
                        <span className="smaller-or-bigger"> {biggerOrSmaller} </span> than
                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="area-in-square-mile-first-entity all-indicator-answers">{state1AreaInSqMileStr} <span>Sq Mile</span> </td>
                            <td className="area-in-square-mile-second-entity all-indicator-answers">{state2AreaInSqMileStr} <span>Sq Mile</span>
                            </td>

                        </tr>
                        <tr>
                            <td className="all-indicators">Difference</td>
                            <td colSpan="2"> <strong> [<span className="area-in-km-differences"></span> {differenceSqMi} <span>Square
                                Mile</span>
                                ]</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="area-in-square-kilometers-first-entity all-indicator-answers">{state1AreaInSqKmStr} <span>Sq km</span>
                            </td>
                            <td className="area-in-square-kilometers-second-entity all-indicator-answers">{state2AreaInSqKmStr} <span>Sq km</span>
                            </td>

                        </tr>
                        <tr>
                            <td className="all-indicators">Difference</td>
                            <td colSpan="2"> <strong> [<span className="area-in-km-differences"></span> {differenceSqKm} <span>Square
                                Kilometers</span>
                                ]</strong>
                            </td>

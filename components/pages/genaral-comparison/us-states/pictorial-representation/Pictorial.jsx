        ...
        <>
            ...
            <div clasaName="maps-flags-emblem">
                <div clasaName="first-entity-map-flag-emblem-pictorial-country-state">
                    <div
                        clasaName="first-entity-name-pages-comparison first-entity-name-maps-flags-emblem">
                        {state1}
                    </div>
                        ...
                        <div clasaName="map-map-text">
                            ...
                            <div clasaName="first-entity-map">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of the map of ${state1}`} />
                            </div>
                        </div>
                        <div clasaName="flag-flag-text">
                            ...
                            <div clasaName="first-entity-flag">
                                <Image
                                    ...
                                    fill alt={`Image illustrating the flag of ${state1}`} />
                            </div>
                        </div>
                        <div clasaName="coat-arms-coat-arms-text">
                            ...
                            <div clasaName="first-entity-emblem">
                                <Image
                                    ...
                                    fill alt={`Image showing the state seal of ${state1}`} />
                            </div>
                        </div>
                    </div>
                </div>
                <div clasaName="second-entity-map-flag-emblem-pictorial-country-state">
                    <div
                        clasaName="second-entity-name-pages-comparison second-entity-name-maps-flags-emblem">
                        {state2}
                    </div>
                    <div clasaName="horizontal-line"></div>
                        ...
                        <div clasaName="map-map-text">
                            ...
                            <div clasaName="second-entity-map">
                                <Image
                                    ...
                                    fill alt={`Pictorial representation of the map of ${state2}`} />
                            </div>
                        </div>
                        <div clasaName="flag-flag-text">
                            <div clasaName="flag-text">Flag</div>
                            <div clasaName="second-entity-flag">
                                <Image
                                    ...
                                    fill alt={`Image illustrating the flag of ${state2}`} />
                            </div>
                        </div>
                        <div clasaName="coat-arms-coat-arms-text">
                            <div clasaName="emblem-text">State Seal</div>
                            <div clasaName="second-entity-emblem">
                                <Image
                                    ...
                                    fill alt={`Image showing the state seal of ${state2}`} />
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="place-weather-answer-first-entity all-indicator-answers">{state1Place ?? 'Yet to Update'} </td>
                            <td className="place-weather-answer-second-entity all-indicator-answers">{state2Place ?? 'Yet to Update'} </td>
                        ...
                        <tr>
                            ...
                            <td className="current-weather-answer-first-entity all-indicator-answers">{state1CurrentWeather ?? 'Yet to Update'}</td>
                            <td className="current-weather-answer-second-entity all-indicator-answers">{state2CurrentWeather ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="current-temperature-answer-first-entity all-indicator-answers">{state1CurrentTemperature ?? 'Yet to Update'}</td>
                            <td className="current-temperature-answer-second-entity all-indicator-answers">{state2CurrentTemperature ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="humidity-answer-first-entity all-indicator-answers">{state1Humidity ?? 'Yet to Update'}</td>
                            <td className="humidity-answer-second-entity all-indicator-answers">{state2Humidity ?? 'Yet to Update'}</td>

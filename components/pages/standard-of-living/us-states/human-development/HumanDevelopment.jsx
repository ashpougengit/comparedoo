                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="hdi-answer-first-entity all-indicator-answers">{state1HDI ?? 'Yet to Update'}</td>
                            <td className="hdi-answer-second-entity all-indicator-answers">{state2HDI ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="literacy-rate-answer-first-entity all-indicator-answers">
                                {state1LiteracyRate ? `${state1LiteracyRate}% (15 years+ above
                                age)`: 'Yet to Update'}
                            </td>
                            <td className="literacy-rate-answer-second-entity all-indicator-answers">
                                {state2LiteracyRate ? `${state2LiteracyRate}% (15 years+ above
                                age)`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="life-expectancy-ratio-answer-first-entity all-indicator-answers">{state1LifeExpectancyRatio ? `${state1LifeExpectancyRatio} years` : 'Yet to Update'}</td>
                            <td className="life-expectancy-ratio-answer-second-entity all-indicator-answers">{state2LifeExpectancyRatio ? `${state2LifeExpectancyRatio} years` : 'Yet to Update'}</td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/employment-rate-image.png"
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        and
                        quality
                        of life of people living in a country or a state. The key dimensions that give a country or a state good HDI rank are a long
                        and
                        healthy
                        life, being knowledgeable and having a decent standard of living. This is expressed as a value between 0 and
                        1. The higher a country&apos;s or a state&apos;s human development, the higher its HDI value.

                    </p>
                    <br />

                    <p>The life expectancy ratio at birth in <strong><span className="first-entity-name-pages-paragraph"> {state1}</span>,{' '} 
                    </strong>
                        is <strong> [ <span className="life-expectancy-ratio-answer-first-entity"> {state1LifeExpectancyRatio} years</span> ], </strong>
                        whereas
                        the
                        life expectancy ratio at birth in <strong> <span
                            className="second-entity-name-pages-paragraph"> {state2} </span></strong> is <strong> [ <span
                                className="life-expectancy-ratio-answer-first-entity"> {state2LifeExpectancyRatio} years</span> ]. </strong>
                    </p>

                    <p>
                        As per the data, a person born and lived in <strong> <span
                            className="first-entity-name-pages-paragraph"> {state1} </span>
                        </strong> is expected to live <strong> [ <span className="life-expectancy-ratio-age-calculation"> {lifeDifference} </span>
                            years
                            ]
                        </strong> <span className="more-or-less-life-expectancy-calculation"> {moreOrLess} </span> than a person born
                        and
                        lived
                        in
                        <strong> <span className="second-entity-name-pages-paragraph"> {state2}</span>.</strong>
                    </p>

                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/total-housing-units-states-images.png" fill alt="Image Depicting Total Housing Units percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1TotalHousingUnits ? `${formatNumberWithCommas(state1TotalHousingUnits)}` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2TotalHousingUnits ? `${formatNumberWithCommas(state2TotalHousingUnits)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/median-gross-rent-states-images.png" fill alt="Image Depicting Median Gross Rent percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MedianGrossRent ? `${formatNumberWithCommas(state1MedianGrossRent)} USD` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MedianGrossRent ? `${formatNumberWithCommas(state2MedianGrossRent)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/homeownership-rate-states-images.png" fill alt="Image Depicting Homeownership Rate percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1HomeownershipRate ? `${state1HomeownershipRate} %` : 'yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2HomeownershipRate ? `${state2HomeownershipRate} %` : 'yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/average-family-size-states-images.png" fill alt="Image Depicting Average Family Size in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/married-couple-household-states-images.png" fill alt="Image Depicting Married Couple Household percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MarriedCoupleHouseholdPercentage ? `${state1MarriedCoupleHouseholdPercentage} %` : 'yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MarriedCoupleHouseholdPercentage ? `${state2MarriedCoupleHouseholdPercentage} %` : 'yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/male-householder-states-images.png" fill alt="Image Depicting Male Householder (No Spouse) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MaleHouseholderPercentage ? `${state1MaleHouseholderPercentage} %` : 'yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MaleHouseholderPercentage ? `${state2MaleHouseholderPercentage} %` : 'yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/female-householder-states-images.png" fill alt="Image Depicting Female Householder (No Spouse) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1FemaleHouseholderPercentage ? `${state1FemaleHouseholderPercentage} %` : 'yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2FemaleHouseholderPercentage ? `${state2FemaleHouseholderPercentage} %` : 'yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/gdp-image.png" fill alt="Image representing the total Gross Domestic Product of any specific country or state" />
                                </div>
                            </td>
                            <td className="gdp-answer-first-entity all-indicator-answers">
                                {state1GDPNominal ? `${formatNumberWithCommas(state1GDPNominal)} million USD` : 'Yet to Update'}
                            </td>
                            <td className="gdp-answer-second-entity all-indicator-answers">
                                {state2GDPNominal ? `${formatNumberWithCommas(state2GDPNominal)} million USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/gdp-per-capita-image.png" fill alt="Image representing the total Gross Domestic Product Per Capita of any specific country or state" />
                                </div>
                            </td>
                            <td className="gdp-per-capita-answer-first-entity all-indicator-answers">
                                {state1GDPPerCapita ? `${formatNumberWithCommas(state1GDPPerCapita)} USD` : 'Yet to Update'}
                            </td>
                            <td className="gdp-per-capita-answer-second-entity all-indicator-answers">
                                {state2GDPPerCapita ? `${formatNumberWithCommas(state2GDPPerCapita)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/gini-ratio-image.png" fill alt="Image representing the total GINI Ratio or GINI Coefficient of any specific country or state" />
                                </div>
                            </td>
                            <td className="gini-ratio-answer-first-entity all-indicator-answers">
                                {state1GINI ?? 'Yet to Update'}</td>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        is a measure of the total value of all goods and
                        services
                        produced
                        within a country or a state in
                        a specific time period, usually a year. It is used to gauge the economic performance of a country or a state and
                        indicates
                        how
                        wealthy and productive a nation or a state is. In simple terms, GDP tells us how much a country or a state is producing and
                        how
                        well
                        its
                        economy is doing.
                    ...
                    <p>
                        ...
                        <span className="gdp-answer-first-entity"> {formatNumberWithCommas(state1GDPNominal)} million USD</span> and the total GDP of
                        <strong>
                            <span className="second-entity-name-pages-paragraph"> {state2} </span>
                        </strong> is
                        <span className="gdp-answer-second-entity"> {formatNumberWithCommas(state2GDPNominal)} million USD</span>.
                    </p>
                    <br />
                    <p>
                        On the other hand,
                        ...
                        output
                        per
                        person in a country or a state. Simply put, it shows how much, on average, each person contributes to the economy,
                        giving
                        an

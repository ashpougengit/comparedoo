                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/married-man-states-images.png" fill alt="Image Depicting Married Male (Not Separated) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MarriedNotSeparatedPopulationPercentageMale ? `${state1MarriedNotSeparatedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MarriedNotSeparatedPopulationPercentageMale ? `${state2MarriedNotSeparatedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/married-woman-states-images.png" fill alt="Image Depicting Married Female (Not Separated) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MarriedNotSeparatedPopulationPercentageFemale ? `${state1MarriedNotSeparatedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MarriedNotSeparatedPopulationPercentageFemale ? `${state2MarriedNotSeparatedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/never-married-man-states-images.png" fill alt="Image Depicting Never Married (Male) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1NeverMarriedPopulationPercentageMale ? `${state1NeverMarriedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2NeverMarriedPopulationPercentageMale ? `${state2NeverMarriedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/never-married-woman-states-images.png" fill alt="Image Depicting Never Married (Female) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1NeverMarriedPopulationPercentageFemale ? `${state1NeverMarriedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2NeverMarriedPopulationPercentageFemale ? `${state2NeverMarriedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/separated-man-states-images.png" fill alt="Image Depicting Separated (Male) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1SeparatedPopulationPercentageMale ? `${state1SeparatedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2SeparatedPopulationPercentageMale ? `${state2SeparatedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/separated-woman-states-images.png" fill alt="Image Depicting Separated (Female) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1SeparatedPopulationPercentageFemale ? `${state1SeparatedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2SeparatedPopulationPercentageFemale ? `${state2SeparatedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/divorced-man-states-images.png" fill alt="Image Depicting Separated (Male) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1DivorcedPopulationPercentageMale ? `${state1DivorcedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2DivorcedPopulationPercentageMale ? `${state2DivorcedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/divorced-woman-states-images.png" fill alt="Image Depicting Divorced (Female) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1DivorcedPopulationPercentageFemale ? `${state1DivorcedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2DivorcedPopulationPercentageFemale ? `${state2DivorcedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/widowed-man-states-images.png" fill alt="Image Depicting Widowed (Male) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1WidowedPopulationPercentageMale ? `${state1WidowedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2WidowedPopulationPercentageMale ? `${state2WidowedPopulationPercentageMale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/widowed-woman-states-images.png" fill alt="Image Depicting Widowed (Female) percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1WidowedPopulationPercentageFemale ? `${state1WidowedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2WidowedPopulationPercentageFemale ? `${state2WidowedPopulationPercentageFemale} %` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

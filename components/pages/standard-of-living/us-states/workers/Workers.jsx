                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/mean-travel-time-to-work-states-images.png" fill alt="Image Depicting the total Mean Travel Time to Work available in any specific country or state" />
                                </div>
                            </td>
                            <td className="mean-travel-time-to-work-answer-first-entity all-indicator-answers">
                                {state1MeanTravelTimeToWorkMinutes ? `${state1MeanTravelTimeToWorkMinutes} Minutes` : 'Yet to Update'}
                            </td>
                            <td className="mean-travel-time-to-work-answer-second-entity all-indicator-answers">
                                {state2MeanTravelTimeToWorkMinutes ? `${state2MeanTravelTimeToWorkMinutes} Minutes` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/work-from-home-states-images.png" fill alt="Image Depicting the People Working From Home percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1WorkFromHome ? `${state1WorkFromHome}%` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2WorkFromHome ? `${state2WorkFromHome}%` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/private-wage-and-salary-states-images.png" fill alt="Image Depicting the Private Wage and Salary Workers percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1PrivateWageandSalaryWorkers ? `${state1PrivateWageandSalaryWorkers}%` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2PrivateWageandSalaryWorkers ? `${state2PrivateWageandSalaryWorkers}%` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/government-worker-states-images.png" fill alt="Image Depicting the People Working In Government Sectors percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1GovernmentWorkers ? `${state1GovernmentWorkers}%` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2GovernmentWorkers ? `${state2GovernmentWorkers}%` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/self-employed-states-images.png" fill alt="Image Depicting the Self-Employed Workers percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1SelfEmployedInNotOwnIncorporatedBusiness ? `${state1SelfEmployedInNotOwnIncorporatedBusiness}%` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2SelfEmployedInNotOwnIncorporatedBusiness ? `${state2SelfEmployedInNotOwnIncorporatedBusiness}%` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/median-income-states-images.png" fill alt="Image Depicting the Median Income percentage in any specific country or state" />
                                </div>
                            </td>
                            <td className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {state1MedianIncomeDollars ? `${formatNumberWithCommas(state1MedianIncomeDollars)} USD` : 'Yet to Update'}
                            </td>
                            <td className="employment-rate-states-answer-second-entity all-indicator-answers">
                                {state2MedianIncomeDollars ? `${formatNumberWithCommas(state2MedianIncomeDollars)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

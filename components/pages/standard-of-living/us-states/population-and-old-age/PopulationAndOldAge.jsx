    ...
    return (
        <>
            ...
            <div className="economic-factors-comparison">
                <h2 className="pages-h2">Population and Old Age Factors Comparison</h2>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/total-population-image.png" fill alt="Illustration of total population of any specific country or a state" />
                                </div>
                            </td>
                            <td className="total-population-first-entity all-indicator-answers">
                                {state1Population ? formatNumberWithCommas(state1Population) : 'Yet to Update'}
                            </td>
                            <td className="total-population-second-entity all-indicator-answers">
                                {state2Population ? formatNumberWithCommas(state2Population) : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/median-age-states-image.png" fill alt="Illustration of Median Age of any specific country or a state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/sex-ratio-states-image.png" fill alt="Illustration of Sex Ratio of any specific country or a state" />
                                </div>
                            </td>
                            <td className="sex-ratio-first-entity all-indicator-answers">
                                {state1SexRatioMalesPer100Females ? (
                                    <>
                                        {state1SexRatioMalesPer100Females}<br /> (Males per 100 Females)
                                    </>
                                ) : 'Yet to Update'}
                            </td>
                            <td className="sex-ratio-second-entity all-indicator-answers">
                                {state2SexRatioMalesPer100Females ? (
                                    <>
                                        {state2SexRatioMalesPer100Females}<br /> (Males per 100 Females)
                                    </>
                                ) : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/60-to-64-years-states-image.png" fill alt="Illustration of 60 to 64 years age group of any specific country or a state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/65-to-74-years-states-image.png" fill alt="Illustration of 65 to 74 years age group of any specific country or a state" />
                                </div>
                            </td>
                            ...
                            <td className="65-to-74-years-population-second-entity all-indicator-answers">
                                {state2Age65to74 ? `${state2Age65to74}%` : 'Yet to Update'}</td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/75-to-84-years-states-image.png" fill alt="Illustration of 75 to 84 years age group of any specific country or a state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/85-years-and-over-states-image.png" fill alt="Illustration of 85 years and older age group of any specific country or a state" />
                                </div>
                            </td>
                            <td className="85-years-and-older-population-first-entity all-indicator-answers">
                                {state1Age85AndOver ? `${state1Age85AndOver}%` : 'Yet to Update'}
                            </td>
                            <td className="85-years-and-older-population-second-entity all-indicator-answers">
                                {state2Age85AndOver ? `${state2Age85AndOver}%` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/total-registered-physicians-states-image.png" fill alt="Image representing Total Registered Physicians of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {state1TotalRegisteredPhysicians ? `${formatNumberWithCommas(state1TotalRegisteredPhysicians)}` : 'Yet to Update'}
                            </td>
                            <td className="income-tax-rates-answer-second-entity all-indicator-answers">
                                {state2TotalRegisteredPhysicians ? `${formatNumberWithCommas(state2TotalRegisteredPhysicians)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/total-registered-nurses-states-image.png" fill alt="Image representing Total Registered Nurses of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {state1TotalRegisteredNurses ? `${formatNumberWithCommas(state1TotalRegisteredNurses)}` : 'Yet to Update'}
                            </td>
                            <td className="income-tax-rates-answer-second-entity all-indicator-answers">
                                {state2TotalRegisteredNurses ? `${formatNumberWithCommas(state2TotalRegisteredNurses)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/available-hospital-beds-states-image.png" fill alt="Image representing Available Hospital Beds of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {state1AvailableHospitalBeds ? `${formatNumberWithCommas(state1AvailableHospitalBeds)}` : 'Yet to Update'}
                            </td>
                            <td className="income-tax-rates-answer-second-entity all-indicator-answers">
                                {state2AvailableHospitalBeds ? `${formatNumberWithCommas(state2AvailableHospitalBeds)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/disability-percentage-states-images.png" fill alt="Image representing Disability Percentage of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {state1DisabilityPercentage ? `${state1DisabilityPercentage}%` : 'Yet to Update'}
                            </td>
                            <td className="income-tax-rates-answer-second-entity all-indicator-answers">
                                {state2DisabilityPercentage ? `${state2DisabilityPercentage}%` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/population-without-health-insurance-coverage-states-images.png" fill alt="Image representing Population Without Health Insurance Coverage of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-first-entity all-indicator-answers">
                                {state1PopulationWithoutHealthInsuranceCoverage ? `${state1PopulationWithoutHealthInsuranceCoverage}%` : 'Yet to Update'}
                            </td>
                            <td className="income-tax-rates-second-entity all-indicator-answers">
                                {state2PopulationWithoutHealthInsuranceCoverage ? `${state2PopulationWithoutHealthInsuranceCoverage}%` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

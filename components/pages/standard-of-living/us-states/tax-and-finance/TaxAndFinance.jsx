                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/income-tax-rates-states-image.png" fill alt="Image representing Income Tax Rates of any specific country or state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/sales-tax-rates-states-image.png" fill alt="Image representing Sales Tax Rates of any specific country or state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/property-tax-rates-states-image.png" fill alt="Image representing Property Tax Rates of any specific country or state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/corporate-tax-rates-states-image.png" fill alt="Image representing Corporate Tax Rates of any specific country or state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/gas-and-fuel-tax-rates-states-image.png" fill alt="Image representing Gas and Fuel Tax of any specific country or state" />
                                </div>
                            </td>
                            <td className="gas-and-fuel-tax-rates-answer-first-entity all-indicator-answers">
                                {state1GasandFuelTaxRatesPerGallon ? `${state1GasandFuelTaxRatesPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                            <td className="gas-and-fuel-tax-rates-answer-second-entity all-indicator-answers">
                                {state2GasandFuelTaxRatesPerGallon ? `${state2GasandFuelTaxRatesPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/beer-tax-rates-states-image.png" fill alt="Image representing Beer Tax of any specific country or state" />
                                </div>
                            </td>
                            <td className="beer-tax-rates-answer-first-entity all-indicator-answers">
                                {state1BeerTaxPerGallon ? `${state1BeerTaxPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                            <td className="beer-tax-rates-answer-second-entity all-indicator-answers">
                                {state2BeerTaxPerGallon ? `${state2BeerTaxPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

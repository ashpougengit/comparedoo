...
function BusinessRegistration({ country1StandardInfo, country2StandardInfo, country1URLCase, country2URLCase }) {
  ...
  return (
    <>
          ...
          <tbody>
            <tr>
              ...
              <td className="time-required-to-start-a-business-answer-first-entity all-indicator-answers">
                {country1TimeRequiredToStartABusinessDays ? (
                  <>
                    {country1TimeRequiredToStartABusinessDays}{' '}
                    <span> Days</span>
                  </>
              ...
              <td className="time-required-to-start-a-business-answer-second-entity all-indicator-answers">
                {country2TimeRequiredToStartABusinessDays ? (
                  <>
                    {country2TimeRequiredToStartABusinessDays}{' '}
                    <span> Days</span>
                  </>
            ...
            <tr>
              ...
              <td className="new-businesses-registered-number-answer-first-entity all-indicator-answers">
                {country1NewBusinessesRegisteredNumber ? (
                  <>
                    {numberWithCommas(country1NewBusinessesRegisteredNumber)}{' '}
              ...
              <td className="new-businesses-registered-number-answer-second-entity all-indicator-answers">
                {country2NewBusinessesRegisteredNumber ? (
                  <>
                    {numberWithCommas(country2NewBusinessesRegisteredNumber)}{' '}
                    <span> (New Businesses)</span>
                  </>
                ) : (
                  'Yet to Update'
      ...
      {((country1NewBusinessesRegisteredNumber && country2NewBusinessesRegisteredNumber) || (country1TimeRequiredToStartABusinessDays && country2TimeRequiredToStartABusinessDays)) &&
        <div className="paragraph-for-pages-below-table">
          <div className="para-for-pages-single-div">
            {country1NewBusinessesRegisteredNumber && country2NewBusinessesRegisteredNumber &&
              <p>
                ...
                <strong>
                  {' '}
                  <span className="new-businesses-registered-number-answer-second-entity">
                    {' '}
                    {numberWithCommas(country2NewBusinessesRegisteredNumber)}{' '}
                  </span>
                  new businesses got registered in{' '}
                </strong>
            ...
            {country1TimeRequiredToStartABusinessDays && country2TimeRequiredToStartABusinessDays &&
              <p>
                It usually takes{' '}
                <strong>
                  {' '}
                ...
                <strong>
                  {' '}
                  <span className="time-required-to-start-a-business-answer-second-entity">
                    {' '}
                    {country2TimeRequiredToStartABusinessDays}{' '}
                  </span>
                  days{' '}

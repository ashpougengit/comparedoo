...
function EconomicFactors({ country1StandardInfo, country2StandardInfo, country1URLCase, country2URLCase }) {
  ...
  const country1InflationOnConsumerPrices = country1StandardInfo.inflationOnConsumerPrices
  const country1CentralGovernmentDebt = country1StandardInfo.centralGovernmentDebt
  ...
  const country1HealthyLifeExpectancyRatio = country1StandardInfo.healthyLifeExpectancyRatio
  const country1PovertyRatio = country1StandardInfo.povertyRatio
  const country1UnemploymentPercentageOfTotalLabourForce = country1StandardInfo.unemploymentPercentageOfTotalLabourForce
  ...
  const country2InflationOnConsumerPrices = country2StandardInfo.inflationOnConsumerPrices
  const country2CentralGovernmentDebt = country2StandardInfo.centralGovernmentDebt
  ...
  const country2HealthyLifeExpectancyRatio = country2StandardInfo.healthyLifeExpectancyRatio
  const country2PovertyRatio = country2StandardInfo.povertyRatio
  const country2UnemploymentPercentageOfTotalLabourForce = country2StandardInfo.unemploymentPercentageOfTotalLabourForce

  const moreOrLess = country1GDPPerCapita > country2GDPPerCapita ? 'more' : 'less'
              ...
              <td className="basic-info">
                <div className="all-indicators">
                  ...
                  <div className="gdp-text">
                    Gross Domestic Product (GDP) <br /> ({lastYear})
                  </div>
...
objectFit="contain"alt="Image representing the total Gross Domestic Product of any specific country" />
              ...
              <td className="gdp-answer-second-entity all-indicator-answers">{country2GDPNominal ? `${country2GDPNominal} USD` : 'Yet to Update'}</td>
...
objectFit="contain"alt="Image representing the total Gross Domestic Product Per Capita of any specific country" />
              ...
              <td className="gdp-per-capita-answer-first-entity all-indicator-answers">
                {country1GDPPerCapita ? `${formatNumberWithCommas(country1GDPPerCapita)} USD` : 'Yet to Update'}
              </td>
              <td className="gdp-per-capita-answer-second-entity all-indicator-answers">
                {country2GDPPerCapita ? `${formatNumberWithCommas(country2GDPPerCapita)} USD` : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representing the total GINI Ratio or GINI Coefficient of any specific country" />
              ...
              <td className="gini-ratio-answer-first-entity all-indicator-answers">
                {country1GINI ? (country1GINI/100).toFixed(2) : 'Yet to Update'}
              </td>
              <td className="gini-ratio-answer-second-entity all-indicator-answers">
                {country2GINI ? (country2GINI/100).toFixed(2) : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representing the Percentage of Inflation on consumer prices of any specific country" />
              ...
              <td className="inflation-answer-second-entity all-indicator-answers">{country2InflationOnConsumerPrices ? `${country2InflationOnConsumerPrices} % annually` : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representing the Central Government Debt of any specific country" />
              ...
              <td className="central-government-debt-answer-second-entity all-indicator-answers">{country2CentralGovernmentDebt ? `${country2CentralGovernmentDebt}% of GDP` : 'Yet to Update'}
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div className="paragraph-for-pages-below-table">
        <div className="para-for-pages-single-div">
          ...
          <p>
            <strong> Gross Domestic Product (GDP) </strong> is a measure of the total value of all goods and
            services
            produced
            within a country in
            a specific time period, usually a year. It is used to gauge the economic performance of a country and
            indicates
            how
            wealthy and productive a nation is. In simple terms, GDP tells us how much a country is producing and
            how
            well
            its
            economy is doing.
          ...
          <br />
          <p>
            As per the statistics from the World Bank Data for the year <strong>{lastYear}</strong>, the total GDP of
            <strong><span className="first-entity-name-pages-paragraph"> {country1} </span></strong> is <span
              className="gdp-answer-first-entity"> {country1GDPNominal} </span><span>USD</span> and that of
            <strong><span className="second-entity-name-pages-paragraph"> {country2} </span></strong> is
            <span className="gdp-answer-second-entity"> {country2GDPNominal} <span>USD</span>.
            </span>
          </p>
          <br />

          <p>
            On the other hand, <strong> Gross Domestic Product (GDP) Per Capita</strong> is the average economic
            output
            per
            person in a country. Simply put, it shows how much, on average, each person contributes to the economy,
            giving
            an
            idea of the standard of living and
            economic well-being of the people in that country.
          </p>
          <br />
          <p>
            From the above data, we can say that a person living and working in <strong><span
              className="first-entity-name-pages-paragraph"> {country1} </span></strong> contributes <span
                className="more-or-less-gdp-per-capita-calculation"> {moreOrLess} </span> to the country&apos;s economy
            compared to
            a
            person
            working in <strong><span className="second-entity-name-pages-paragraph"> {country2}</span></strong>.
          </p>
...
objectFit="contain"alt="Image representing the Human Capital Index of any specific country" />
              ...
              <td className="human-capital-index-answer-first-entity all-indicator-answers">
                {country1HumanCapitalIndex ? country1HumanCapitalIndex : 'Yet to Update'}
              </td>
              <td className="human-capital-index-answer-second-entity all-indicator-answers">
                {country2HumanCapitalIndex ? country2HumanCapitalIndex : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representing the Literacy Rate of any specific country" />
              ...
              <td className="literacy-rate-answer-first-entity all-indicator-answers">
                {country1LiteracyRate ? `${country1LiteracyRate}% (15 years+ above age)` : 'Yet to Update'}
              </td>
              <td className="literacy-rate-answer-second-entity all-indicator-answers">
                {country2LiteracyRate ? `${country2LiteracyRate}% (15 years+ above age)` : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representation of Life Expectancy Ratio any given country" />
              ...
              <td className="life-expectancy-ratio-answer-second-entity all-indicator-answers">{country2LifeExpectancyRatio ? `${country2LifeExpectancyRatio} years` : 'Yet to Update'}</td>
...
objectFit="contain"alt="Image representation of Healthy Life Expectancy Ratio any given country" />
              ...
              <td className="healthy-life-expectancy-ratio-answer-second-entity all-indicator-answers">{country2HealthyLifeExpectancyRatio ? `${country2HealthyLifeExpectancyRatio} years` : 'Yet to Update'}</td>
...
objectFit="contain"alt="Image representing the Poverty Rate of any specific country" />
              ...
              <td className="poverty-ratio-answer-first-entity all-indicator-answers">
                {country1PovertyRatio ? `${country1PovertyRatio}% of total Population` : 'Yet to Update'}
              </td>
              <td className="poverty-ratio-answer-second-entity all-indicator-answers">
                {country2PovertyRatio ? `${country2PovertyRatio}% of total Population` : 'Yet to Update'}
              </td>
...
objectFit="contain"alt="Image representing the Unemployment Rate of any specific country" />
              ...
              <td className="unemployment-rate-answer-second-entity all-indicator-answers">{country2UnemploymentPercentageOfTotalLabourForce ? `${country2UnemploymentPercentageOfTotalLabourForce}% of total labor force`: 'Yet to Update'}
              </td>
      ...
      <div className="paragraph-for-pages-below-table">
        <div className="para-for-pages-single-div">
          ...
          <p>
            <strong> The Human Development Index (HDI) </strong> is a measure used to assess the overall well-being
            and
            quality
            of life of people living in a country. The key dimensions that give a country good HDI rank are a long
            and
            healthy
          ...
          <br />
          <p>
            From the above given statistics, we can see that the HDI of <strong><span
              className="first-entity-name-pages-paragraph"> {country1} </span></strong> is <strong> [<span
                className="hdi-answer-first-entity"> {country1HDI} </span>]</strong> and the HDI of <strong><span
                  className="second-entity-name-pages-paragraph"> {country2} </span></strong> is{' '}
            <strong>
              [<span className="hdi-answer-second-entity"> {country2HDI}</span>]</strong>.
          </p>

          <p>The data shows that the people living in <strong><span
            className="first-entity-name-pages-paragraph"> {country1} </span></strong> has <span
              className="better-or-lower-calculation"> {betterOrLower} </span> income, life expectancy and education
            level
            compared
            to
            <strong><span className="second-entity-name-pages-paragraph"> {country2}</span>.</strong>
          </p>
        </div>
      </div>
    </>

    ...
    return (
        <>
            ...
            <div className="economic-factors-comparison">
                <h2 className="pages-h2">Government National Expenditure Comparison</h2>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/gross-national-expenditure-image.png"
                                        fill alt="Image representing the total Gross National Expenditure of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/health-expenditure-image.png"
                                        fill alt="Image representation of total Health Expenditure of any given country" />
                                </div>
                            </td>
                            <td className="health-expenditure-rate-answer-first-entity all-indicator-answers">{
                                country1CurrentHealthExpenditurePercentage ? (
                                    <>
                                        {country1CurrentHealthExpenditurePercentage} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                            <td className="health-expenditure-rate-answer-second-entity all-indicator-answers">{
                                country2CurrentHealthExpenditurePercentage ? (
                                    <>
                                        {country2CurrentHealthExpenditurePercentage} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/research-and-development-expenditure-image.png"
                                        fill alt="Image representing the Government Expenditure of any specific country" />
                                </div>
                            </td>
                            <td className="research-and-development-expenditure-answer-first-entity all-indicator-answers">{
                                country1ResearchAndDevelopmentExpenditure ? (
                                    <>
                                        {country1ResearchAndDevelopmentExpenditure} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                            <td className="research-and-development-expenditure-answer-second-entity all-indicator-answers">{
                                country2ResearchAndDevelopmentExpenditure ? (
                                    <>
                                        {country2ResearchAndDevelopmentExpenditure} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/government-expenditure-on-education-image.png"
                                        fill alt="Image representing the Government Expenditure of any specific country" />
                                </div>
                            </td>
                            <td className="government-expenditure-on-education-answer-first-entity all-indicator-answers">{
                                country1GovernmentExpenditureOnEducation ? (
                                    <>
                                        {country1GovernmentExpenditureOnEducation} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                            <td className="government-expenditure-on-education-answer-second-entity all-indicator-answers">{
                                country2GovernmentExpenditureOnEducation ? (
                                    <>
                                        {country2GovernmentExpenditureOnEducation} <span>% of GDP</span>
                                    </>
                                ) : 'Yet to Update'
                            }
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/international-tourism-image.png"
                                        fill alt="Image representing the International Tourism Expenditure of any specific country" />
                                </div>
                            </td>
                            <td className="international-tourism-expenditure-answer-first-entity all-indicator-answers">
                                {formatNumberWithCommas(country1InternationalTourismExpenditureUSD)}
                                <span>{country1InternationalTourismExpenditureUSD ? ' USD' : ''}</span>
                            </td>
                            <td className="international-tourism-expenditure-answer-second-entity all-indicator-answers">
                                {formatNumberWithCommas(country2InternationalTourismExpenditureUSD)}
                                <span>{country2InternationalTourismExpenditureUSD ? ' USD' : ''}</span>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/number-of-international-tourists-arrival.png"
                                        fill alt="Image representing the Number of International Tourists Arrival in any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/military-expenditure-image.png"
                                        fill alt="Image representing the Military Expenditure of any specific country" />
                                </div>
                            </td>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>The total Gross National Expenditure of <span className="first-entity-name-pages-paragraph"> {country1} </span> is
                        <strong>
                            <span className="gross-national-expenditure-answer-first-entity"> {country1GrossNationalExpenditure}% </span> of its GDP </strong>and the
                        total Gross National Expenditure of
                        <span className="second-entity-name-pages-paragraph"> {country2} </span> is <strong>
                            <span className="gross-national-expenditure-answer-second-entity">{country2GrossNationalExpenditure}% </span> of its GDP. </strong>

                    </p>

                    <p>From the above data, we can say that <span className="first-entity-name-pages-paragraph"> {country1} </span> spends
                        <strong>
                            <span className="gross-national-expenditure-calculation"> {expenditureTimes} </span> times </strong> <span
                                className="gross-national-expenditure-more-less-calculation"> {moreOrLess} </span> of its GDP on Gross National Expenditure compared to

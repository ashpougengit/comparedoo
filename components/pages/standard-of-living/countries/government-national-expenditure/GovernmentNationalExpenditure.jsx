...
function GovernmentNationalExpenditure({ country1StandardInfo, country2StandardInfo, country1URLCase, country2URLCase }) {
  ...
  const country1InternationalTourismExpenditureRaw = country1StandardInfo.internationalTourismExpenditureUSD
  const country1InternationalTourismExpenditureMillion = country1InternationalTourismExpenditureRaw ? `${formatNumberWithCommas(country1InternationalTourismExpenditureRaw / 1e6)} million USD` : null
  ...
  const country2InternationalTourismExpenditureRaw = country2StandardInfo.internationalTourismExpenditureUSD
  const country2InternationalTourismExpenditureMillion = country2InternationalTourismExpenditureRaw ? `${formatNumberWithCommas(country2InternationalTourismExpenditureRaw / 1e6)} million USD` : null
  ...
  return (
    <>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="international-tourism-expenditure-answer-first-entity all-indicator-answers">
                {country1InternationalTourismExpenditureMillion ?? 'Yet to Update'}
              </td>
              <td className="international-tourism-expenditure-answer-second-entity all-indicator-answers">
                {country2InternationalTourismExpenditureMillion ?? 'Yet to Update'}
              </td>
            </tr>
      ...
      {country1GrossNationalExpenditure && country2GrossNationalExpenditure &&
        (
          <>

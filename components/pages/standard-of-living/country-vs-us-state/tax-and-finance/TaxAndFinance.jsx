          ...
          <table class="indicators-first-entity-and-second-entity-div1">
            ...
            <tbody>
              <tr>
                ...
                <td class="income-tax-rates-answer-first-entity all-indicator-answers">
                  {formatPercentage(slug1IncomeTaxRates)}
                </td>
                <td class="income-tax-rates-answer-second-entity all-indicator-answers">
              ...
              <tr>
                ...
                <td class="sales-tax-rates-answer-second-entity all-indicator-answers">
              ...
              <tr>
                ...
                <td class="property-tax-rates-answer-first-entity all-indicator-answers">
                  {formatPercentage(slug1PropertyTaxRates)}
                </td>
                <td class="property-tax-rates-answer-second-entity all-indicator-answers">
              ...
              <tr>
                ...
                <td class="corporate-tax-rates-answer-first-entity all-indicator-answers">
                  {formatPercentage(slug1CorporateTaxRates)}
                </td>
                <td class="corporate-tax-rates-answer-second-entity all-indicator-answers">

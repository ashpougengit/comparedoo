          ...
          <table class="indicators-first-entity-and-second-entity-div1">
            ...
            <tbody>
              <tr>
                ...
                <td class="environmental-factors-answer-first-entity all-indicator-answers">
                  {slug1AccessToInternet
                    ? `${slug1AccessToInternet} %`
                    : 'Yet to Update'}
                </td>
                <td class="environmental-factors-answer-second-entity all-indicator-answers">
                  {slug2AccessToInternet
                    ? `${slug2AccessToInternet} %`
                    : 'Yet to Update'}
                </td>
              </tr>
              <tr>
                ...
                <td class="environmental-factors-answer-first-entity all-indicator-answers">
                  {slug1AccessToElectricity
                    ? `${slug1AccessToElectricity} %`
                    : 'Yet to Update'}
                </td>
                <td class="environmental-factors-answer-second-entity all-indicator-answers">
                  {slug2AccessToElectricity
                    ? `${slug2AccessToElectricity} %`
                    : 'Yet to Update'}
                </td>
              </tr>

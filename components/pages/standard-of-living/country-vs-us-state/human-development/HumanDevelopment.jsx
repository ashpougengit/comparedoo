...
function HumanDevelopment({ slug1, slug2, slug1StandardInfo, slug2StandardInfo, slug1URLCase, slug2URLCase }) {
    ...
    const slug1EmploymentRate = allCountries.includes(slug1) ? (slug1StandardInfo.unemploymentPercentageOfTotalLabourForce ? (100 - slug1StandardInfo.unemploymentPercentageOfTotalLabourForce) : null) : slug1StandardInfo.employmentRate
    ...
    const slug2EmploymentRate = allCountries.includes(slug2) ? (slug2StandardInfo.unemploymentPercentageOfTotalLabourForce ? (100 - slug2StandardInfo.unemploymentPercentageOfTotalLabourForce) : null) : slug2StandardInfo.employmentRate


    const lifeDifference = removeZerosAfterDecimal(Math.abs(slug1LifeExpectancyRatio - slug2LifeExpectancyRatio))
                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">
                                    <div className="hdi-text">Human Development Index (HDI) ({lastYear})</div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td
                                className="life-expectancy-ratio-answer-first-entity all-indicator-answers">
                                {slug1LifeExpectancyRatio ? `${slug1LifeExpectancyRatio} years` : 'Yet to Update'}
                            </td>
                            <td
                                className="life-expectancy-ratio-answer-second-entity all-indicator-answers">
                        ...
                        <tr>
                            ...
                            <td
                                className="unemployment-rate-answer-first-entity all-indicator-answers">
                                {slug1EmploymentRate ? `${slug1EmploymentRate} % of
                                total labor force`: 'Yet to Update'}
                            </td>
                            <td
                                className="unemployment-rate-answer-second-entity all-indicator-answers">
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <strong>
                            [
                            <span className="life-expectancy-ratio-age-calculation"> {lifeDifference} </span>
                            years ]{' '}
                        </strong>

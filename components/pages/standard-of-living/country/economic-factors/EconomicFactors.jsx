                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="gdp-per-capita-answer-first-entity all-indicator-answers">
                                {GDPPerCapita ? `${GDPPerCapita} USD` : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="gini-ratio-answer-first-entity all-indicator-answers">{GINI ? `${(GINI / 100).toFixed(2)}` : 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="inflation-answer-first-entity all-indicator-answers">
                                {inflationOnConsumerPrices ? `${inflationOnConsumerPrices}% anually` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="central-government-debt-answer-first-entity all-indicator-answers">
                                {centralGovernmentDebt ? `${centralGovernmentDebt}% of GDP` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <strong><span className="first-entity-name-pages-paragraph"> {country} </span></strong> is <span className="gdp-answer-first-entity"> {GDPNominal} </span> USD.
                    </p>
                    <br />
                ...
                <table className="indicators-single-country-divs">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="hdi-answer-first-entity all-indicator-answers">{HDI ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="human-capital-index-answer-first-entity all-indicator-answers">{humanCapitalIndex ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="literacy-rate-answer-first-entity all-indicator-answers">{literacyRate ? `${literacyRate}% (15 years+ above
                                age)`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="life-expectancy-ratio-answer-first-entity all-indicator-answers">{lifeExpectancyRatio ? `${lifeExpectancyRatio} years` : 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="healthy-life-expectancy-ratio-answer-first-entity all-indicator-answers">
                                {healthyLifeExpectancyRatio ? `${healthyLifeExpectancyRatio} years` : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="poverty-ratio-answer-first-entity all-indicator-answers">{povertyRatio ? `${povertyRatio}% of total
                        ...
                        <tr>
                            ...
                            <td className="unemployment-rate-answer-first-entity all-indicator-answers">
                                {unemploymentPercentageOfTotalLabourForce ?
                                    `${unemploymentPercentageOfTotalLabourForce}% of total labor force` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        and
                        healthy
                        life, being knowledgeable and having a decent standard of living. This is expressed as a value between 0 and
                        1. The higher a country&apos;s human development, the higher its HDI value.
                    </p>
                </div>
            </div>
        </>

        ...
        <table className="indicators-single-country-divs">
          ...
          <tbody>
            <tr>
              ...
              <td className="density-of-doctors-answer-first-entity all-indicator-answers">{densityOfDoctorsNumber ? (
                <>
                  {densityOfDoctorsNumber}<br />(Per 10,000 People)
                </>
              ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="density-of-nurses-answer-first-entity all-indicator-answers">
                {densityOfNursesNumber ? (
                  <>
                    {densityOfNursesNumber}<br />(Per 10,000 People)
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="density-of-pharmacists-answer-first-entity all-indicator-answers">
                {densityOfPharmacistsNumber ? (
                  <>
                    {densityOfPharmacistsNumber}<br />(Per 10,000 People)
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="available-hospital-beds-answer-first-entity all-indicator-answers">
                {hospitalBedsPer1000Peoples ? (
                  <>
                    {hospitalBedsPer1000Peoples}<br />(Per 10,000 People)
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="pregnant-women-receiving-prenatal-care-answer-first-entity all-indicator-answers">
                {pregnantWomenReceivingPrenatalCare ? `${pregnantWomenReceivingPrenatalCare}% of
                  total Population`: 'Yet to Update'}
              </td>
            </tr>
          </tbody>
        </table>

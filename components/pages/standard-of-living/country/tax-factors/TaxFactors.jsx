          ...
          <tbody>
              ...
              <td className="basic-info">
                <div className="all-indicators">
                  <div className="gross-national-savings-text">
                    Gross National Savings ({lastYear})
                  </div>
                </div>
            ...
            <tr>
              ...
              <td className="taxes-on-exports-answer-first-entity all-indicator-answers">
                {taxesOnExportsPercentageOfTaxRevenue
                  ? `${taxesOnExportsPercentageOfTaxRevenue}% of Tax Revenue`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              <td className="basic-info">
                <div className="all-indicators">
                  <div className="taxes-on-goods-and-services-text">
                    Taxes on Goods and Services ({lastYear})
                  </div>
                </div>
                <div className="basic-information-images">
                  <Image
              ...
              <td className="taxes-on-goods-and-services-answer-first-entity all-indicator-answers">
                {taxesOnGoodsAndServicesPercentageOfRevenue
                  ? `${taxesOnGoodsAndServicesPercentageOfRevenue}% of Tax Revenue`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              <td className="basic-info">
                <div className="all-indicators">
                  <div className="taxes-on-international-trade-text">
                    Taxes on International Trade ({lastYear})
                  </div>
                </div>
                <div className="basic-information-images">
                  <Image
              ...
              <td className="taxes-on-international-trade-answer-first-entity all-indicator-answers">
                {taxesOnInternationalTradePercentageOfRevenue
                  ? `${taxesOnInternationalTradePercentageOfRevenue}% of Revenue`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="time-to-prepare-and-pay-taxes-answer-first-entity all-indicator-answers">
                {timeToPrepareAndPayTaxesHours
                  ? `${timeToPrepareAndPayTaxesHours} ${timeToPrepareAndPayTaxesHours > 1 ? 'Hours' : 'Hour'
                  }`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="customs-and-other-import-duties-answer-first-entity all-indicator-answers">
                {customsAndOtherImportDutiesPercentageOfTaxRevenue
                  ? `${customsAndOtherImportDutiesPercentageOfTaxRevenue}% of Tax Revenue`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

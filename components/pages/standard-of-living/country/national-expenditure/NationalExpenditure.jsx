    ...
    return (
        <>
            ...
            <div className="economic-factors-comparison">
                <h2 className="pages-h2">Government National Expenditure Information</h2>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="gross-national-expenditure-answer-first-entity all-indicator-answers">
                                {grossNationalExpenditure ? `${grossNationalExpenditure}% of
                                GDP`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="health-expenditure-rate-answer-first-entity all-indicator-answers">{currentHealthExpenditurePercentage ? `${currentHealthExpenditurePercentage}% of
                                GDP`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="research-and-development-expenditure-answer-first-entity all-indicator-answers">
                                {researchAndDevelopmentExpenditure ? `${researchAndDevelopmentExpenditure}% of
                                GDP`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="government-expenditure-on-education-answer-first-entity all-indicator-answers">
                                {governmentExpenditureOnEducation ? `${governmentExpenditureOnEducation}% of
                                GDP`: 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="international-tourism-expenditure-answer-first-entity all-indicator-answers">
                                ...
                                <span>{internationalTourismExpenditureUSD ? ' USD' : ''}</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="military-expenditure-answer-first-entity all-indicator-answers">
                                {militaryExpenditure ? `${militaryExpenditure}% of GDP` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

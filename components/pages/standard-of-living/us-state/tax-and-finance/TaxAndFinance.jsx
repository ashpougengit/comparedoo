                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Gas and Fuel Tax of any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="gas-and-fuel-tax-rates-answer-first-entity all-indicator-answers">
                                {gasandFuelTaxRatesPerGallon ? `${gasandFuelTaxRatesPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Beer Tax of any specific country or state" />
                                </div>
                            </td>
                            <td className="beer-tax-rates-answer-first-entity all-indicator-answers">
                                {beerTaxPerGallon ? `${beerTaxPerGallon} USD Per Gallon` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the total Mean Travel Time to Work available in any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="mean-travel-time-to-work-answer-first-entity all-indicator-answers">
                                {meanTravelTimeToWorkMinutes ? `${meanTravelTimeToWorkMinutes} Minutes` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the People Working From Home percentage in any specific country or state" />
                                </div>
                            </td>
                            <td
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the Private Wage and Salary Workers percentage in any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {privateWageandSalaryWorkers ? `${privateWageandSalaryWorkers} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the People Working In Government Sectors percentage in any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {governmentWorkers ? `${governmentWorkers} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the Self-Employed Workers percentage in any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {selfEmployedInNotOwnIncorporatedBusiness ? `${selfEmployedInNotOwnIncorporatedBusiness} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Depicting the Median Income percentage in any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="employment-rate-states-answer-first-entity all-indicator-answers">
                                {medianIncomeDollars ? `${formatNumberWithCommas(medianIncomeDollars)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

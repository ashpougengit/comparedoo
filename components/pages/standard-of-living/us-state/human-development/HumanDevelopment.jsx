                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="literacy-rate-answer-first-entity all-indicator-answers">
                                {literacyRate ? `${literacyRate} % (15 years+ above age)` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                            ...
                            <td
                                ...
                                {lifeExpectancyRatio ? `${lifeExpectancyRatio} years` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                            ...
                            <td className="poverty-ratio-answer-first-entity all-indicator-answers">
                                {povertyRatio ? `${povertyRatio} % of total population` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                            ...
                            <td
                                ...
                                {employmentRate ? `${employmentRate} % of total population` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        of people living in a country or a state. The key dimensions that give a country or a state good HDI rank are a long and healthy life, being knowledgeable and having a decent standard of living. This is expressed as a value between 0 and 1. The higher a country&apos;s or a state&apos;s human development, the higher its HDI value.
                    </p>
                </div>
            </div>
        </>

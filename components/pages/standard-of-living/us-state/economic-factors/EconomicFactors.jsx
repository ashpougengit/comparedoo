                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="gdp-answer-first-entity all-indicator-answers">
                                {GDPNominal ? `${formatNumberWithCommas(GDPNominal)} million USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    <p>
                        ...
                        within a country or a state in a specific time period, usually a year. It is used to gauge the economic performance of a country or a state and indicates how wealthy and productive a nation or a state is. In simple terms, GDP tells us how much a country or a state is producing and how well its economy is doing.
                    </p>
                    <br />
                    <p>
                        ...
                        is
                        <span className="gdp-answer-first-entity"> {formatNumberWithCommas(GDPNominal)} </span>
                    ...
                    <p>
                        ...
                        is the average economic output per person in a country or a state. Simply put, it shows how much, on average, each person contributes to the economy,

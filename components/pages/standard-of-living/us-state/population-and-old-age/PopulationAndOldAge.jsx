    ...
    return (
        <>
            ...
            <div className="economic-factors-comparison">
                <h2 className="pages-h2">Population and Old Age Factors Information</h2>
            </div>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of total population of any specific country or a state" />
                                </div>
                            </td>
                            <td className="total-population-first-entity all-indicator-answers">
                                {population ? formatNumberWithCommas(population) : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of Median Age of any specific country or a state" />
                                </div>
                            </td>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of Sex Ratio of any specific country or a state" />
                                </div>
                            </td>
                            <td className="sex-ratio-first-entity all-indicator-answers">
                                {sexRatioMalesPer100Females ? (
                                    <>
                                        {sexRatioMalesPer100Females}<br /> (Males per 100 Females)
                                    </>
                                ) : 'Yet to Update'}
                            </td>
                        </tr>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of 60 to 64 years age group of any specific country or a state" />
                                </div>
                            </td>
                            <td
                                className="60-to-64-years-population-first-entity all-indicator-answers">
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of 65 to 74 years age group of any specific country or a state" />
                                </div>
                            </td>
                            <td
                                className="65-to-74-years-population-first-entity all-indicator-answers">
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of 75 to 84 years age group of any specific country or a state" />
                                </div>
                            </td>
                            <td
                                className="75-to-84-years-population-first-entity all-indicator-answers">
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Illustration of 85 years and older age group of any specific country or a state" />
                                </div>
                            </td>
                            <td
                                className="85-years-and-older-population-first-entity all-indicator-answers">

                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Total Registered Physicians of any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {totalRegisteredPhysicians ? `${formatNumberWithCommas(totalRegisteredPhysicians)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Total Registered Nurses of any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {totalRegisteredNurses ? `${formatNumberWithCommas(totalRegisteredNurses)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Available Hospital Beds of any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {availableHospitalBeds ? `${formatNumberWithCommas(availableHospitalBeds)}` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Disability Percentage of any specific country or state" />
                                </div>
                            </td>
                            <td
                                className="income-tax-rates-answer-first-entity all-indicator-answers">
                                {disabilityPercentage ? `${disabilityPercentage} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image representing Population Without Health Insurance Coverage of any specific country or state" />
                                </div>
                            </td>
                            <td className="income-tax-rates-first-entity all-indicator-answers">
                                {populationWithoutHealthInsuranceCoverage ? `${populationWithoutHealthInsuranceCoverage} %` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

...
function MapAndDescriptionAntarctica() {
    return (
        <>
            ...
            <div className="map-of-continent-and-ads-section">
                <div className="continent-map">
                    <Image src="/images/map-of-antarctica-big.png" fill
                        sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" alt="Map of Antarctica" />
                </div>
...
export default MapAndDescriptionAntarctica
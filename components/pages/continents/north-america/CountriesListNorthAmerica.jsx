import { northAmericaCountries } from '@/lib/array-list/allCountriesList'
import { toURLFormat } from '@/lib/format/format'
import Image from 'next/image'
import Link from 'next/link'

function CountriesListNorthAmerica() {
    return (
        <>
            ...
            <div className="first-paragraph-of-the-page">
                ...
                <div className="first-para-single-div">
                    <p>
                        There are total of <strong> <span className="number-of-countries-in-the-given-continent">23</span></strong>
                        countries
                        in
                        <strong><span className="continent-name">North America</span></strong>. You can click the countries links below
                        and
                        compare
                        them
                        further to other countries, cities and states in the world.
                    </p>
                </div>
                        ...
                        <Link href={`/general-information/${urlCasedCountry}`} key={index}>
                            <div className="country-map-name-flag">
                                <div className="country-map">
                                    <Image src={`/images/${urlCasedCountry}-map-small.png`} fill alt={`Pictorial representation of map of ${country}`} />
                                </div>
...
export default CountriesListNorthAmerica
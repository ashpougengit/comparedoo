      ...
      <>
        ...
        <div className="map-of-continent-and-ads-section">
          <div className="continent-map">
            <Image
              src="/images/map-of-north-america-big.png"
              layout="fill"
              objectFit="contain"
              alt="Map of North America and outline showing for all countries in North America"
            />
          </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="population-density-answer-continent continent-indicator-answers">
                  25.7 / Square KM [66.4 / Square Mile]
                </td>
              </tr>

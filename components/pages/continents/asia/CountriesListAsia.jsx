    ...
    <>
      ...
      <div className="first-paragraph-of-the-page">
        <div className="first-para-single-div">
          <p>
            There are total of <strong> <span className="number-of-countries-in-the-given-continent">49</span></strong> countries
            in
            <strong><span className="continent-name">Asia</span></strong>. You can click the countries links below and compare
            them

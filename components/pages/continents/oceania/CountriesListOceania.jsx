        ...
        <>
            ...
            <div className="first-paragraph-of-the-page">
                ...
                <div className="first-para-single-div">
                    <p>
                        There are total of <strong> <span className="number-of-countries-in-the-given-continent">15</span></strong>
                        countries
                        in
                        <strong><span className="continent-name">Oceania</span></strong>. You can click the countries links below and
                        compare
                        them

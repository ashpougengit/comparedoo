      ...
      <>
        ...
        <div className="map-of-continent-and-ads-section">
          <div className="continent-map">
            <Image
              src="/images/map-of-oceania-big.png"
              layout="fill"
              objectFit="contain"
              alt="Map of Oceania and outline showing for all countries in Oceania"
            />
          </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="population-density-answer-continent continent-indicator-answers">
                  4.94 / Square KM [12.8 / Square Mile]
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="timezone-answer-continent continent-indicator-answers">
                  UTC+9 (Papua, Palau) to UTC–6 (Easter Island) (west to east)
                </td>
              </tr>

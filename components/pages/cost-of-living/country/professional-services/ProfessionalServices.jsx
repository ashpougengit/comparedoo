            ...
            <tbody>
              <tr>
                ...
                <td className="legal-consultation-per-hour-rate-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(legalConsultationPerHourRate)} ${
                    legalConsultationPerHourRate ? currency : ''
                  }`}
                  <br />{' '}
              ...
              <tr>
                ...
                <td className="accounting-services-per-hour-rate-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(accountingServicesPerHourRate)} ${
                    accountingServicesPerHourRate ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="IT-support-services-per-hour-rate-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(ITSupportServicesPerHourRate)} ${
                    ITSupportServicesPerHourRate ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="technical-services-per-hour-rate-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(technicianServicesPerHourRate)} ${
                    technicianServicesPerHourRate ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''

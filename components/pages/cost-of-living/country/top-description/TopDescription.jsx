        ...
        <div className="para-for-pages-single-div">
          <p>
            ...
            <strong>
              {' '}
              cost of living in{' '}
              <span className="first-entity-name-pag es-paragraph">
                {' '}
                {country}
              </span>
            </strong>
            , covering various aspects such as housing, utilities,
            communication, groceries, transportation, health, clothing,
            childcare, education, entertainment, taxes, finances and

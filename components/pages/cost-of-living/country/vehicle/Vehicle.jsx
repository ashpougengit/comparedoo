            ...
            <tbody>
              <tr>
                ...
                <td className="vehicle-purchase-price-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(vehiclePurchasePrice)} ${
                    vehiclePurchasePrice ? currency : ''
                  }`}
                  <br />{' '}
              ...
              <tr>
                ...
                <td className="vehicle-registration-cost-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(vehicleRegistration)} ${
                    vehicleRegistration ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="driving-license-fees-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(drivingLicenseFees)} ${
                    drivingLicenseFees ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="car-insurance-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(carInsurance)} ${
                    carInsurance ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="car-maintainence-cost-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(carMaintenance)} ${
                    carMaintenance ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="fuel-per-liter-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(fuelPerLiter)} ${
                    fuelPerLiter ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="fuel-per-gallon-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(fuelPerGallon)} ${
                    fuelPerGallon ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ''
              ...
              <tr>
                ...
                <td className="toll-fees-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(tollFees)} ${
                    tollFees ? currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country) ? (
                    ...
                    <span className="toll-fees-first-entity-amount-in-usd amount-in-dollar">{`${
                      tollFees === null
                        ? ''

                ...
                <table className="indicators-single-country-divs">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="average-gross-monthly-salary-first-entity all-indicator-answers">{`${formatNumberWithCommas(averageGrossSalary)} ${averageGrossSalary ? currency : ''}`}
                                <br /> {dollarizedCountries.includes(country) ? '' : (<span className="average-gross-monthly-salary-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(averageGrossSalary * unitValueInUSD)}`}</span>)}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="average-net-monthly-salary-first-entity all-indicator-answers">{`${formatNumberWithCommas(averageNetSalary)} ${averageNetSalary ? currency : ''}`}
                                <br /> {dollarizedCountries.includes(country) ? '' : (<span className="average-net-monthly-salary-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(averageNetSalary * unitValueInUSD)}`}</span>)}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="minimum-wage-first-entity all-indicator-answers">{`${formatNumberWithCommas(minimumWage)} ${minimumWage ? currency : ''}`}
                                <br /> {dollarizedCountries.includes(country) ? '' : (<span className="minimum-wage-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(minimumWage * unitValueInUSD)}`}</span>)}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="average-bonus-first-entity all-indicator-answers">{`${formatNumberWithCommas(averageBonus)} ${averageBonus ? currency : ''}`}
                                <br /> {dollarizedCountries.includes(country) ? '' : (<span className="average-bonus-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(averageBonus * unitValueInUSD)}`}</span>)}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="income-tax-rate-first-entity all-indicator-answers">{incomeTaxRates ? `${incomeTaxRates}%` : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="social-security-contributions-first-entity all-indicator-answers">{socialSecurityContributions ? `${socialSecurityContributions}%` : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="pension-contributions-first-entity all-indicator-answers">{pensionContributions ? `${pensionContributions}%` : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="cost-of-living-index-first-entity all-indicator-answers">{costOfLivingIndex ?? 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="median-household-income-first-entity all-indicator-answers">{`${formatNumberWithCommas(medianHouseholdIncome)} ${medianHouseholdIncome ? currency : ''}`}
                                <br /> {dollarizedCountries.includes(country) ? '' : (<span className="median-household-income-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(medianHouseholdIncome * unitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                    </tbody>
                </table>

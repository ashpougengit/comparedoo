...
function ProfessionalServices({
  ...
  const slug1LegalConsultationPerHourRate =
    slug1CostInfo.legalConsultationPerHourRate;
  const slug1AccountingServicesPerHourRate =
    slug1CostInfo.accountingServicesPerHourRate;
  const slug1ITSupportServicesPerHourRate = parseFloat(
    slug1CostInfo.ITSupportServicesPerHourRate
  );
  const slug1TechnicianServicesPerHourRate =
    slug1CostInfo.technicianServicesPerHourRate;
  const slug1TotalCost =
    ((slug1LegalConsultationPerHourRate || 0) +
      (slug1AccountingServicesPerHourRate || 0) +
      (slug1ITSupportServicesPerHourRate || 0) +
      (slug1TechnicianServicesPerHourRate || 0)) *
    slug1ExchangeRate;

  const slug2LegalConsultationPerHourRate =
    slug2CostInfo.legalConsultationPerHourRate;
  const slug2AccountingServicesPerHourRate =
    slug2CostInfo.accountingServicesPerHourRate;
  const slug2ITSupportServicesPerHourRate = parseFloat(
    slug2CostInfo.ITSupportServicesPerHourRate
  );
  const slug2TechnicianServicesPerHourRate =
    slug2CostInfo.technicianServicesPerHourRate;
  const slug2TotalCost =
    ((slug2LegalConsultationPerHourRate || 0) +
      (slug2AccountingServicesPerHourRate || 0) +
      (slug2ITSupportServicesPerHourRate || 0) +
      (slug2TechnicianServicesPerHourRate || 0)) *
    slug2ExchangeRate;
          ...
          <tbody>
            <tr>
              ...
              <td className="legal-consultation-per-hour-rate-first-entity all-indicator-answers">
                {slug1LegalConsultationPerHourRate
                  ? formatCost(
                    slug1LegalConsultationPerHourRate,
                    slug1ExchangeRate,
                    slug1Currency,
              ...
              <td className="legal-consultation-per-hour-rate-second-entity all-indicator-answers">
                {slug2LegalConsultationPerHourRate
                  ? formatCost(
                    slug2LegalConsultationPerHourRate,
                    slug2ExchangeRate,
                    slug2Currency,
            ...
            <tr>
              ...
              <td className="accounting-services-per-hour-rate-first-entity all-indicator-answers">
                {slug1AccountingServicesPerHourRate
                  ? formatCost(
                    slug1AccountingServicesPerHourRate,
                    slug1ExchangeRate,
                    slug1Currency,
              ...
              <td className="accounting-services-per-hour-rate-second-entity all-indicator-answers">
                {slug2AccountingServicesPerHourRate
                  ? formatCost(
                    slug2AccountingServicesPerHourRate,
                    slug2ExchangeRate,
                    slug2Currency,
            ...
            <tr>
              ...
              <td className="IT-support-services-per-hour-rate-first-entity all-indicator-answers">
                {slug1ITSupportServicesPerHourRate
                  ? formatCost(
                    slug1ITSupportServicesPerHourRate,
                    slug1ExchangeRate,
                    slug1Currency,
              ...
              <td className="IT-support-services-per-hour-rate-second-entity all-indicator-answers">
                {slug2ITSupportServicesPerHourRate
                  ? formatCost(
                    slug2ITSupportServicesPerHourRate,
                    slug2ExchangeRate,
                    slug2Currency,
            ...
            <tr>
              ...
              <td className="technical-services-per-hour-rate-first-entity all-indicator-answers">
                {slug1TechnicianServicesPerHourRate
                  ? formatCost(
                    slug1TechnicianServicesPerHourRate,
                    slug1ExchangeRate,
                    slug1Currency,
              ...
              <td className="technical-services-per-hour-rate-second-entity all-indicator-answers">
                {slug2TechnicianServicesPerHourRate
                  ? formatCost(
                    slug2TechnicianServicesPerHourRate,
                    slug2ExchangeRate,
                    slug2Currency,

...
function Education({
  ...
  const slug1TotalCost =
    ((slug1Preschool || 0) +
      (slug1PrimarySchoolFees || 0) +
      (slug1SecondarySchoolFees || 0) +
      (slug1PrivateSchoolFees || 0) +
      (slug1UniversityTuition || 0) +
      (slug1UniversityTuitionPrivate || 0) +
      (slug1AfterSchoolActivities || 0) +
      (slug1SpecialEducationServices || 0) +
      (slug1Tutoring || 0) +
      (slug1Textbooks || 0) +
      (slug1SchoolSupplies || 0)) *
    slug1ExchangeRate;
  ...
  const slug2TotalCost =
    ((slug2Preschool || 0) +
      (slug2PrimarySchoolFees || 0) +
      (slug2SecondarySchoolFees || 0) +
      (slug2PrivateSchoolFees || 0) +
      (slug2UniversityTuition || 0) +
      (slug2UniversityTuitionPrivate || 0) +
      (slug2AfterSchoolActivities || 0) +
      (slug2SpecialEducationServices || 0) +
      (slug2Tutoring || 0) +
      (slug2Textbooks || 0) +
      (slug2SchoolSupplies || 0)) *
    slug2ExchangeRate;

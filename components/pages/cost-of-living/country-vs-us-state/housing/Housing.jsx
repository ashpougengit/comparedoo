...
function Housing({
  ...
  const slug1Rent1bedroomflatInCityCenter =
    slug1CostInfo.rent1bedroomflatInCityCenter;
  const slug1Rent2bedroomflatInCityCenter =
    slug1CostInfo.rent2bedroomflatInCityCenter;
  const slug1Rent3bedroomflatInCityCenter =
    slug1CostInfo.rent3bedroomflatInCityCenter;
  const slug1Rent1bedroomflatOutsideCityCenter =
    slug1CostInfo.rent1bedroomflatOutsideCityCenter;
  const slug1Rent2bedroomflatOutsideCityCenter =
    slug1CostInfo.rent2bedroomflatOutsideCityCenter;
  const slug1Rent3bedroomflatOutsideCityCenter =
    slug1CostInfo.rent3bedroomflatOutsideCityCenter;
  const slug1MortgageRatesPerMonth = slug1CostInfo.mortgageRatesPerMonth;
  const slug1RealEstateAgentsCommissionFees =
    slug1CostInfo.realEstateAgentsCommissionFees;
  const slug1PropertyTaxRates =
    entity1PropertyAndIncomeTaxInfo.propertyTaxRates;
  const slug1AverageCost =
    (((slug1Rent1bedroomflatInCityCenter || 0) +
      (slug1Rent2bedroomflatInCityCenter || 0) +
      (slug1Rent3bedroomflatInCityCenter || 0) +
      (slug1Rent1bedroomflatOutsideCityCenter || 0) +
      (slug1Rent2bedroomflatOutsideCityCenter || 0) +
      (slug1Rent3bedroomflatOutsideCityCenter || 0)) /
      6) *
    slug1ExchangeRate;

  const slug2Rent1bedroomflatInCityCenter =
    slug2CostInfo.rent1bedroomflatInCityCenter;
  const slug2Rent2bedroomflatInCityCenter =
    slug2CostInfo.rent2bedroomflatInCityCenter;
  const slug2Rent3bedroomflatInCityCenter =
    slug2CostInfo.rent3bedroomflatInCityCenter;
  const slug2Rent1bedroomflatOutsideCityCenter =
    slug2CostInfo.rent1bedroomflatOutsideCityCenter;
  const slug2Rent2bedroomflatOutsideCityCenter =
    slug2CostInfo.rent2bedroomflatOutsideCityCenter;
  const slug2Rent3bedroomflatOutsideCityCenter =
    slug2CostInfo.rent3bedroomflatOutsideCityCenter;
  const slug2MortgageRatesPerMonth = slug2CostInfo.mortgageRatesPerMonth;
  const slug2RealEstateAgentsCommissionFees =
    slug2CostInfo.realEstateAgentsCommissionFees;
  const slug2PropertyTaxRates =
    entity2PropertyAndIncomeTaxInfo.propertyTaxRates;
  const slug2AverageCost =
    (((slug2Rent1bedroomflatInCityCenter || 0) +
      (slug2Rent2bedroomflatInCityCenter || 0) +
      (slug2Rent3bedroomflatInCityCenter || 0) +
      (slug2Rent1bedroomflatOutsideCityCenter || 0) +
      (slug2Rent2bedroomflatOutsideCityCenter || 0) +
      (slug2Rent3bedroomflatOutsideCityCenter || 0)) /
      6) *
    slug2ExchangeRate;

  const costTimes =
    slug1AverageCost > slug2AverageCost
      ? (slug1AverageCost / slug2AverageCost).toFixed(2)
      : (slug2AverageCost / slug1AverageCost).toFixed(2);

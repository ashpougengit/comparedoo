                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                className="rent-1-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent1bedroomflatInCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent1bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent1bedroomflatInCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent1bedroomflatInCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            ...
                            <td
                                className="rent-1-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent1bedroomflatInCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent1bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent1bedroomflatInCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent1bedroomflatInCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="rent-2-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent2bedroomflatInCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent2bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent2bedroomflatInCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent2bedroomflatInCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td
                                className="rent-2-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent2bedroomflatInCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent2bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent2bedroomflatInCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent2bedroomflatInCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="rent-3-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent3bedroomflatInCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent3bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent3bedroomflatInCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent3bedroomflatInCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td
                                className="rent-3-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent3bedroomflatInCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent3bedroomflatInCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent3bedroomflatInCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent3bedroomflatInCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="rent-1-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent1bedroomflatOutsideCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent1bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent1bedroomflatOutsideCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent1bedroomflatOutsideCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td
                                className="rent-1-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent1bedroomflatOutsideCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent1bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent1bedroomflatOutsideCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent1bedroomflatOutsideCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="rent-2-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent2bedroomflatOutsideCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent2bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent2bedroomflatOutsideCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent2bedroomflatOutsideCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td
                                className="rent-2-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent2bedroomflatOutsideCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent2bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent2bedroomflatOutsideCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent2bedroomflatOutsideCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="rent-3-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                {slug1Rent3bedroomflatOutsideCityCenter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1Rent3bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1Rent3bedroomflatOutsideCityCenter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rent3bedroomflatOutsideCityCenter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td
                                className="rent-3-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                {slug2Rent3bedroomflatOutsideCityCenter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2Rent3bedroomflatOutsideCityCenter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2Rent3bedroomflatOutsideCityCenter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rent3bedroomflatOutsideCityCenter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="mortgage-rates-per-month-index-answer-first-entity all-indicator-answers">
                                {slug1MortgageRatesPerMonth ? `${slug1MortgageRatesPerMonth} %` : 'Yet to Update'}
                            </td>
                            <td
                                className="mortgage-rates-per-month-index-answer-second-entity all-indicator-answers">
                                {slug2MortgageRatesPerMonth ? `${slug2MortgageRatesPerMonth} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="real-estate-agents-commission-fees-answer-first-entity all-indicator-answers">
                                {slug1RealEstateAgentsCommissionFees ? `${slug1RealEstateAgentsCommissionFees} %` : 'Yet to Update'}
                            </td>
                            <td
                                className="real-estate-agents-commission-fees-answer-second-entity all-indicator-answers">
                                {slug2RealEstateAgentsCommissionFees ? `${slug2RealEstateAgentsCommissionFees} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="property-taxes-answer-first-entity all-indicator-answers">
                                {slug1PropertyTaxRates ? `${slug1PropertyTaxRates} %` : 'Yet to Update'}
                            </td>
                            <td
                                className="property-taxes-answer-second-entity all-indicator-answers">
                                {slug2PropertyTaxRates ? `${slug2PropertyTaxRates} %` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

...
function BasicUtilities({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1TotalCost = ((slug1HomeFurnishing || 0) + (slug1ElectricityCostPerMonth || 0) + (slug1HeatingCostPerMonth || 0) + (slug1CoolingCostPerMonth || 0) + (slug1WaterCostPerMonth || 0)) * slug1ExchangeRate
    ...
    const slug2TotalCost = ((slug2HomeFurnishing || 0) + (slug2ElectricityCostPerMonth || 0) + (slug2HeatingCostPerMonth || 0) + (slug2CoolingCostPerMonth || 0) + (slug2WaterCostPerMonth || 0)) * slug2ExchangeRate
    ...
    const furnishingCostTimes = slug1HomeFurnishingInUSD > slug2HomeFurnishingInUSD ? (slug1HomeFurnishingInUSD / slug2HomeFurnishingInUSD).toFixed(2) : (slug2HomeFurnishingInUSD / slug1HomeFurnishingInUSD).toFixed(2)
    const moreOrLessFurnishing = slug1HomeFurnishingInUSD > slug2HomeFurnishingInUSD ? 'more' : 'less'

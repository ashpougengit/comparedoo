...
function PersonalCare({
  ...
  const slug1TotalCost =
    ((slug1CosmeticProcedures || 0) +
      (slug1SpaTreatment || 0) +
      (slug1ManicurePedicureCost || 0) +
      (slug1OpticalGlasses || 0) +
      (slug1ContactLenses || 0) +
      (slug1Haircuts || 0) +
      (slug1HairColoring || 0) +
      (slug1ShampooPrice || 0) +
      (slug1ToothpastePrice || 0)) *
    slug1ExchangeRate;
  ...
  const slug2TotalCost =
    ((slug2CosmeticProcedures || 0) +
      (slug2SpaTreatment || 0) +
      (slug2ManicurePedicureCost || 0) +
      (slug2OpticalGlasses || 0) +
      (slug2ContactLenses || 0) +
      (slug2Haircuts || 0) +
      (slug2HairColoring || 0) +
      (slug2ShampooPrice || 0) +
      (slug2ToothpastePrice || 0)) *
    slug2ExchangeRate;

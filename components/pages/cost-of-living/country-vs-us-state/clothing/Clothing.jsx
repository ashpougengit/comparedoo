...
function Clothing({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1TotalCost = ((slug1PairOfNikeRunningShoes || 0) + (slug1MensDressShirt || 0) + (slug1WomensDress || 0) + (slug1SummerDress || 0) + (slug1MensSuit || 0) + (slug1MensJeans || 0) + (slug1WomensJeans || 0) + (slug1MensFormalShoes || 0) + (slug1WomensFormalShoes || 0) + (slug1MensCasualShoes || 0) + (slug1WomensCasualShoes || 0) + (slug1UnderwearMen || 0) + (slug1UnderwearWomen || 0) + (slug1SocksMen || 0) + (slug1SocksWomen || 0) + (slug1WinterCoatForAdults || 0) + (slug1Sportswear || 0)) * slug1ExchangeRate
    ...
    const slug2TotalCost = ((slug2PairOfNikeRunningShoes || 0) + (slug2MensDressShirt || 0) + (slug2WomensDress || 0) + (slug2SummerDress || 0) + (slug2MensSuit || 0) + (slug2MensJeans || 0) + (slug2WomensJeans || 0) + (slug2MensFormalShoes || 0) + (slug2WomensFormalShoes || 0) + (slug2MensCasualShoes || 0) + (slug2WomensCasualShoes || 0) + (slug2UnderwearMen || 0) + (slug2UnderwearWomen || 0) + (slug2SocksMen || 0) + (slug2SocksWomen || 0) + (slug2WinterCoatForAdults || 0) + (slug2Sportswear || 0)) * slug2ExchangeRate
...
objectFit="contain"alt="Image Describing Pair of Nike Running Shoes" />
                            ...
                            <td
                                className="pair-of-nike-running-shoes-first-entity all-indicator-answers">
                                {slug1PairOfNikeRunningShoes ? formatCost(slug1PairOfNikeRunningShoes, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="pair-of-nike-running-shoes-second-entity all-indicator-answers">
                                {slug2PairOfNikeRunningShoes ? formatCost(slug2PairOfNikeRunningShoes, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Shirt" />
                            ...
                            <td className="mens-dress-shirt-first-entity all-indicator-answers">
                                {slug1MensDressShirt ? formatCost(slug1MensDressShirt, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mens-dress-shirt-second-entity all-indicator-answers">
                                {slug2MensDressShirt ? formatCost(slug2MensDressShirt, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Shirt" />
                            ...
                            <td className="womens-dress-first-entity all-indicator-answers">
                                {slug1WomensDress ? formatCost(slug1WomensDress, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="womens-dress-second-entity all-indicator-answers">
                                {slug2WomensDress ? formatCost(slug2WomensDress, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Summer Dress" />
                            ...
                            <td className="summer-dress-first-entity all-indicator-answers">
                                {slug1SummerDress ? formatCost(slug1SummerDress, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="summer-dress-second-entity all-indicator-answers">
                                {slug2SummerDress ? formatCost(slug2SummerDress, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Suit" />
                            ...
                            <td className="mens-dress-shirt-first-entity all-indicator-answers">
                                {slug1MensSuit ? formatCost(slug1MensSuit, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mens-dress-shirt-second-entity all-indicator-answers">
                                {slug2MensSuit ? formatCost(slug2MensSuit, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Jeans" />
                            ...
                            <td className="mens-jeans-first-entity all-indicator-answers">
                                {slug1MensJeans ? formatCost(slug1MensJeans, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mens-jeans-second-entity all-indicator-answers">
                                {slug2MensJeans ? formatCost(slug2MensJeans, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Jeans" />
                            ...
                            <td className="womens-jeans-first-entity all-indicator-answers">
                                {slug1WomensJeans ? formatCost(slug1WomensJeans, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="womens-jeans-second-entity all-indicator-answers">
                                {slug2WomensJeans ? formatCost(slug2WomensJeans, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's formal Shoes" />
                            ...
                            <td className="mens-formal-shoes-first-entity all-indicator-answers">
                                {slug1MensFormalShoes ? formatCost(slug1MensFormalShoes, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mens-formal-shoes-second-entity all-indicator-answers">
                                {slug2MensFormalShoes ? formatCost(slug2MensFormalShoes, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's formal Shoes" />
                            ...
                            <td className="women-formal-shoes-first-entity all-indicator-answers">
                                {slug1WomensFormalShoes ? formatCost(slug1WomensFormalShoes, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="women-formal-shoes-second-entity all-indicator-answers">
                                {slug2WomensFormalShoes ? formatCost(slug2WomensFormalShoes, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Casual Shoes" />
                            ...
                            <td className="mens-casual-shoes-first-entity all-indicator-answers">
                                {slug1MensCasualShoes ? formatCost(slug1MensCasualShoes, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mens-casual-shoes-second-entity all-indicator-answers">
                                {slug2MensCasualShoes ? formatCost(slug2MensCasualShoes, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Casual Shoes" />
                            ...
                            <td className="women-casual-shoes-first-entity all-indicator-answers">
                                {slug1WomensCasualShoes ? formatCost(slug1WomensCasualShoes, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="women-casual-shoes-second-entity all-indicator-answers">
                                {slug2WomensCasualShoes ? formatCost(slug2WomensCasualShoes, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Underwear For Men" />
                            ...
                            <td className="underwear-for-men-first-entity all-indicator-answers">
                                {slug1UnderwearMen ? formatCost(slug1UnderwearMen, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="underwear-for-men-second-entity all-indicator-answers">
                                {slug2UnderwearMen ? formatCost(slug2UnderwearMen, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Underwear For Women" />
                            ...
                            <td className="underwear-for-women-first-entity all-indicator-answers">
                                {slug1UnderwearWomen ? formatCost(slug1UnderwearWomen, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="underwear-for-women-second-entity all-indicator-answers">
                                {slug2UnderwearWomen ? formatCost(slug2UnderwearWomen, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing socks For Men" />
                            ...
                            <td className="socks-for-men-first-entity all-indicator-answers">
                                {slug1SocksMen ? formatCost(slug1SocksMen, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="socks-for-men-second-entity all-indicator-answers">
                                {slug2SocksMen ? formatCost(slug2SocksMen, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing socks For Women" />
                            ...
                            <td className="socks-for-women-first-entity all-indicator-answers">
                                {slug1SocksWomen ? formatCost(slug1SocksWomen, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="socks-for-women-second-entity all-indicator-answers">
                                {slug2SocksWomen ? formatCost(slug2SocksWomen, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Wintercoat for Adults" />
                            ...
                            <td
                                className="wintercoat-for-adults-first-entity all-indicator-answers">
                                {slug1WinterCoatForAdults ? formatCost(slug1WinterCoatForAdults, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="wintercoat-for-adults-second-entity all-indicator-answers">
                                {slug2WinterCoatForAdults ? formatCost(slug2WinterCoatForAdults, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Sportswear" />
                            ...
                            <td className="sportswear-first-entity all-indicator-answers">
                                {slug1Sportswear ? formatCost(slug1Sportswear, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="sportswear-second-entity all-indicator-answers">
                                {slug2Sportswear ? formatCost(slug2Sportswear, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

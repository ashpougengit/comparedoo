...
function DiningOut({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1URLCase, slug2URLCase }) {
          ...
          <tbody>
            <tr>
              ...
              <td className="meal-at-a-resonable-restaurant-first-entity all-indicator-answers">
                {slug1MealAtInexpensiveRestaurant
                  ? formatCost(
                    slug1MealAtInexpensiveRestaurant,
                    slug1ExchangeRate,
                    slug1Currency,
              ...
              <td className="meal-at-a-resonable-restaurant-second-entity all-indicator-answers">
                {slug2MealAtInexpensiveRestaurant
                  ? formatCost(
                    slug2MealAtInexpensiveRestaurant,
                    slug2ExchangeRate,
                    slug2Currency,

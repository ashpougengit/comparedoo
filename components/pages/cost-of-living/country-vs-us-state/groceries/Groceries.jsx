...
function Groceries({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    const slug1Rice1Kg = slug1CostInfo.rice1Kg
    const slug1MilkOneLiter = slug1CostInfo.milkOneLiter
    ...
    const slug1WaterAndMilkCost = ((slug1Water1Liter || 0) + (slug1MilkOneLiter || 0)) * slug1ExchangeRate
    const slug1TotalCost = ((slug1Rice1Kg || 0) + (slug1MilkOneLiter || 0) + (slug1Water1Liter || 0) + (slug1Bread500g || 0) + (slug1EggsDozen || 0) + (slug1Cheese1Kg || 0) + (slug1ChickenBreasts1Kg || 0)) * slug1ExchangeRate

    const slug2Rice1Kg = slug2CostInfo.rice1Kg
    const slug2MilkOneLiter = slug2CostInfo.milkOneLiter
    ...
    const slug2WaterAndMilkCost = ((slug2Water1Liter || 0) + (slug2MilkOneLiter || 0)) * slug2ExchangeRate
    const slug2TotalCost = ((slug2Rice1Kg || 0) + (slug2MilkOneLiter || 0) + (slug2Water1Liter || 0) + (slug2Bread500g || 0) + (slug2EggsDozen || 0) + (slug2Cheese1Kg || 0) + (slug2ChickenBreasts1Kg || 0)) * slug2ExchangeRate


    const waterAndMilkTimes = slug1WaterAndMilkCost > slug2WaterAndMilkCost ? (slug1WaterAndMilkCost / slug2WaterAndMilkCost).toFixed(2) : (slug2WaterAndMilkCost / slug1WaterAndMilkCost).toFixed(2)
    const moreOrLessTimes = slug1WaterAndMilkCost > slug2WaterAndMilkCost ? 'more' : 'less'
    const percentageDifference = (((Math.abs(slug1TotalCost - slug2TotalCost)) / slug2TotalCost) * 100).toFixed(2)
    const moreOrLessPercentage = slug1TotalCost > slug2TotalCost ? 'more' : 'less'
                    ...
                    <tbody>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing rice cost per month" />
                                </div>
                            </td>
                            ...
                            <td className="rice-1-kg-first-entity all-indicator-answers">
                                {slug1Rice1Kg ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1Rice1Kg)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Rice1Kg * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="rice-1-kg-second-entity all-indicator-answers">
                                {slug2Rice1Kg ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2Rice1Kg)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Rice1Kg * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing milk cost per month" />
                                </div>
                            </td>
                            ...
                            <td className="milk-1-liter-first-entity all-indicator-answers">
                                {slug1MilkOneLiter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        `${formatNumberWithCommas(slug1MilkOneLiter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug1MilkOneLiter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1MilkOneLiter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="milk-1-liter-second-entity all-indicator-answers">
                                {slug2MilkOneLiter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        `${formatNumberWithCommas(slug2MilkOneLiter)} USD`
                                    ) : (
                                        <>
                                            {`${formatNumberWithCommas(slug2MilkOneLiter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2MilkOneLiter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            ...
                            <td className="water-1-liter-first-entity all-indicator-answers">
                                {slug1Water1Liter ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1Water1Liter)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Water1Liter * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="water-1-liter-second-entity all-indicator-answers">
                                {slug2Water1Liter ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2Water1Liter)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Water1Liter * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing bread cost per month" />
                                </div>
                            </td>
                            ...
                            <td className="bread-first-entity all-indicator-answers">
                                {slug1Bread500g ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1Bread500g)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Bread500g * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="bread-second-entity all-indicator-answers">
                                {slug2Bread500g ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2Bread500g)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Bread500g * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing eggs cost per month" />
                                </div>
                            </td>
                            ...
                            <td className="eggs-first-entity all-indicator-answers">
                                {slug1EggsDozen ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1EggsDozen)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1EggsDozen * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="eggs-second-entity all-indicator-answers">
                                {slug2EggsDozen ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2EggsDozen)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2EggsDozen * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing cheese cost per month" />
                                </div>
                            </td>
                            ...
                            <td className="cheese-1-kg-first-entity all-indicator-answers">
                                {slug1Cheese1Kg ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1Cheese1Kg)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1Cheese1Kg * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="cheese-1-kg-second-entity all-indicator-answers">
                                {slug2Cheese1Kg ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2Cheese1Kg)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2Cheese1Kg * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            ...
                            <td className="chicken-1-kg-first-entity all-indicator-answers">
                                {slug1ChickenBreasts1Kg ? (
                                    value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug1ChickenBreasts1Kg)} ${slug1Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug1ChickenBreasts1Kg * slug1ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
                            <td className="chicken-1-kg-second-entity all-indicator-answers">
                                {slug2ChickenBreasts1Kg ? (
                                    value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                                        ...
                                        <>
                                            {`${formatNumberWithCommas(slug2ChickenBreasts1Kg)} ${slug2Currency}`} <br />
                                            {`(${formatNumberWithCommas(slug2ChickenBreasts1Kg * slug2ExchangeRate)} USD)`}
                                        </>
                                    )
                                ) : 'Yet to Update'}
                            </td>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <strong>
                            <span className="water-and-milk-dollar-price-calculation"> {waterAndMilkTimes} </span>
                            times
                        </strong>
                        <span className="milk-water-more-less-calculation"> {moreOrLessTimes} </span>
                    ...
                    <p>
                        ...
                        <strong>
                            <span className="groceries-calculation"> {percentageDifference}% </span>
                            <span className="groceries-more-or-less-calculation"> {moreOrLessPercentage} </span>
                        </strong>
                        for Groceries.
                    </p>
                </div>

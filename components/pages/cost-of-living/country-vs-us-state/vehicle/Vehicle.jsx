...
function Vehicle({
  ...
  const slug1TotalCost =
    ((slug1VehiclePurchasePrice || 0) +
      (slug1VehicleRegistration || 0) +
      (slug1DrivingLicenseFees || 0) +
      (slug1CarInsurance || 0) +
      (slug1CarMaintenance || 0) +
      (slug1FuelPerLiter || 0) +
      (slug1FuelPerGallon || 0) +
      (slug1TollFees || 0)) *
    slug1ExchangeRate;
  ...
  const slug2TotalCost =
    ((slug2VehiclePurchasePrice || 0) +
      (slug2VehicleRegistration || 0) +
      (slug2DrivingLicenseFees || 0) +
      (slug2CarInsurance || 0) +
      (slug2CarMaintenance || 0) +
      (slug2FuelPerLiter || 0) +
      (slug2FuelPerGallon || 0) +
      (slug2TollFees || 0)) *
    slug2ExchangeRate;

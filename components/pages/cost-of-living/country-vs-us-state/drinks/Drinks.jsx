...
function Drinks({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1TotalCost = ((slug1WineMidRangeBottle || 0) + (slug1GlassOfWine || 0) + (slug1DomesticBeerHalfLiter || 0) + (slug1ImportedBeerHalfLiter || 0) + (slug1DomesticAlcohol1Liter || 0) + (slug1BrandedAlcohol1Liter || 0)) * slug1ExchangeRate
    ...
    const slug2TotalCost = ((slug2WineMidRangeBottle || 0) + (slug2GlassOfWine || 0) + (slug2DomesticBeerHalfLiter || 0) + (slug2ImportedBeerHalfLiter || 0) + (slug2DomesticAlcohol1Liter || 0) + (slug2BrandedAlcohol1Liter || 0)) * slug2ExchangeRate
                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing Wine Mid Range Bottle" />
                                </div>
                            </td>

                            <td
                                className="wine-mid-range-bottle-first-entity all-indicator-answers">
                                {slug1WineMidRangeBottle ? formatCost(slug1WineMidRangeBottle, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="wine-mid-range-bottle-second-entity all-indicator-answers">
                                {slug2WineMidRangeBottle ? formatCost(slug2WineMidRangeBottle, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing cost of Glass of Wine" />
                                </div>
                            </td>

                            <td
                                className="three-course-meal-for-two-first-entity all-indicator-answers">
                                {slug1GlassOfWine ? formatCost(slug1GlassOfWine, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="three-course-meal-for-two-second-entity all-indicator-answers">
                                {slug2GlassOfWine ? formatCost(slug2GlassOfWine, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="domestic-beer-half-liter-first-entity all-indicator-answers">
                                {slug1DomesticBeerHalfLiter ? formatCost(slug1DomesticBeerHalfLiter, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="domestic-beer-half-liter-second-entity all-indicator-answers">
                                {slug2DomesticBeerHalfLiter ? formatCost(slug2DomesticBeerHalfLiter, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="imported-beer-half-liter-first-entity all-indicator-answers">
                                {slug1ImportedBeerHalfLiter ? formatCost(slug1ImportedBeerHalfLiter, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="imported-beer-half-liter-second-entity all-indicator-answers">
                                {slug2ImportedBeerHalfLiter ? formatCost(slug2ImportedBeerHalfLiter, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="domestic-alcohol-1-liter-first-entity all-indicator-answers">
                                {slug1DomesticAlcohol1Liter ? formatCost(slug1DomesticAlcohol1Liter, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="domestic-alcohol-1-liter-second-entity all-indicator-answers">
                                {slug2DomesticAlcohol1Liter ? formatCost(slug2DomesticAlcohol1Liter, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="branded-alcohol-1-liter-first-entity all-indicator-answers">
                                {slug1BrandedAlcohol1Liter ? formatCost(slug1BrandedAlcohol1Liter, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="branded-alcohol-1-liter-second-entity all-indicator-answers">
                                {slug2BrandedAlcohol1Liter ? formatCost(slug2BrandedAlcohol1Liter, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

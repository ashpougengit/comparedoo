...
function FruitsAndVegetables({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1TotalCost = ((slug1Apples1Kg || 0) + (slug1Bananas1Kg || 0) + (slug1Oranges1Kg || 0) + (slug1Tomatoes1Kg || 0) + (slug1Potatoes1Kg || 0) + (slug1Lemons1Kg || 0) + (slug1Onions1Kg || 0) + (slug1Lentils1Kg || 0)) * slug1ExchangeRate
    ...
    const slug2TotalCost = ((slug2Apples1Kg || 0) + (slug2Bananas1Kg || 0) + (slug2Oranges1Kg || 0) + (slug2Tomatoes1Kg || 0) + (slug2Potatoes1Kg || 0) + (slug2Lemons1Kg || 0) + (slug2Onions1Kg || 0) + (slug2Lentils1Kg || 0)) * slug2ExchangeRate

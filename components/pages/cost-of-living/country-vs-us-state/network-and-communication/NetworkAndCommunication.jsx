...
function NetworkAndCommunication({
  ...
  const slug1MobilePhonePlanCostPerMonth =
    slug1CostInfo.mobilePhonePlanCostPerMonth;
  const slug1LandlinePhoneServicePerMonth =
    slug1CostInfo.landlinePhoneServicePerMonth;
  const slug1CableTVServicePerMonth = slug1CostInfo.cableTVServicePerMonth;
  const slug1TotalCost =
    ((slug1WifiCostPerMonth || 0) +
      (slug1MobilePhonePlanCostPerMonth || 0) +
      (slug1LandlinePhoneServicePerMonth || 0) +
      (slug1CableTVServicePerMonth || 0)) *
    slug1ExchangeRate;

  const slug2WifiCostPerMonth = slug2CostInfo.wifiCostPerMonth;
  const slug2MobilePhonePlanCostPerMonth =
    slug2CostInfo.mobilePhonePlanCostPerMonth;
  const slug2LandlinePhoneServicePerMonth =
    slug2CostInfo.landlinePhoneServicePerMonth;
  const slug2CableTVServicePerMonth = slug2CostInfo.cableTVServicePerMonth;
  const slug2TotalCost =
    ((slug2WifiCostPerMonth || 0) +
      (slug2MobilePhonePlanCostPerMonth || 0) +
      (slug2LandlinePhoneServicePerMonth || 0) +
      (slug2CableTVServicePerMonth || 0)) *
    slug2ExchangeRate;
                ...
                {slug1WifiCostPerMonth ? (
                  value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug1WifiCostPerMonth * slug1ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug2WifiCostPerMonth ? (
                  value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug2WifiCostPerMonth * slug2ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug1MobilePhonePlanCostPerMonth ? (
                  value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug1MobilePhonePlanCostPerMonth * slug1ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug2MobilePhonePlanCostPerMonth ? (
                  value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug2MobilePhonePlanCostPerMonth * slug2ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug1LandlinePhoneServicePerMonth ? (
                  value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug1LandlinePhoneServicePerMonth * slug1ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug2LandlinePhoneServicePerMonth ? (
                  value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug2LandlinePhoneServicePerMonth * slug2ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug1CableTVServicePerMonth ? (
                  value1 === 'state' || dollarizedCountries.includes(slug1) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug1CableTVServicePerMonth * slug1ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (
                ...
                {slug2CableTVServicePerMonth ? (
                  value2 === 'state' || dollarizedCountries.includes(slug2) ? (
                    ...
                    <>
                      ...
                      <br />
                      {`(${formatNumberWithCommas(
                        slug2CableTVServicePerMonth * slug2ExchangeRate
                      )} USD)`}
                    </>
                  )
                ) : (

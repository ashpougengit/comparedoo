...
function WagesAndTaxes({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, entity1PropertyAndIncomeTaxInfo, entity2PropertyAndIncomeTaxInfo, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    const slug1AverageGrossSalary = slug1CostInfo.averageGrossSalary
    const slug1AverageNetSalary = slug1CostInfo.averageNetSalary
    const slug1MinimumWage = slug1CostInfo.minimumWage
    ...
    const slug1SocialSecurityContributions = slug1CostInfo.socialSecurityContributions
    ...
    const slug1TotalCost = ((slug1AverageGrossSalary || 0) + (slug1AverageNetSalary || 0) + (slug1MinimumWage || 0) + (slug1AverageBonus || 0) + (slug1MedianHouseholdIncome || 0)) * slug1ExchangeRate

    const slug2AverageGrossSalary = slug2CostInfo.averageGrossSalary
    const slug2AverageNetSalary = slug2CostInfo.averageNetSalary
    const slug2MinimumWage = slug2CostInfo.minimumWage
    ...
    const slug2SocialSecurityContributions = slug2CostInfo.socialSecurityContributions
    ...
    const slug2TotalCost = ((slug2AverageGrossSalary || 0) + (slug2AverageNetSalary || 0) + (slug2MinimumWage || 0) + (slug2AverageBonus || + slug2MedianHouseholdIncome || 0)) * slug2ExchangeRate
                ...
                <table className="indicators-first-entity-and-second-entity-div1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                className="average-gross-monthly-salary-first-entity all-indicator-answers">
                                {slug1AverageGrossSalary ? formatCost(slug1AverageGrossSalary, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="average-gross-monthly-salary-second-entity all-indicator-answers">
                                {slug2AverageGrossSalary ? formatCost(slug2AverageGrossSalary, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="average-net-monthly-salary-first-entity all-indicator-answers">
                                {slug1AverageNetSalary ? formatCost(slug1AverageNetSalary, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="average-net-monthly-salary-second-entity all-indicator-answers">
                                {slug2AverageNetSalary ? formatCost(slug2AverageNetSalary, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing Minimum Wages" />
                                </div>
                            </td>

                            <td className="minimum-wage-first-entity all-indicator-answers">
                                {slug1MinimumWage ? `${slug1MinimumWage} per hour` : 'Yet to Update'}
                            </td>
                            <td className="minimum-wage-second-entity all-indicator-answers">
                                {slug2MinimumWage ? `${slug2MinimumWage} per hour` : 'Yet to Update'}
                            </td>
                        </tr>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing Average Bonus" />
                                </div>
                            </td>

                            <td className="average-bonus-first-entity all-indicator-answers">
                                {slug1AverageBonus ? formatCost(slug1AverageBonus, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="average-bonus-second-entity all-indicator-answers">
                                {slug2AverageBonus ? formatCost(slug2AverageBonus, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                            ...
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image
                                        ...
                                        fill alt="Image Describing Income Tax Rate" />
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                className="social-security-contributions-first-entity all-indicator-answers">
                                {slug1SocialSecurityContributions ? `${slug1SocialSecurityContributions} %` : 'Yet to Update'}
                            </td>
                            <td
                                className="social-security-contributions-second-entity all-indicator-answers">
                                {slug2SocialSecurityContributions ? `${slug2SocialSecurityContributions} %` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="pension-contributions-first-entity all-indicator-answers">
                                {slug1PensionContributions ? `${slug1PensionContributions} %` : 'Yet to Update'}
                            </td>
                            <td
                                className="pension-contributions-second-entity all-indicator-answers">
                                {slug2PensionContributions ? `${slug2PensionContributions} %` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <span className="salary-cost-more-or-less-calculation"> {moreOrLess}{' '} </span>

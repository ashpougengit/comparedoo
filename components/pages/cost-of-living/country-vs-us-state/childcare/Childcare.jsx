...
function Childcare({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1EarlyChildhoodEducationPrograms = slug1CostInfo.earlyChildhoodEducationPrograms
    const slug1ExtracurricularActivities = slug1CostInfo.extracurricularActivities
    const slug1SummerCamp = slug1CostInfo.summerCamp
    const slug1TotalCost = ((slug1ChildrensJeans || 0) + (slug1ChildrensSneakers || 0) + (slug1ChildrensWinterCoat || 0) + (slug1DaycareInfant || 0) + (slug1DaycareToddler || 0) + (slug1ChildcareForSickDays || 0) + (slug1EarlyChildhoodEducationPrograms || 0) + (slug1ExtracurricularActivities || 0) + (slug1SummerCamp || 0)) * slug1ExchangeRate
    ...
    const slug2EarlyChildhoodEducationPrograms = slug2CostInfo.earlyChildhoodEducationPrograms
    const slug2ExtracurricularActivities = slug2CostInfo.extracurricularActivities
    const slug2SummerCamp = slug2CostInfo.summerCamp
    const slug2TotalCost = ((slug2ChildrensJeans || 0) + (slug2ChildrensSneakers || 0) + (slug2ChildrensWinterCoat || 0) + (slug2DaycareInfant || 0) + (slug2DaycareToddler || 0) + (slug2ChildcareForSickDays || 0) + (slug2EarlyChildhoodEducationPrograms || 0) + (slug2ExtracurricularActivities || 0) + (slug2SummerCamp || 0)) * slug2ExchangeRate
...
objectFit="contain"alt="Image Describing Children Jeans" />
                            ...
                            <td className="children-jeans-first-entity all-indicator-answers">
                                {slug1ChildrensJeans ? formatCost(slug1ChildrensJeans, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="children-jeans-second-entity all-indicator-answers">
                                {slug2ChildrensJeans ? formatCost(slug2ChildrensJeans, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Children Normal Sneakers" />
                            ...
                            <td className="children-sneakers-first-entity all-indicator-answers">
                                {slug1ChildrensSneakers ? formatCost(slug1ChildrensSneakers, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="children-sneakers-second-entity all-indicator-answers">
                                {slug2ChildrensSneakers ? formatCost(slug2ChildrensSneakers, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Children's Winter Coat" />
                            ...
                            <td className="children-winter-coat-first-entity all-indicator-answers">
                                {slug1ChildrensWinterCoat ? formatCost(slug1ChildrensWinterCoat, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="children-winter-coat-second-entity all-indicator-answers">
                                {slug2ChildrensWinterCoat ? formatCost(slug2ChildrensWinterCoat, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Daycare for Infant" />
                            ...
                            <td className="daycare-infant-first-entity all-indicator-answers">
                                {slug1DaycareInfant ? formatCost(slug1DaycareInfant, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="daycare-infant-second-entity all-indicator-answers">
                                {slug2DaycareInfant ? formatCost(slug2DaycareInfant, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Daycare for Toddler" />
                            ...
                            <td className="daycare-toddler-first-entity all-indicator-answers">
                                {slug1DaycareToddler ? formatCost(slug1DaycareToddler, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="daycare-toddler-second-entity all-indicator-answers">
                                {slug2DaycareToddler ? formatCost(slug2DaycareToddler, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Childcare for Sick Days" />
                            ...
                            <td
                                ...
                                {slug1ChildcareForSickDays ? formatCost(slug1ChildcareForSickDays, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="childcare-for-sick-days-second-entity all-indicator-answers">
                                {slug2ChildcareForSickDays ? formatCost(slug2ChildcareForSickDays, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Early Childhood Education Programs" />
                            ...
                            <td
                                ...
                                {slug1EarlyChildhoodEducationPrograms ? formatCost(slug1EarlyChildhoodEducationPrograms, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="early-childhood-education-program-second-entity all-indicator-answers">
                                {slug2EarlyChildhoodEducationPrograms ? formatCost(slug2EarlyChildhoodEducationPrograms, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Extra Curricular Activities" />
                            ...
                            <td
                                ...
                                {slug1ExtracurricularActivities ? formatCost(slug1ExtracurricularActivities, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="extra-curricular-activities-second-entity all-indicator-answers">
                                {slug2ExtracurricularActivities ? formatCost(slug2ExtracurricularActivities, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Summer Camp" />
                            ...
                            <td className="summer-camp-first-entity all-indicator-answers">
                                {slug1SummerCamp ? formatCost(slug1SummerCamp, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="summer-camp-second-entity all-indicator-answers">
                                {slug2SummerCamp ? formatCost(slug2SummerCamp, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

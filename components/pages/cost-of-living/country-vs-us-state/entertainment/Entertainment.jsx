...
function Entertainment({ slug1, slug2, value1, value2, slug1CostInfo, slug2CostInfo, slug1Currency, slug2Currency, slug1ExchangeRate, slug2ExchangeRate, slug1LowerCase, slug2LowerCase }) {
    ...
    const slug1TotalCost = ((slug1MovieTicket || 0) + (slug1TheaterTicket || 0) + (slug1ConcertTicket || 0) + (slug1SportsEventTicket || 0) + (slug1GymMembership || 0) + (slug1SwimmingPoolAccess || 0) + (slug1MuseumEntry || 0) + (slug1ZooEntry || 0) + (slug1AmusementParkEntry || 0) + (slug1Bowling || 0) + (slug1MiniGolf || 0) + (slug1VideoGames || 0) + (slug1StreamingServices || 0) + (slug1OutdoorEquipmentRental || 0) + (slug1ThemeParkAnnualPass || 0)) * slug1ExchangeRate
    ...
    const slug2TotalCost = ((slug2MovieTicket || 0) + (slug2TheaterTicket || 0) + (slug2ConcertTicket || 0) + (slug2SportsEventTicket || 0) + (slug2GymMembership || 0) + (slug2SwimmingPoolAccess || 0) + (slug2MuseumEntry || 0) + (slug2ZooEntry || 0) + (slug2AmusementParkEntry || 0) + (slug2Bowling || 0) + (slug2MiniGolf || 0) + (slug2VideoGames || 0) + (slug2StreamingServices || 0) + (slug2OutdoorEquipmentRental || 0) + (slug2ThemeParkAnnualPass || 0)) * slug2ExchangeRate
...
objectFit="contain"alt="Image Describing Single Movie Ticket" />
                            ...
                            <td className="movie-ticket-first-entity all-indicator-answers">
                                {slug1MovieTicket ? formatCost(slug1MovieTicket, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="movie-ticket-second-entity all-indicator-answers">
                                {slug2MovieTicket ? formatCost(slug2MovieTicket, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Single Theater Ticket" />
                            ...
                            <td className="theater-ticket-first-entity all-indicator-answers">
                                {slug1TheaterTicket ? formatCost(slug1TheaterTicket, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="theater-ticket-second-entity all-indicator-answers">
                                {slug2TheaterTicket ? formatCost(slug2TheaterTicket, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Single Concert Ticket" />
                            ...
                            <td className="concert-ticket-first-entity all-indicator-answers">
                                {slug1ConcertTicket ? formatCost(slug1ConcertTicket, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="concert-ticket-second-entity all-indicator-answers">
                                {slug2ConcertTicket ? formatCost(slug2ConcertTicket, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Single Sports Event Ticket" />
                            ...
                            <td className="sports-event-ticket-first-entity all-indicator-answers">
                                {slug1SportsEventTicket ? formatCost(slug1SportsEventTicket, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="sports-event-ticket-second-entity all-indicator-answers">
                                {slug2SportsEventTicket ? formatCost(slug2SportsEventTicket, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Gym Membership" />
                            ...
                            <td className="gym-membership-first-entity all-indicator-answers">
                                {slug1GymMembership ? formatCost(slug1GymMembership, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="gym-membership-second-entity all-indicator-answers">
                                {slug2GymMembership ? formatCost(slug2GymMembership, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Swimming Pool Access" />
                            ...
                            <td className="swimming-pool-access-first-entity all-indicator-answers">
                                {slug1SwimmingPoolAccess ? formatCost(slug1SwimmingPoolAccess, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="swimming-pool-access-second-entity all-indicator-answers">
                                {slug2SwimmingPoolAccess ? formatCost(slug2SwimmingPoolAccess, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Museum Entry Ticket" />
                            ...
                            <td className="museum-entry-first-entity all-indicator-answers">
                                {slug1MuseumEntry ? formatCost(slug1MuseumEntry, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="museum-entry-second-entity all-indicator-answers">
                                {slug2MuseumEntry ? formatCost(slug2MuseumEntry, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Zoo Entry Ticket" />
                            ...
                            <td className="zoo-entry-first-entity all-indicator-answers">
                                {slug1ZooEntry ? formatCost(slug1ZooEntry, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="zoo-entry-second-entity all-indicator-answers">
                                {slug2ZooEntry ? formatCost(slug2ZooEntry, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Amusement Park Entry Ticket" />
                            ...
                            <td className="amusement-park-entry-first-entity all-indicator-answers">
                                {slug1AmusementParkEntry ? formatCost(slug1AmusementParkEntry, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="amusement-park-entry-second-entity all-indicator-answers">
                                {slug2AmusementParkEntry ? formatCost(slug2AmusementParkEntry, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Bowling" />
                            ...
                            <td className="bowling-first-entity all-indicator-answers">
                                {slug1Bowling ? formatCost(slug1Bowling, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="bowling-second-entity all-indicator-answers">
                                {slug2Bowling ? formatCost(slug2Bowling, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Mini Golf" />
                            ...
                            <td className="mini-golf-first-entity all-indicator-answers">
                                {slug1MiniGolf ? formatCost(slug1MiniGolf, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="mini-golf-second-entity all-indicator-answers">
                                {slug2MiniGolf ? formatCost(slug2MiniGolf, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Video Games" />
                            ...
                            <td className="video-games-first-entity all-indicator-answers">
                                {slug1VideoGames ? formatCost(slug1VideoGames, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="video-games-second-entity all-indicator-answers">
                                {slug2VideoGames ? formatCost(slug2VideoGames, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Streaming Services" />
                            ...
                            <td className="streaming-services-first-entity all-indicator-answers">
                                {slug1StreamingServices ? formatCost(slug1StreamingServices, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td className="streaming-services-second-entity all-indicator-answers">
                                {slug2StreamingServices ? formatCost(slug2StreamingServices, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Outdoor Equipment Rental" />
                            ...
                            <td
                                className="outdoor-equipment-rental-first-entity all-indicator-answers">
                                {slug1OutdoorEquipmentRental ? formatCost(slug1OutdoorEquipmentRental, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="outdoor-equipment-rental-second-entity all-indicator-answers">
                                {slug2OutdoorEquipmentRental ? formatCost(slug2OutdoorEquipmentRental, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Theme Park Annual Pass" />
                            ...
                            <td
                                className="theme-park-annual-pass-first-entity all-indicator-answers">
                                {slug1ThemeParkAnnualPass ? formatCost(slug1ThemeParkAnnualPass, slug1ExchangeRate, slug1Currency, isDollarizedSlug1) : 'Yet to Update'}
                            </td>
                            <td
                                className="theme-park-annual-pass-second-entity all-indicator-answers">
                                {slug2ThemeParkAnnualPass ? formatCost(slug2ThemeParkAnnualPass, slug2ExchangeRate, slug2Currency, isDollarizedSlug2) : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <span
                            className="entertainment-and-recreation-cost-more-or-less-calculation">
                            {moreOrLess}{' '}
                        </span>

...
function WagesAndTaxes({ costInfo, propertyAndIncomeTaxInfo, stateLowerCase }) {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                ...
                                {averageGrossSalary ? `${formatNumberWithCommas(averageGrossSalary)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {averageNetSalary ? `${formatNumberWithCommas(averageNetSalary)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="minimum-wage-first-entity all-indicator-answers">
                                {minimumWage ? `${formatNumberWithCommas(minimumWage)} USD per hour` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="average-bonus-first-entity all-indicator-answers">
                                {averageBonus ? `${formatNumberWithCommas(averageBonus)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {socialSecurityContributions ? `${socialSecurityContributions} %` : 'Yet to update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {pensionContributions ? `${pensionContributions} %` : 'Yet to update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td
                                className="median-household-income-first-entity all-indicator-answers">
                                {medianHouseholdIncome ? `${formatNumberWithCommas(medianHouseholdIncome)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

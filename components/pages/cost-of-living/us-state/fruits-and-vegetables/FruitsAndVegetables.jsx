...
function FruitsAndVegetables({ costInfo, stateURLCase }) {
          ...
          <tbody>
            <tr>
              ...
              <td className="apples-1-kg-first-entity all-indicator-answers">
                {apples1Kg
                  ? `${formatNumberWithCommas(apples1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="bananas-1-kg-first-entity all-indicator-answers">
                {bananas1Kg
                  ? `${formatNumberWithCommas(bananas1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="oranges-1-kg-first-entity all-indicator-answers">
                {oranges1Kg
                  ? `${formatNumberWithCommas(oranges1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="tomatoes-1-kg-first-entity all-indicator-answers">
                {tomatoes1Kg
                  ? `${formatNumberWithCommas(tomatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="potatoes-1-kg-first-entity all-indicator-answers">
                {potatoes1Kg
                  ? `${formatNumberWithCommas(potatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="lemons-1-kg-first-entity all-indicator-answers">
                {lemons1Kg
                  ? `${formatNumberWithCommas(lemons1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="onions-1-kg-first-entity all-indicator-answers">
                {onions1Kg
                  ? `${formatNumberWithCommas(onions1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="lentils-1-kg-first-entity all-indicator-answers">
                {lentils1Kg
                  ? `${formatNumberWithCommas(lentils1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

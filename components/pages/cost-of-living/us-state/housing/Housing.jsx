...
function Housing({ costInfo, propertyAndIncomeTaxInfo, stateURLCase }) {
  ...
  const rent1bedroomflatOutsideCityCenter =
    costInfo.rent1bedroomflatOutsideCityCenter;
  const rent2bedroomflatOutsideCityCenter =
    costInfo.rent2bedroomflatOutsideCityCenter;
  const rent3bedroomflatOutsideCityCenter =
    costInfo.rent3bedroomflatOutsideCityCenter;

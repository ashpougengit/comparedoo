...
function GroceriesCost({ country1CostInfo, country2CostInfo, country1Currency, country2Currency, country1UnitValueInUSD, country2UnitValueInUSD, country1LowerCase, country2LowerCase }) {
    const country1 = country1CostInfo.country
    const country1Rice1Kg = country1CostInfo.rice1Kg
    const country1MilkOneLiter = country1CostInfo.milkOneLiter
    ...
    const country1WaterAndMilkCost = ((country1Water1Liter || 0) + (country1MilkOneLiter || 0)) * country1UnitValueInUSD
    const country1TotalCost = ((country1Rice1Kg || 0) + (country1MilkOneLiter || 0) + (country1Water1Liter || 0) + (country1Bread500g || 0) + (country1EggsDozen || 0) + (country1Cheese1Kg || 0) + (country1ChickenBreasts1Kg || 0)) * country1UnitValueInUSD

    const country2 = country2CostInfo.country
    const country2Rice1Kg = country2CostInfo.rice1Kg
    const country2MilkOneLiter = country2CostInfo.milkOneLiter
    ...
    const country2WaterAndMilkCost = ((country2Water1Liter || 0) + (country2MilkOneLiter || 0)) * country2UnitValueInUSD
    const country2TotalCost = ((country2Rice1Kg || 0) + (country2MilkOneLiter || 0) + (country2Water1Liter || 0) + (country2Bread500g || 0) + (country2EggsDozen || 0) + (country2Cheese1Kg || 0) + (country2ChickenBreasts1Kg || 0)) * country2UnitValueInUSD

    const waterAndMilkTimes = country1WaterAndMilkCost > country2WaterAndMilkCost ? (country1WaterAndMilkCost / country2WaterAndMilkCost).toFixed(2) : (country2WaterAndMilkCost / country1WaterAndMilkCost).toFixed(2)
    const moreOrLessTimes = country1WaterAndMilkCost > country2WaterAndMilkCost ? 'more' : 'less'

...
function HousingCost({ country1CostInfo, country2CostInfo, country1Currency, country2Currency, entity1PropertyAndIncomeTaxInfo, entity2PropertyAndIncomeTaxInfo, country1UnitValueInUSD, country2UnitValueInUSD, country1LowerCase, country2LowerCase }) {
    const country1 = country1CostInfo.country
    const country1OneBHKCityCenter = country1CostInfo.rent1bedroomflatInCityCenter
    const country1TwoBHKCityCenter = country1CostInfo.rent2bedroomflatInCityCenter
    const country1ThreeBHKCityCenter = country1CostInfo.rent3bedroomflatInCityCenter
    const country1OneBHKOutsideCity = country1CostInfo.rent1bedroomflatOutsideCityCenter
    const country1TwoBHKOutsideCity = country1CostInfo.rent2bedroomflatOutsideCityCenter
    const country1ThreeBHKOutsideCity = country1CostInfo.rent3bedroomflatOutsideCityCenter
    const country1MortgageRatesPerMonth = country1CostInfo.mortgageRatesPerMonth
    const country1RealEstateAgentsCommissionFees = country1CostInfo.realEstateAgentsCommissionFees
    const country1PropertyTaxRates = entity1PropertyAndIncomeTaxInfo.propertyTaxRates
    const country1AverageHousingCost = ((country1OneBHKCityCenter || 0) + (country1TwoBHKCityCenter || 0) + (country1ThreeBHKCityCenter || 0) + (country1OneBHKOutsideCity || 0) + (country1TwoBHKOutsideCity || 0) + (country1ThreeBHKOutsideCity || 0) / 6) * country1UnitValueInUSD

    const country2 = country2CostInfo.country
    const country2OneBHKCityCenter = country2CostInfo.rent1bedroomflatInCityCenter
    const country2TwoBHKCityCenter = country2CostInfo.rent2bedroomflatInCityCenter
    const country2ThreeBHKCityCenter = country2CostInfo.rent3bedroomflatInCityCenter
    const country2OneBHKOutsideCity = country2CostInfo.rent1bedroomflatOutsideCityCenter
    const country2TwoBHKOutsideCity = country2CostInfo.rent2bedroomflatOutsideCityCenter
    const country2ThreeBHKOutsideCity = country2CostInfo.rent3bedroomflatOutsideCityCenter
    const country2MortgageRatesPerMonth = country2CostInfo.mortgageRatesPerMonth
    const country2RealEstateAgentsCommissionFees = country2CostInfo.realEstateAgentsCommissionFees
    const country2PropertyTaxRates = entity2PropertyAndIncomeTaxInfo.propertyTaxRates
    const country2AverageHousingCost = ((country2OneBHKCityCenter || 0) + (country2TwoBHKCityCenter || 0) + (country2ThreeBHKCityCenter || 0) + (country2OneBHKOutsideCity || 0) + (country2TwoBHKOutsideCity || 0) + (country2ThreeBHKOutsideCity || 0) / 6) * country2UnitValueInUSD

    const moreOrLess = country1AverageHousingCost > country2AverageHousingCost ? 'more' : 'less'
    const housingCostTimes = country1AverageHousingCost > country2AverageHousingCost ? (country1AverageHousingCost / country2AverageHousingCost).toFixed(2) : (country2AverageHousingCost / country1AverageHousingCost).toFixed(2)
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="rent-1-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                {`${formatNumberWithCommas(country1OneBHKCityCenter)} ${country1OneBHKCityCenter ? country1Currency : ''}`}<br /> {dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-1-bedroom-flat-in-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1OneBHKCityCenter * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-1-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                {`${formatNumberWithCommas(country2OneBHKCityCenter)} ${country2OneBHKCityCenter ? country2Currency : ''}`}<br /> {dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-1-bedroom-flat-in-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{dollarizedCountries.includes(country2) ? '' : `${formatUSDWithCommas(country2OneBHKCityCenter * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="rent-2-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-2-bedroom-flat-in-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1TwoBHKCityCenter * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-2-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                ...
                                <br />{dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-2-bedroom-flat-in-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country2TwoBHKCityCenter * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="rent-3-bedroom-flat-in-city-center-answer-first-entity all-indicator-answers">
                                {`${formatNumberWithCommas(country1ThreeBHKCityCenter)} ${country1ThreeBHKCityCenter ? country1Currency : ''}`}<br />{dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-3-bedroom-flat-in-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1ThreeBHKCityCenter * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-3-bedroom-flat-in-city-center-answer-second-entity all-indicator-answers">
                                ...
                                <br />{dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-3-bedroom-flat-in-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country2ThreeBHKCityCenter * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="rent-1-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-1-bedroom-flat-outside-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1OneBHKOutsideCity * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-1-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-1-bedroom-flat-outside-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country2OneBHKOutsideCity * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="rent-2-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-2-bedroom-flat-outside-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1TwoBHKOutsideCity * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-2-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-2-bedroom-flat-outside-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country2TwoBHKOutsideCity * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="rent-3-bedroom-flat-outside-city-center-answer-first-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country1) ? '' : (<span
                                    className="rent-3-bedroom-flat-outside-city-center-answer-first-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country1ThreeBHKOutsideCity * country1UnitValueInUSD)}`}</span>)}
                            </td>
                            <td className="rent-3-bedroom-flat-outside-city-center-answer-second-entity all-indicator-answers">
                                ...
                                <br /> {dollarizedCountries.includes(country2) ? '' : (<span
                                    className="rent-3-bedroom-flat-outside-city-center-answer-second-entity-amount-in-usd amount-in-dollar">{`${formatUSDWithCommas(country2ThreeBHKOutsideCity * country2UnitValueInUSD)}`}</span>)}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="mortgage-rates-per-month-index-answer-first-entity all-indicator-answers">
                                {country1MortgageRatesPerMonth ?? 'Yet to Update'}
                            </td>
                            <td className="mortgage-rates-per-month-index-answer-second-entity all-indicator-answers">
                                {country2MortgageRatesPerMonth ?? 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="real-estate-agents-commission-fees-answer-first-entity all-indicator-answers">
                                {country1RealEstateAgentsCommissionFees ?? 'Yet to Update'}
                            </td>
                            <td className="real-estate-agents-commission-fees-answer-second-entity all-indicator-answers">
                                {country2RealEstateAgentsCommissionFees ?? 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="property-taxes-answer-first-entity all-indicator-answers">
                                {country1PropertyTaxRates ?? 'Yet to Update'}
                            </td>
                            <td className="property-taxes-answer-second-entity all-indicator-answers">
                                {country2PropertyTaxRates ?? 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <span className="first-entity-name-pages-paragraph"> {country1} </span><strong>
                            is <span className="housing-cost-calculation">{housingCostTimes}</span> times</strong>
                        <span className="housing-cost-less-or-more-expensive-calculation"> {moreOrLess} </span>
                        expensive than
                        <span className="second-entity-name-pages-paragraph"> {country2}</span>.
                    </p>
                </div>

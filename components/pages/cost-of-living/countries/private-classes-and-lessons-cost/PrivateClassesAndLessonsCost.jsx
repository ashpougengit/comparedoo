...
function PrivateClassesAndLessonsCost({ country1CostInfo, country2CostInfo, country1Currency, country2Currency, country1UnitValueInUSD, country2UnitValueInUSD, country1LowerCase, country2LowerCase }) {
    ...
    const country1TotalCost = ((country1LanguageClasses || 0 ) + (country1ParentingClasses || 0 ) + (country1ArtClasses || 0 ) + (country1FitnessClass || 0 ) + (country1MusicLessons || 0 ) + (country1DanceLessons || 0 ) + (country1ReadingMaterials || 0 ) + (country1EducationalSoftware || 0)) * country1UnitValueInUSD
    ...
    const country2TotalCost = ((country2LanguageClasses || 0 ) + (country2ParentingClasses || 0 ) + (country2ArtClasses || 0 ) + (country2FitnessClass || 0 ) + (country2MusicLessons || 0 ) + (country2DanceLessons || 0 ) + (country2ReadingMaterials || 0 ) + (country2EducationalSoftware || 0)) * country2UnitValueInUSD

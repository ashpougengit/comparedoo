...
function ProfessionalServicesCost({
  country1CostInfo,
  country2CostInfo,
  country1Currency,
  country2Currency,
  ...
  const country1LegalConsultationPerHourRate =
    country1CostInfo.legalConsultationPerHourRate;
  const country1AccountingServicesPerHourRate =
    country1CostInfo.accountingServicesPerHourRate;
  const country1ITSupportServicesPerHourRate = parseFloat(
    country1CostInfo.ITSupportServicesPerHourRate
  );
  const country1TechnicianServicesPerHourRate =
    country1CostInfo.technicianServicesPerHourRate;
  const country1TotalCost =
    ((country1LegalConsultationPerHourRate || 0) +
      (country1AccountingServicesPerHourRate || 0) +
      (country1ITSupportServicesPerHourRate || 0) +
      (country1TechnicianServicesPerHourRate || 0)) *
    country1UnitValueInUSD;

  const country2 = country2CostInfo.country;
  const country2LegalConsultationPerHourRate =
    country2CostInfo.legalConsultationPerHourRate;
  const country2AccountingServicesPerHourRate =
    country2CostInfo.accountingServicesPerHourRate;
  const country2ITSupportServicesPerHourRate = parseFloat(
    country2CostInfo.ITSupportServicesPerHourRate
  );
  const country2TechnicianServicesPerHourRate =
    country2CostInfo.technicianServicesPerHourRate;
  const country2TotalCost =
    ((country2LegalConsultationPerHourRate || 0) +
      (country2AccountingServicesPerHourRate || 0) +
      (country2ITSupportServicesPerHourRate || 0) +
      (country2TechnicianServicesPerHourRate || 0)) *
    country2UnitValueInUSD;
          ...
          <tbody>
            <tr>
              ...
              <td className="legal-consultation-per-hour-rate-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1LegalConsultationPerHourRate
                )} ${country1LegalConsultationPerHourRate ? country1Currency : ''
                  }`}
                <br />{' '}
              ...
              <td className="legal-consultation-per-hour-rate-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2LegalConsultationPerHourRate
                )} ${country2LegalConsultationPerHourRate ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="legal-consultation-per-hour-rate-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2LegalConsultationPerHourRate *
                    country2UnitValueInUSD
                  )})`}</span>
                )}
            ...
            <tr>
              ...
              <td className="accounting-services-per-hour-rate-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1AccountingServicesPerHourRate
                )} ${country1AccountingServicesPerHourRate ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
              ...
              <td className="accounting-services-per-hour-rate-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2AccountingServicesPerHourRate
                )} ${country2AccountingServicesPerHourRate ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="accounting-services-per-hour-rate-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2AccountingServicesPerHourRate *
                    country2UnitValueInUSD
                  )})`}</span>
                )}
            ...
            <tr>
              ...
              <td className="IT-support-services-per-hour-rate-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1ITSupportServicesPerHourRate
                )} ${country1ITSupportServicesPerHourRate ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
              ...
              <td className="IT-support-services-per-hour-rate-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2ITSupportServicesPerHourRate
                )} ${country2ITSupportServicesPerHourRate ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="IT-support-services-per-hour-rate-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2ITSupportServicesPerHourRate *
                    country2UnitValueInUSD
                  )})`}</span>
                )}
            ...
            <tr>
              ...
              <td className="technical-services-per-hour-rate-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1TechnicianServicesPerHourRate
                )} ${country1TechnicianServicesPerHourRate ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
              ...
              <td className="technical-services-per-hour-rate-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2TechnicianServicesPerHourRate
                )} ${country2TechnicianServicesPerHourRate ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="technical-services-per-hour-rate-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2TechnicianServicesPerHourRate *
                    country2UnitValueInUSD
                  )})`}</span>
                )}

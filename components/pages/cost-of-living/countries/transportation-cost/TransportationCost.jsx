...
function TransportationCost({
  ...
  const country1SinglePublicTransportTicket =
    country1CostInfo.singlePublicTransportTicket;
  ...
  const country1ParkingFeesCityCenterPerHour =
    country1CostInfo.parkingFeesCityCenterPerHour;
  const country1ParkingFeesOutsideCityCenterPerHour =
    country1CostInfo.parkingFeesOutsideCityCenterPerHour;
  const country1TotalCost =
    ((country1PublicTransportPass || 0) +
      (country1SinglePublicTransportTicket || 0) +
      (country1TrainTickets || 0) +
      (country1AirfareDomestic || 0) +
      (country1TaxiStartFare || 0) +
      (country1TaxiRatePerKm || 0) +
      (country1CarRentalPerDay || 0) +
      (country1ParkingFeesCityCenterPerHour || 0) +
      (country1ParkingFeesOutsideCityCenterPerHour || 0)) *
    country1UnitValueInUSD;

  const country2 = country2CostInfo.country;
  const country2PublicTransportPass = country2CostInfo.publicTransportPass;
  const country2SinglePublicTransportTicket =
    country2CostInfo.singlePublicTransportTicket;
  ...
  const country2ParkingFeesCityCenterPerHour =
    country2CostInfo.parkingFeesCityCenterPerHour;
  const country2ParkingFeesOutsideCityCenterPerHour =
    country2CostInfo.parkingFeesOutsideCityCenterPerHour;
  const country2TotalCost =
    ((country2PublicTransportPass || 0) +
      (country2SinglePublicTransportTicket || 0) +
      (country2TrainTickets || 0) +
      (country2AirfareDomestic || 0) +
      (country2TaxiStartFare || 0) +
      (country2TaxiRatePerKm || 0) +
      (country2CarRentalPerDay || 0) +
      (country2ParkingFeesCityCenterPerHour || 0) +
      (country2ParkingFeesOutsideCityCenterPerHour || 0)) *
    country2UnitValueInUSD;
          ...
          <tbody>
            <tr>
              ...
              <td className="public-transport-pass-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1PublicTransportPass)} ${country1PublicTransportPass ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ...
                  <span className="public-transport-pass-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1PublicTransportPass * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="public-transport-pass-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2PublicTransportPass)} ${country2PublicTransportPass ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="public-transport-pass-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2PublicTransportPass * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="single-public-transportation-ticket-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1SinglePublicTransportTicket
                )} ${country1SinglePublicTransportTicket ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="single-public-transportation-ticket-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1SinglePublicTransportTicket * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="single-public-transportation-ticket-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2SinglePublicTransportTicket
                )} ${country2SinglePublicTransportTicket ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="single-public-transportation-ticket-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2SinglePublicTransportTicket * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="single-train-ticket-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1TrainTickets)} ${country1TrainTickets ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="single-train-ticket-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1TrainTickets * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="single-train-ticket-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2TrainTickets)} ${country2TrainTickets ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="single-train-ticket-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2TrainTickets * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="air-fare-domestic-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1AirfareDomestic)} ${country1AirfareDomestic ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="air-fare-domestic-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1AirfareDomestic * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="air-fare-domestic-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2AirfareDomestic)} ${country2AirfareDomestic ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="air-fare-domestic-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2AirfareDomestic * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="taxi-start-fare-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1TaxiStartFare)} ${country1TaxiStartFare ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="taxi-start-fare-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1TaxiStartFare * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="taxi-start-fare-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2TaxiStartFare)} ${country2TaxiStartFare ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="taxi-start-fare-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2TaxiStartFare * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="taxi-rate-per-kilometers-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1TaxiRatePerKm)} ${country1TaxiRatePerKm ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="taxi-rate-per-kilometers-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1TaxiRatePerKm * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="taxi-rate-per-kilometers-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2TaxiRatePerKm)} ${country2TaxiRatePerKm ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="taxi-rate-per-kilometers-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2TaxiRatePerKm * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="car-rental-per-day-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(country1CarRentalPerDay)} ${country1CarRentalPerDay ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
                  ...
                  <span className="car-rental-per-day-first-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country1CarRentalPerDay * country1UnitValueInUSD
                  )})`}</span>
                )}
              </td>
              <td className="car-rental-per-day-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(country2CarRentalPerDay)} ${country2CarRentalPerDay ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="car-rental-per-day-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2CarRentalPerDay * country2UnitValueInUSD
                  )})`}</span>
                )}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="parking-fees-in-city-center-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1ParkingFeesCityCenterPerHour
                )} ${country1ParkingFeesCityCenterPerHour ? country1Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country1) ? (
                  ''
              ...
              <td className="parking-fees-in-city-center-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2ParkingFeesCityCenterPerHour
                )} ${country2ParkingFeesCityCenterPerHour ? country2Currency : ''
                  }`}
                <br />{' '}
                {dollarizedCountries.includes(country2) ? (
                  ''
                ) : (
                  <span className="parking-fees-in-city-center-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2ParkingFeesCityCenterPerHour *
                    country2UnitValueInUSD
                  )})`}</span>
                )}
            ...
            <tr>
              ...
              <td className="parking-fees-outside-city-center-first-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country1ParkingFeesOutsideCityCenterPerHour
                )} ${country1ParkingFeesOutsideCityCenterPerHour
                  ? country1Currency
                  : ''
                  }`}
              ...
              <td className="parking-fees-outside-city-center-second-entity all-indicator-answers">
                {`${formatNumberWithCommas(
                  country2ParkingFeesOutsideCityCenterPerHour
                )} ${country2ParkingFeesOutsideCityCenterPerHour
                  ? country2Currency
                  : ''
                  }`}
                ...
                {dollarizedCountries.includes(country2) ? (
                  ...
                  <span className="parking-fees-outside-city-center-second-entity-amount-in-usd amount-in-dollar">{`(${formatUSDWithCommas(
                    country2ParkingFeesOutsideCityCenterPerHour *
                    country2UnitValueInUSD
                  )})`}</span>
                )}

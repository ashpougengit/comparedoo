            ...
            <tbody>
              <tr>
                ...
                <td className="apples-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Apples1Kg)} ${
                    country1Apples1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                ...
                <td className="apples-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Apples1Kg)} ${
                    country2Apples1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
              ...
              <tr>
                ...
                <td className="bananas-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Bananas1Kg)} ${
                    country1Bananas1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="bananas-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Bananas1Kg)} ${
                    country2Bananas1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="oranges-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Oranges1Kg)} ${
                    country1Oranges1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="oranges-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Oranges1Kg)} ${
                    country2Oranges1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="tomatoes-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Tomatoes1Kg)} ${
                    country1Tomatoes1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="tomatoes-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Tomatoes1Kg)} ${
                    country2Tomatoes1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="potatoes-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Potatoes1Kg)} ${
                    country1Potatoes1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="potatoes-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Potatoes1Kg)} ${
                    country2Potatoes1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="lemons-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Lemons1Kg)} ${
                    country1Lemons1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="lemons-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Lemons1Kg)} ${
                    country2Lemons1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="onions-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Onions1Kg)} ${
                    country1Onions1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="onions-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Onions1Kg)} ${
                    country2Onions1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''
              ...
              <tr>
                ...
                <td className="lentils-1-kg-first-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country1Lentils1Kg)} ${
                    country1Lentils1Kg ? country1Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country1) ? (
                    ''
                ...
                <td className="lentils-1-kg-second-entity all-indicator-answers">
                  {`${formatNumberWithCommas(country2Lentils1Kg)} ${
                    country2Lentils1Kg ? country2Currency : ''
                  }`}
                  <br />{' '}
                  {dollarizedCountries.includes(country2) ? (
                    ''

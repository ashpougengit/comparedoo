                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/wifi-cost-per-month-image.png"
                                        fill alt="Image Describing wifi cost per month" />
                                </div>
                            </td>

                            <td className="wifi-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1WifiCostPerMonth ? `${formatNumberWithCommas(state1WifiCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="wifi-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2WifiCostPerMonth ? `${formatNumberWithCommas(state2WifiCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="mobile-phone-plan-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1MobilePhonePlanCostPerMonth ? `${formatNumberWithCommas(state1MobilePhonePlanCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mobile-phone-plan-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2MobilePhonePlanCostPerMonth ? `${formatNumberWithCommas(state2MobilePhonePlanCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="landline-phone-plan-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1LandlinePhoneServicePerMonth ? `${formatNumberWithCommas(state1LandlinePhoneServicePerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="landline-phone-plan-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2LandlinePhoneServicePerMonth ? `${formatNumberWithCommas(state2LandlinePhoneServicePerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="cable-tv-service-per-month-first-entity all-indicator-answers">
                                {state1CableTVServicePerMonth ? `${formatNumberWithCommas(state1CableTVServicePerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mobile-phone-plan-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2CableTVServicePerMonth ? `${formatNumberWithCommas(state2CableTVServicePerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <span className="first-entity-name-pages-paragraph"> {state1} </span> compared to

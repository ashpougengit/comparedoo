...
function PersonalCare({
  ...
  const state1TotalCost =
    (state1CosmeticProcedures || 0) +
    (state1SpaTreatment || 0) +
    (state1ManicurePedicureCost || 0) +
    (state1OpticalGlasses || 0) +
    (state1ContactLenses || 0) +
    (state1Haircuts || 0) +
    (state1HairColoring || 0) +
    (state1ShampooPrice || 0) +
    (state1ToothpastePrice || 0);
  ...
  const state2TotalCost =
    (state2CosmeticProcedures || 0) +
    (state2SpaTreatment || 0) +
    (state2ManicurePedicureCost || 0) +
    (state2OpticalGlasses || 0) +
    (state2ContactLenses || 0) +
    (state2Haircuts || 0) +
    (state2HairColoring || 0) +
    (state2ShampooPrice || 0) +
    (state2ToothpastePrice || 0);
          ...
          <tbody>
            <tr>
              ...
              <td className="cosmetic-procedures-first-entity all-indicator-answers">
                {state1CosmeticProcedures
                  ? `${formatNumberWithCommas(state1CosmeticProcedures)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="cosmetic-procedures-second-entity all-indicator-answers">
                {state2CosmeticProcedures
                  ? `${formatNumberWithCommas(state2CosmeticProcedures)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="spa-treatment-first-entity all-indicator-answers">
                {state1SpaTreatment
                  ? `${formatNumberWithCommas(state1SpaTreatment)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="spa-treatment-second-entity all-indicator-answers">
                {state2SpaTreatment
                  ? `${formatNumberWithCommas(state2SpaTreatment)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="manicure-pedicure-cost-first-entity all-indicator-answers">
                {state1ManicurePedicureCost
                  ? `${formatNumberWithCommas(state1ManicurePedicureCost)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="manicure-pedicure-cost-second-entity all-indicator-answers">
                {state2ManicurePedicureCost
                  ? `${formatNumberWithCommas(state2ManicurePedicureCost)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="optical-glasses-first-entity all-indicator-answers">
                {state1OpticalGlasses
                  ? `${formatNumberWithCommas(state1OpticalGlasses)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="optical-glasses-second-entity all-indicator-answers">
                {state2OpticalGlasses
                  ? `${formatNumberWithCommas(state2OpticalGlasses)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="contact-lenses-first-entity all-indicator-answers">
                {state1ContactLenses
                  ? `${formatNumberWithCommas(state1ContactLenses)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="contact-lenses-second-entity all-indicator-answers">
                {state2ContactLenses
                  ? `${formatNumberWithCommas(state2ContactLenses)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="hair-cuts-first-entity all-indicator-answers">
                {state1Haircuts
                  ? `${formatNumberWithCommas(state1Haircuts)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="hair-cuts-second-entity all-indicator-answers">
                {state2Haircuts
                  ? `${formatNumberWithCommas(state2Haircuts)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="hair-coloring-first-entity all-indicator-answers">
                {state1HairColoring
                  ? `${formatNumberWithCommas(state1HairColoring)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="hair-coloring-second-entity all-indicator-answers">
                {state2HairColoring
                  ? `${formatNumberWithCommas(state2HairColoring)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="shampoo-price-first-entity all-indicator-answers">
                {state1ShampooPrice
                  ? `${formatNumberWithCommas(state1ShampooPrice)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="shampoo-price-second-entity all-indicator-answers">
                {state2ShampooPrice
                  ? `${formatNumberWithCommas(state2ShampooPrice)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="toothpaste-price-first-entity all-indicator-answers">
                {state1ToothpastePrice
                  ? `${formatNumberWithCommas(state1ToothpastePrice)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="toothpaste-price-second-entity all-indicator-answers">
                {state2ToothpastePrice
                  ? `${formatNumberWithCommas(state2ToothpastePrice)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

...
function Entertainment({
  ...
  const state1TotalCost =
    (state1MovieTicket || 0) +
    (state1TheaterTicket || 0) +
    (state1ConcertTicket || 0) +
    (state1SportsEventTicket || 0) +
    (state1GymMembership || 0) +
    (state1SwimmingPoolAccess || 0) +
    (state1MuseumEntry || 0) +
    (state1ZooEntry || 0) +
    (state1AmusementParkEntry || 0) +
    (state1Bowling || 0) +
    (state1MiniGolf || 0) +
    (state1VideoGames || 0) +
    (state1StreamingServices || 0) +
    (state1OutdoorEquipmentRental || 0) +
    (state1ThemeParkAnnualPass || 0);
  ...
  const state2TotalCost =
    (state2MovieTicket || 0) +
    (state2TheaterTicket || 0) +
    (state2ConcertTicket || 0) +
    (state2SportsEventTicket || 0) +
    (state2GymMembership || 0) +
    (state2SwimmingPoolAccess || 0) +
    (state2MuseumEntry || 0) +
    (state2ZooEntry || 0) +
    (state2AmusementParkEntry || 0) +
    (state2Bowling || 0) +
    (state2MiniGolf || 0) +
    (state2VideoGames || 0) +
    (state2StreamingServices || 0) +
    (state2OutdoorEquipmentRental || 0) +
    (state2ThemeParkAnnualPass || 0);
          ...
          <tbody>
            <tr>
              ...
              <td className="movie-ticket-first-entity all-indicator-answers">
                {state1MovieTicket
                  ? `${formatNumberWithCommas(state1MovieTicket)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="movie-ticket-second-entity all-indicator-answers">
                {state2MovieTicket
                  ? `${formatNumberWithCommas(state2MovieTicket)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="theater-ticket-first-entity all-indicator-answers">
                {state1TheaterTicket
                  ? `${formatNumberWithCommas(state1TheaterTicket)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="theater-ticket-second-entity all-indicator-answers">
                {state2TheaterTicket
                  ? `${formatNumberWithCommas(state2TheaterTicket)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="concert-ticket-first-entity all-indicator-answers">
                {state1ConcertTicket
                  ? `${formatNumberWithCommas(state1ConcertTicket)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="concert-ticket-second-entity all-indicator-answers">
                {state2ConcertTicket
                  ? `${formatNumberWithCommas(state2ConcertTicket)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="sports-event-ticket-first-entity all-indicator-answers">
                {state1SportsEventTicket
                  ? `${formatNumberWithCommas(state1SportsEventTicket)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="sports-event-ticket-second-entity all-indicator-answers">
                {state2SportsEventTicket
                  ? `${formatNumberWithCommas(state2SportsEventTicket)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="gym-membership-first-entity all-indicator-answers">
                {state1GymMembership
                  ? `${formatNumberWithCommas(state1GymMembership)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="gym-membership-second-entity all-indicator-answers">
                {state2GymMembership
                  ? `${formatNumberWithCommas(state2GymMembership)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="swimming-pool-access-first-entity all-indicator-answers">
                {state1SwimmingPoolAccess
                  ? `${formatNumberWithCommas(state1SwimmingPoolAccess)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="swimming-pool-access-second-entity all-indicator-answers">
                {state2SwimmingPoolAccess
                  ? `${formatNumberWithCommas(state2SwimmingPoolAccess)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="museum-entry-first-entity all-indicator-answers">
                {state1MuseumEntry
                  ? `${formatNumberWithCommas(state1MuseumEntry)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="museum-entry-second-entity all-indicator-answers">
                {state2MuseumEntry
                  ? `${formatNumberWithCommas(state2MuseumEntry)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="zoo-entry-first-entity all-indicator-answers">
                {state1ZooEntry
                  ? `${formatNumberWithCommas(state1ZooEntry)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="zoo-entry-second-entity all-indicator-answers">
                {state2ZooEntry
                  ? `${formatNumberWithCommas(state2ZooEntry)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="amusement-park-entry-first-entity all-indicator-answers">
                {state1AmusementParkEntry
                  ? `${formatNumberWithCommas(state1AmusementParkEntry)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="amusement-park-entry-second-entity all-indicator-answers">
                {state2AmusementParkEntry
                  ? `${formatNumberWithCommas(state2AmusementParkEntry)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="bowling-first-entity all-indicator-answers">
                {state1Bowling
                  ? `${formatNumberWithCommas(state1Bowling)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="bowling-second-entity all-indicator-answers">
                {state2Bowling
                  ? `${formatNumberWithCommas(state2Bowling)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="mini-golf-first-entity all-indicator-answers">
                {state1MiniGolf
                  ? `${formatNumberWithCommas(state1MiniGolf)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="mini-golf-second-entity all-indicator-answers">
                {state2MiniGolf
                  ? `${formatNumberWithCommas(state2MiniGolf)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="video-games-first-entity all-indicator-answers">
                {state1VideoGames
                  ? `${formatNumberWithCommas(state1VideoGames)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="video-games-second-entity all-indicator-answers">
                {state2VideoGames
                  ? `${formatNumberWithCommas(state2VideoGames)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="streaming-services-first-entity all-indicator-answers">
                {state1StreamingServices
                  ? `${formatNumberWithCommas(state1StreamingServices)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="streaming-services-second-entity all-indicator-answers">
                {state2StreamingServices
                  ? `${formatNumberWithCommas(state2StreamingServices)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="theme-park-annual-pass-first-entity all-indicator-answers">
                {state1ThemeParkAnnualPass
                  ? `${formatNumberWithCommas(state1ThemeParkAnnualPass)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="theme-park-annual-pass-second-entity all-indicator-answers">
                {state2ThemeParkAnnualPass
                  ? `${formatNumberWithCommas(state2ThemeParkAnnualPass)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

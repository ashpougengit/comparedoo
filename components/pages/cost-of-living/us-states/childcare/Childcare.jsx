...
function Childcare({
  ...
  const state1EarlyChildhoodEducationPrograms =
    state1CostInfo.earlyChildhoodEducationPrograms;
  const state1ExtracurricularActivities =
    state1CostInfo.extracurricularActivities;
  const state1SummerCamp = state1CostInfo.summerCamp;
  const state1TotalCost =
    (state1ChildrensJeans || 0) +
    (state1ChildrensSneakers || 0) +
    (state1ChildrensWinterCoat || 0) +
    (state1DaycareInfant || 0) +
    (state1DaycareToddler || 0) +
    (state1ChildcareForSickDays || 0) +
    (state1EarlyChildhoodEducationPrograms || 0) +
    (state1ExtracurricularActivities || 0) +
    (state1SummerCamp || 0);
  ...
  const state2EarlyChildhoodEducationPrograms =
    state2CostInfo.earlyChildhoodEducationPrograms;
  const state2ExtracurricularActivities =
    state2CostInfo.extracurricularActivities;
  const state2SummerCamp = state2CostInfo.summerCamp;
  const state2TotalCost =
    (state2ChildrensJeans || 0) +
    (state2ChildrensSneakers || 0) +
    (state2ChildrensWinterCoat || 0) +
    (state2DaycareInfant || 0) +
    (state2DaycareToddler || 0) +
    (state2ChildcareForSickDays || 0) +
    (state2EarlyChildhoodEducationPrograms || 0) +
    (state2ExtracurricularActivities || 0) +
    (state2SummerCamp || 0);
          ...
          <tbody>
            <tr>
              ...
              <td className="children-jeans-first-entity all-indicator-answers">
                {state1ChildrensJeans
                  ? `${formatNumberWithCommas(state1ChildrensJeans)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="children-jeans-second-entity all-indicator-answers">
                {state2ChildrensJeans
                  ? `${formatNumberWithCommas(state2ChildrensJeans)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="children-sneakers-first-entity all-indicator-answers">
                {state1ChildrensSneakers
                  ? `${formatNumberWithCommas(state1ChildrensSneakers)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="children-sneakers-second-entity all-indicator-answers">
                {state2ChildrensSneakers
                  ? `${formatNumberWithCommas(state2ChildrensSneakers)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="children-winter-coat-first-entity all-indicator-answers">
                {state1ChildrensWinterCoat
                  ? `${formatNumberWithCommas(state1ChildrensWinterCoat)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="children-winter-coat-second-entity all-indicator-answers">
                {state2ChildrensWinterCoat
                  ? `${formatNumberWithCommas(state2ChildrensWinterCoat)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="daycare-infant-first-entity all-indicator-answers">
                {state1DaycareInfant
                  ? `${formatNumberWithCommas(state1DaycareInfant)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="daycare-infant-second-entity all-indicator-answers">
                {state2DaycareInfant
                  ? `${formatNumberWithCommas(state2DaycareInfant)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="daycare-toddler-first-entity all-indicator-answers">
                {state1DaycareToddler
                  ? `${formatNumberWithCommas(state1DaycareToddler)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="daycare-toddler-second-entity all-indicator-answers">
                {state2DaycareToddler
                  ? `${formatNumberWithCommas(state2DaycareToddler)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="childcare-for-sick-days-first-entity all-indicator-answers">
                {state1ChildcareForSickDays
                  ? `${formatNumberWithCommas(state1ChildcareForSickDays)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="childcare-for-sick-days-second-entity all-indicator-answers">
                {state2ChildcareForSickDays
                  ? `${formatNumberWithCommas(state2ChildcareForSickDays)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="early-childhood-education-program-first-entity all-indicator-answers">
                {state1EarlyChildhoodEducationPrograms
              ...
              <td className="early-childhood-education-program-second-entity all-indicator-answers">
                {state2EarlyChildhoodEducationPrograms
                  ? `${formatNumberWithCommas(
                    state2EarlyChildhoodEducationPrograms
                  )} USD`
                  : 'Yet to Update'}
            ...
            <tr>
              ...
              <td className="extra-curricular-activities-first-entity all-indicator-answers">
                {state1ExtracurricularActivities
                  ? `${formatNumberWithCommas(
                    state1ExtracurricularActivities
                  )} USD`
                  : 'Yet to Update'}
              ...
              <td className="extra-curricular-activities-second-entity all-indicator-answers">
                {state2ExtracurricularActivities
                  ? `${formatNumberWithCommas(
                    state2ExtracurricularActivities
                  )} USD`
                  : 'Yet to Update'}
            ...
            <tr>
              ...
              <td className="summer-camp-first-entity all-indicator-answers">
                {state1SummerCamp
                  ? `${formatNumberWithCommas(state1SummerCamp)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="summer-camp-second-entity all-indicator-answers">
                {state2SummerCamp
                  ? `${formatNumberWithCommas(state2SummerCamp)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

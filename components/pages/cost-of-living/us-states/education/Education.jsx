...
function Education({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1UniversityTuitionPrivate = state1CostInfo.universityTuitionPrivate
    const state1AfterSchoolActivities = state1CostInfo.afterSchoolActivities
    const state1SpecialEducationServices = state1CostInfo.specialEducationServices
    ...
    const state1TotalCost = (state1Preschool || 0) + (state1PrimarySchoolFees || 0) + (state1SecondarySchoolFees || 0) + (state1PrivateSchoolFees || 0) + (state1UniversityTuition || 0) + (state1UniversityTuitionPrivate || 0) + (state1AfterSchoolActivities || 0) + (state1SpecialEducationServices || 0) + (state1Tutoring || 0) + (state1Textbooks || 0) + (state1SchoolSupplies || 0)
    ...
    const state2UniversityTuitionPrivate = state2CostInfo.universityTuitionPrivate
    const state2AfterSchoolActivities = state2CostInfo.afterSchoolActivities
    const state2SpecialEducationServices = state2CostInfo.specialEducationServices
    ...
    const state2TotalCost = (state2Preschool || 0) + (state2PrimarySchoolFees || 0) + (state2SecondarySchoolFees || 0) + (state2PrivateSchoolFees || 0) + (state2UniversityTuition || 0) + (state2UniversityTuitionPrivate || 0) + (state2AfterSchoolActivities || 0) + (state2SpecialEducationServices || 0) + (state2Tutoring || 0) + (state2Textbooks || 0) + (state2SchoolSupplies || 0)
...
objectFit="contain"alt="Image Describing PreSchool Fees" />
                            ...
                            <td className="preschool-fees-first-entity all-indicator-answers">
                                {state1Preschool ? `${formatNumberWithCommas(state1Preschool)} USD` : 'Yet to Update'}
                            </td>
                            <td className="preschool-fees-second-entity all-indicator-answers">
                                {state2Preschool ? `${formatNumberWithCommas(state2Preschool)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/primary-school-fees-image.png"
                                       layout="fill"
objectFit="contain"alt="Image Describing Primary School Fees" />
                            ...
                            <td className="primary-school-fees-first-entity all-indicator-answers">
                                {state1PrimarySchoolFees ? `${formatNumberWithCommas(state1PrimarySchoolFees)} USD` : 'Yet to Update'}
                            </td>
                            <td className="primary-school-fees-second-entity all-indicator-answers">
                                {state2PrimarySchoolFees ? `${formatNumberWithCommas(state2PrimarySchoolFees)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Secondary School Fees" />
                            ...
                            <td className="secondary-school-fees-first-entity all-indicator-answers">
                                {state1SecondarySchoolFees ? `${formatNumberWithCommas(state1SecondarySchoolFees)} USD` : 'Yet to Update'}
                            </td>
                            <td className="secondary-school-fees-second-entity all-indicator-answers">
                                {state2SecondarySchoolFees ? `${formatNumberWithCommas(state2SecondarySchoolFees)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/private-school-fees-image.png"
                                       layout="fill"
objectFit="contain"alt="Image Describing Private School Fees" />
                            ...
                            <td className="private-school-fees-first-entity all-indicator-answers">
                                {state1PrivateSchoolFees ? `${formatNumberWithCommas(state1PrivateSchoolFees)} USD` : 'Yet to Update'}
                            </td>
                            <td className="private-school-fees-second-entity all-indicator-answers">
                                {state2PrivateSchoolFees ? `${formatNumberWithCommas(state2PrivateSchoolFees)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing University Tuition Fees" />
                            ...
                            <td className="university-tuition-fees-first-entity all-indicator-answers">
                                {state1UniversityTuition ? `${formatNumberWithCommas(state1UniversityTuition)} USD` : 'Yet to Update'}
                            </td>
                            <td className="university-tuition-fees-second-entity all-indicator-answers">
                                {state2UniversityTuition ? `${formatNumberWithCommas(state2UniversityTuition)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing University Private Tuition Fees" />
                            ...
                            <td className="university-private-tuition-fees-first-entity all-indicator-answers">
                                {state1UniversityTuitionPrivate ? `${formatNumberWithCommas(state1UniversityTuitionPrivate)} USD` : 'Yet to Update'}
                            </td>
                            <td className="university-private-tuition-fees-second-entity all-indicator-answers">
                                {state2UniversityTuitionPrivate ? `${formatNumberWithCommas(state2UniversityTuitionPrivate)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing After School Activities" />
                            ...
                            <td className="after-school-activities-first-entity all-indicator-answers">
                                {state1AfterSchoolActivities ? `${formatNumberWithCommas(state1AfterSchoolActivities)} USD` : 'Yet to Update'}
                            </td>
                            <td className="after-school-activities-second-entity all-indicator-answers">
                                {state2AfterSchoolActivities ? `${formatNumberWithCommas(state2AfterSchoolActivities)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Special Education Services" />
                            ...
                            <td className="special-education-services-first-entity all-indicator-answers">
                                {state1SpecialEducationServices ? `${formatNumberWithCommas(state1SpecialEducationServices)} USD` : 'Yet to Update'}
                            </td>
                            <td className="special-education-services-second-entity all-indicator-answers">
                                {state2SpecialEducationServices ? `${formatNumberWithCommas(state2SpecialEducationServices)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Tutoring" />
                            ...
                            <td className="tutoring-first-entity all-indicator-answers">
                                {state1Tutoring ? `${formatNumberWithCommas(state1Tutoring)} USD` : 'Yet to Update'}
                            </td>
                            <td className="tutoring-second-entity all-indicator-answers">
                                {state2Tutoring ? `${formatNumberWithCommas(state2Tutoring)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Textbooks Cost" />
                            ...
                            <td className="textbooks-first-entity all-indicator-answers">
                                {state1Textbooks ? `${formatNumberWithCommas(state1Textbooks)} USD` : 'Yet to Update'}
                            </td>
                            <td className="textbooks-second-entity all-indicator-answers">
                                {state2Textbooks ? `${formatNumberWithCommas(state2Textbooks)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing School Supplies" />
                            ...
                            <td className="school-supplies-first-entity all-indicator-answers">
                                {state1SchoolSupplies ? `${formatNumberWithCommas(state1SchoolSupplies)} USD` : 'Yet to Update'}
                            </td>
                            <td className="school-supplies-second-entity all-indicator-answers">
                                {state2SchoolSupplies ? `${formatNumberWithCommas(state2SchoolSupplies)} USD` : 'Yet to Update'}
                            </td>
                        </tr>

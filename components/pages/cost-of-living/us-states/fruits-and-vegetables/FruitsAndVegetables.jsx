          ...
          <tbody>
            <tr>
              ...
              <td className="apples-1-kg-first-entity all-indicator-answers">
                {state1Apples1Kg
                  ? `${formatNumberWithCommas(state1Apples1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="apples-1-kg-second-entity all-indicator-answers">
                {state2Apples1Kg
                  ? `${formatNumberWithCommas(state2Apples1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="bananas-1-kg-first-entity all-indicator-answers">
                {state1Bananas1Kg
                  ? `${formatNumberWithCommas(state1Bananas1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="bananas-1-kg-second-entity all-indicator-answers">
                {state2Bananas1Kg
                  ? `${formatNumberWithCommas(state2Bananas1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="oranges-1-kg-first-entity all-indicator-answers">
                {state1Oranges1Kg
                  ? `${formatNumberWithCommas(state1Oranges1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="oranges-1-kg-second-entity all-indicator-answers">
                {state2Oranges1Kg
                  ? `${formatNumberWithCommas(state2Oranges1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="tomatoes-1-kg-first-entity all-indicator-answers">
                {state1Tomatoes1Kg
                  ? `${formatNumberWithCommas(state1Tomatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="tomatoes-1-kg-second-entity all-indicator-answers">
                {state2Tomatoes1Kg
                  ? `${formatNumberWithCommas(state2Tomatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="potatoes-1-kg-first-entity all-indicator-answers">
                {state1Potatoes1Kg
                  ? `${formatNumberWithCommas(state1Potatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="potatoes-1-kg-second-entity all-indicator-answers">
                {state2Potatoes1Kg
                  ? `${formatNumberWithCommas(state2Potatoes1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="lemons-1-kg-first-entity all-indicator-answers">
                {state1Lemons1Kg
                  ? `${formatNumberWithCommas(state1Lemons1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="lemons-1-kg-second-entity all-indicator-answers">
                {state2Lemons1Kg
                  ? `${formatNumberWithCommas(state2Lemons1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="onions-1-kg-first-entity all-indicator-answers">
                {state1Onions1Kg
                  ? `${formatNumberWithCommas(state1Onions1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="onions-1-kg-second-entity all-indicator-answers">
                {state2Onions1Kg
                  ? `${formatNumberWithCommas(state2Onions1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="lentils-1-kg-first-entity all-indicator-answers">
                {state1Lentils1Kg
                  ? `${formatNumberWithCommas(state1Lentils1Kg)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="lentils-1-kg-second-entity all-indicator-answers">
                {state2Lentils1Kg
                  ? `${formatNumberWithCommas(state2Lentils1Kg)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>
          </tbody>

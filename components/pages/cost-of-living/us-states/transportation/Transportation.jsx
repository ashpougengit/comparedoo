...
function Transportation({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    const state1 = state1CostInfo.state
    const state1PublicTransportPass = state1CostInfo.publicTransportPass
    const state1SinglePublicTransportTicket = state1CostInfo.singlePublicTransportTicket
    ...
    const state1ParkingFeesCityCenterPerHour = state1CostInfo.parkingFeesCityCenterPerHour
    const state1ParkingFeesOutsideCityCenterPerHour = state1CostInfo.parkingFeesOutsideCityCenterPerHour
    const state1TotalCost = (state1PublicTransportPass || 0) + (state1SinglePublicTransportTicket || 0) + (state1TrainTickets || 0) + (state1AirfareDomestic || 0) + (state1TaxiStartFare || 0) + (state1TaxiRatePerKm || 0) + (state1CarRentalPerDay || 0) + (state1ParkingFeesCityCenterPerHour || 0) + (state1ParkingFeesOutsideCityCenterPerHour || 0)

    const state2 = state2CostInfo.state
    const state2PublicTransportPass = state2CostInfo.publicTransportPass
    const state2SinglePublicTransportTicket = state2CostInfo.singlePublicTransportTicket
    ...
    const state2ParkingFeesCityCenterPerHour = state2CostInfo.parkingFeesCityCenterPerHour
    const state2ParkingFeesOutsideCityCenterPerHour = state2CostInfo.parkingFeesOutsideCityCenterPerHour
    const state2TotalCost = (state2PublicTransportPass || 0) + (state2SinglePublicTransportTicket || 0) + (state2TrainTickets || 0) + (state2AirfareDomestic || 0) + (state2TaxiStartFare || 0) + (state2TaxiRatePerKm || 0) + (state2CarRentalPerDay || 0) + (state2ParkingFeesCityCenterPerHour || 0) + (state2ParkingFeesOutsideCityCenterPerHour || 0)

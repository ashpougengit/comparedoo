...
function Clothing({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1TotalCost = (state1PairOfNikeRunningShoes || 0) + (state1MensDressShirt || 0) + (state1WomensDress || 0) + (state1SummerDress || 0) + (state1MensSuit || 0) + (state1MensJeans || 0) + (state1WomensJeans || 0) + (state1MensFormalShoes || 0) + (state1WomensFormalShoes || 0) + (state1MensCasualShoes || 0) + (state1WomensCasualShoes || 0) + (state1UnderwearMen || 0) + (state1UnderwearWomen || 0) + (state1SocksMen || 0) + (state1SocksWomen || 0) + (state1WinterCoatForAdults || 0) + (state1Sportswear || 0)
    ...
    const state2TotalCost = (state2PairOfNikeRunningShoes || 0) + (state2MensDressShirt || 0) + (state2WomensDress || 0) + (state2SummerDress || 0) + (state2MensSuit || 0) + (state2MensJeans || 0) + (state2WomensJeans || 0) + (state2MensFormalShoes || 0) + (state2WomensFormalShoes || 0) + (state2MensCasualShoes || 0) + (state2WomensCasualShoes || 0) + (state2UnderwearMen || 0) + (state2UnderwearWomen || 0) + (state2SocksMen || 0) + (state2SocksWomen || 0) + (state2WinterCoatForAdults || 0) + (state2Sportswear || 0)
...
objectFit="contain"alt="Image Describing Pair of Nike Running Shoes" />
                            ...
                            <td className="pair-of-nike-running-shoes-first-entity all-indicator-answers">
                                {state1PairOfNikeRunningShoes ? `${formatNumberWithCommas(state1PairOfNikeRunningShoes)} USD` : 'Yet to Update'}
                            </td>
                            <td className="pair-of-nike-running-shoes-second-entity all-indicator-answers">
                                {state2PairOfNikeRunningShoes ? `${formatNumberWithCommas(state2PairOfNikeRunningShoes)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Shirt" />
                            ...
                            <td className="mens-dress-shirt-first-entity all-indicator-answers">
                                {state1MensDressShirt ? `${formatNumberWithCommas(state1MensDressShirt)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mens-dress-shirt-second-entity all-indicator-answers">
                                {state2MensDressShirt ? `${formatNumberWithCommas(state2MensDressShirt)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Shirt" />
                            ...
                            <td className="womens-dress-first-entity all-indicator-answers">
                                {state1WomensDress ? `${formatNumberWithCommas(state1WomensDress)} USD` : 'Yet to Update'}
                            </td>
                            <td className="womens-dress-second-entity all-indicator-answers">
                                {state2WomensDress ? `${formatNumberWithCommas(state2WomensDress)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Summer Dress" />
                            ...
                            <td className="summer-dress-first-entity all-indicator-answers">
                                {state1SummerDress ? `${formatNumberWithCommas(state1SummerDress)} USD` : 'Yet to Update'}
                            </td>
                            <td className="summer-dress-second-entity all-indicator-answers">
                                {state2SummerDress ? `${formatNumberWithCommas(state2SummerDress)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Suit" />
                            ...
                            <td className="mens-dress-shirt-first-entity all-indicator-answers">
                                {state1MensSuit ? `${formatNumberWithCommas(state1MensSuit)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mens-dress-shirt-second-entity all-indicator-answers">
                                {state2MensSuit ? `${formatNumberWithCommas(state2MensSuit)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Jeans" />
                            ...
                            <td className="mens-jeans-first-entity all-indicator-answers">
                                {state1MensJeans ? `${formatNumberWithCommas(state1MensJeans)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mens-jeans-second-entity all-indicator-answers">
                                {state2MensJeans ? `${formatNumberWithCommas(state2MensJeans)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Jeans" />
                            ...
                            <td className="womens-jeans-first-entity all-indicator-answers">
                                {state1WomensJeans ? `${formatNumberWithCommas(state1WomensJeans)} USD` : 'Yet to Update'}
                            </td>
                            <td className="womens-jeans-second-entity all-indicator-answers">
                                {state2WomensJeans ? `${formatNumberWithCommas(state2WomensJeans)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's formal Shoes" />
                            ...
                            <td className="mens-formal-shoes-first-entity all-indicator-answers">
                                {state1MensFormalShoes ? `${formatNumberWithCommas(state1MensFormalShoes)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mens-formal-shoes-second-entity all-indicator-answers">
                                {state2MensFormalShoes ? `${formatNumberWithCommas(state2MensFormalShoes)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's formal Shoes" />
                            ...
                            <td className="women-formal-shoes-first-entity all-indicator-answers">
                                {state1WomensFormalShoes ? `${formatNumberWithCommas(state1WomensFormalShoes)} USD` : 'Yet to Update'}
                            </td>
                            <td className="women-formal-shoes-second-entity all-indicator-answers">
                                {state2WomensFormalShoes ? `${formatNumberWithCommas(state2WomensFormalShoes)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Men's Casual Shoes" />
                            ...
                            <td className="mens-casual-shoes-first-entity all-indicator-answers">
                                {state1MensCasualShoes ? `${formatNumberWithCommas(state1MensCasualShoes)} USD` : 'Yet to Update'}
                            </td>
                            <td className="mens-casual-shoes-second-entity all-indicator-answers">
                                {state2MensCasualShoes ? `${formatNumberWithCommas(state2MensCasualShoes)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Women's Casual Shoes" />
                            ...
                            <td className="women-casual-shoes-first-entity all-indicator-answers">
                                {state1WomensCasualShoes ? `${formatNumberWithCommas(state1WomensCasualShoes)} USD` : 'Yet to Update'}
                            </td>
                            <td className="women-casual-shoes-second-entity all-indicator-answers">
                                {state2WomensCasualShoes ? `${formatNumberWithCommas(state2WomensCasualShoes)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Underwear For Men" />
                            ...
                            <td className="underwear-for-men-first-entity all-indicator-answers">
                                {state1UnderwearMen ? `${formatNumberWithCommas(state1UnderwearMen)} USD` : 'Yet to Update'}
                            </td>
                            <td className="underwear-for-men-second-entity all-indicator-answers">
                                {state2UnderwearMen ? `${formatNumberWithCommas(state2UnderwearMen)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Underwear For Women" />
                            ...
                            <td className="underwear-for-women-first-entity all-indicator-answers">
                                {state1UnderwearWomen ? `${formatNumberWithCommas(state1UnderwearWomen)} USD` : 'Yet to Update'}
                            </td>
                            <td className="underwear-for-women-second-entity all-indicator-answers">
                                {state2UnderwearWomen ? `${formatNumberWithCommas(state2UnderwearWomen)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing socks For Men" />
                            ...
                            <td className="socks-for-men-first-entity all-indicator-answers">
                                {state1SocksMen ? `${formatNumberWithCommas(state1SocksMen)} USD` : 'Yet to Update'}
                            </td>
                            <td className="socks-for-men-second-entity all-indicator-answers">
                                {state2SocksMen ? `${formatNumberWithCommas(state2SocksMen)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing socks For Women" />
                            ...
                            <td className="socks-for-women-first-entity all-indicator-answers">
                                {state1SocksWomen ? `${formatNumberWithCommas(state1SocksWomen)} USD` : 'Yet to Update'}
                            </td>
                            <td className="socks-for-women-second-entity all-indicator-answers">
                                {state2SocksWomen ? `${formatNumberWithCommas(state2SocksWomen)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Wintercoat for Adults" />
                            ...
                            <td className="wintercoat-for-adults-first-entity all-indicator-answers">
                                {state1WinterCoatForAdults ? `${formatNumberWithCommas(state1WinterCoatForAdults)} USD` : 'Yet to Update'}
                            </td>
                            <td className="wintercoat-for-adults-second-entity all-indicator-answers">
                                {state2WinterCoatForAdults ? `${formatNumberWithCommas(state2WinterCoatForAdults)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
...
objectFit="contain"alt="Image Describing Sportswear" />
                            ...
                            <td className="sportswear-first-entity all-indicator-answers">
                                {state1Sportswear ? `${formatNumberWithCommas(state1Sportswear)} USD` : 'Yet to Update'}
                            </td>
                            <td className="sportswear-second-entity all-indicator-answers">
                                {state2Sportswear ? `${formatNumberWithCommas(state2Sportswear)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

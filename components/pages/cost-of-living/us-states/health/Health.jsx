...
function Health({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1PreventiveHealthScreenings = state1CostInfo.preventiveHealthScreenings
    ...
    const state1OverTheCounterMedication = state1CostInfo.overTheCounterMedication
    const state1HealthInsurancePremiums = state1CostInfo.healthInsurancePremiums
    const state1HealthInsuranceDeductibles = state1CostInfo.healthInsuranceDeductibles
    const state1TotalCost = (state1DoctorsVisit || 0) + (state1SpecialistsVisit || 0) + (state1DentistsVisit || 0) + (state1EyeExam || 0) + (state1MentalHealthCounseling || 0) + (state1PreventiveHealthScreenings || 0) + (state1PhysicalTherapy || 0) + (state1EmergencyRoomVisit || 0) + (state1HospitalStayPerNight || 0) + (state1Vaccinations || 0) + (state1PrescriptionMedication || 0) + (state1OverTheCounterMedication || 0) + (state1HealthInsurancePremiums || 0) + (state1HealthInsuranceDeductibles || 0)
    ...
    const state2PreventiveHealthScreenings = state2CostInfo.preventiveHealthScreenings
    ...
    const state2OverTheCounterMedication = state2CostInfo.overTheCounterMedication
    const state2HealthInsurancePremiums = state2CostInfo.healthInsurancePremiums
    const state2HealthInsuranceDeductibles = state2CostInfo.healthInsuranceDeductibles
    const state2TotalCost = (state2DoctorsVisit || 0) + (state2SpecialistsVisit || 0) + (state2DentistsVisit || 0) + (state2EyeExam || 0) + (state2MentalHealthCounseling || 0) + (state2PreventiveHealthScreenings || 0) + (state2PhysicalTherapy || 0) + (state2EmergencyRoomVisit || 0) + (state2HospitalStayPerNight || 0) + (state2Vaccinations || 0) + (state2PrescriptionMedication || 0) + (state2OverTheCounterMedication || 0) + (state2HealthInsurancePremiums || 0) + (state2HealthInsuranceDeductibles || 0)

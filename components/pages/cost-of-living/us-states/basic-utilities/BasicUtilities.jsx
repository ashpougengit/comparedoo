...
function BasicUtilities({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1TotalCost = (state1HomeFurnishing || 0) + (state1ElectricityCostPerMonth || 0) + (state1HeatingCostPerMonth || 0) + (state1CoolingCostPerMonth || 0) + (state1WaterCostPerMonth || 0)
    ...
    const state2TotalCost = (state2HomeFurnishing || 0) + (state2ElectricityCostPerMonth || 0) + (state2HeatingCostPerMonth || 0) + (state2CoolingCostPerMonth || 0) + (state2WaterCostPerMonth || 0)

    const furnishingCostTimes = state1HomeFurnishing > state2HomeFurnishing ? (state1HomeFurnishing / state2HomeFurnishing).toFixed(2) : (state2HomeFurnishing / state1HomeFurnishing).toFixed(2)
    const moreOrLessFurnishing = state1HomeFurnishing > state2HomeFurnishing ? 'more' : 'less'

    const percentageDifference = (((Math.abs(state1TotalCost - state2TotalCost)) / state2TotalCost) * 100).toFixed(2)
    const moreOrLessUtilities = state1TotalCost > state2TotalCost ? 'more' : 'less'
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="home-furnishing-answer-first-entity all-indicator-answers">
                                {state1HomeFurnishing ? `${formatNumberWithCommas(state1HomeFurnishing)} USD` : 'Yet to Update'}
                            </td>
                            <td className="home-furnishing-answer-second-entity all-indicator-answers">
                                {state2HomeFurnishing ? `${formatNumberWithCommas(state2HomeFurnishing)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="electricity-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1ElectricityCostPerMonth ? `${formatNumberWithCommas(state1ElectricityCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="electricity-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2ElectricityCostPerMonth ? `${formatNumberWithCommas(state2ElectricityCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/heating-cost-per-month-image.png"
                            ...
                            <td className="heating-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1HeatingCostPerMonth ? `${formatNumberWithCommas(state1HeatingCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="heating-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2HeatingCostPerMonth ? `${formatNumberWithCommas(state2HeatingCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/cooling-cost-per-month-image.png"
                            ...
                            <td className="cooling-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1CoolingCostPerMonth ? `${formatNumberWithCommas(state1CoolingCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="cooling-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2CoolingCostPerMonth ? `${formatNumberWithCommas(state2CoolingCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/water-cost-per-month-image.png"
                            ...
                            <td className="water-cost-per-month-answer-first-entity all-indicator-answers">
                                {state1WaterCostPerMonth ? `${formatNumberWithCommas(state1WaterCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                            <td className="water-cost-per-month-answer-second-entity all-indicator-answers">
                                {state2WaterCostPerMonth ? `${formatNumberWithCommas(state2WaterCostPerMonth)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <p>
                        ...
                        <strong>
                            <span className="utility-bills-calculation"> {percentageDifference}%</span> <span
                                className="utility-more-or-less-calculation"> {moreOrLessUtilities} </span></strong>
                        for Utilities.
                    </p>

                    <p>
                        The basic home furnishing in
                        <span className="first-entity-name-pages-paragraph"> {state1} </span><strong>
                            costs <span className="home-furnishing-answer-first-entity"> {furnishingCostTimes} </span> times</strong>

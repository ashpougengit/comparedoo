...
function Drinks({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1TotalCost = (state1WineMidRangeBottle || 0) + (state1GlassOfWine || 0) + (state1DomesticBeerHalfLiter || 0) + (state1ImportedBeerHalfLiter || 0) + (state1DomesticAlcohol1Liter || 0) + (state1BrandedAlcohol1Liter || 0)
    ...
    const state2TotalCost = (state2WineMidRangeBottle || 0) + (state2GlassOfWine || 0) + (state2DomesticBeerHalfLiter || 0) + (state2ImportedBeerHalfLiter || 0) + (state2DomesticAlcohol1Liter || 0) + (state2BrandedAlcohol1Liter || 0)
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="wine-mid-range-bottle-first-entity all-indicator-answers">
                                {state1WineMidRangeBottle ? `${formatNumberWithCommas(state1WineMidRangeBottle)} USD` : 'Yet to Update'}
                            </td>
                            <td className="wine-mid-range-bottle-second-entity all-indicator-answers">
                                {state2WineMidRangeBottle ? `${formatNumberWithCommas(state2WineMidRangeBottle)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="three-course-meal-for-two-first-entity all-indicator-answers">
                                {state1GlassOfWine ? `${formatNumberWithCommas(state1GlassOfWine)} USD` : 'Yet to Update'}
                            </td>
                            <td className="three-course-meal-for-two-second-entity all-indicator-answers">
                                {state2GlassOfWine ? `${formatNumberWithCommas(state2GlassOfWine)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="domestic-beer-half-liter-first-entity all-indicator-answers">
                                {state1DomesticBeerHalfLiter ? `${formatNumberWithCommas(state1DomesticBeerHalfLiter)} USD` : 'Yet to Update'}
                            </td>
                            <td className="domestic-beer-half-liter-second-entity all-indicator-answers">
                                {state2DomesticBeerHalfLiter ? `${formatNumberWithCommas(state2DomesticBeerHalfLiter)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="imported-beer-half-liter-first-entity all-indicator-answers">{state1ImportedBeerHalfLiter ? `${formatNumberWithCommas(state1ImportedBeerHalfLiter)} USD` : 'Yet to Update'}
                            </td>
                            <td className="imported-beer-half-liter-second-entity all-indicator-answers">{state2ImportedBeerHalfLiter ? `${formatNumberWithCommas(state2ImportedBeerHalfLiter)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="domestic-alcohol-1-liter-first-entity all-indicator-answers">
                                {state1DomesticAlcohol1Liter ? `${formatNumberWithCommas(state1DomesticAlcohol1Liter)} USD` : 'Yet to Update'}
                            </td>
                            <td className="domestic-alcohol-1-liter-second-entity all-indicator-answers">
                                {state2DomesticAlcohol1Liter ? `${formatNumberWithCommas(state2DomesticAlcohol1Liter)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="branded-alcohol-1-liter-first-entity all-indicator-answers">
                                {state1BrandedAlcohol1Liter ? `${formatNumberWithCommas(state1BrandedAlcohol1Liter)} USD` : 'Yet to Update'}
                            </td>
                            <td className="branded-alcohol-1-liter-second-entity all-indicator-answers">
                                {state2BrandedAlcohol1Liter ? `${formatNumberWithCommas(state2BrandedAlcohol1Liter)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>

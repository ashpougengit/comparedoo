                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="legal-consultation-per-hour-rate-first-entity all-indicator-answers">
                                {state1LegalConsultationPerHourRate ? `${formatNumberWithCommas(state1LegalConsultationPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                            <td className="legal-consultation-per-hour-rate-second-entity all-indicator-answers">
                                {state2LegalConsultationPerHourRate ? `${formatNumberWithCommas(state2LegalConsultationPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="accounting-services-per-hour-rate-first-entity all-indicator-answers">
                                {state1AccountingServicesPerHourRate ? `${formatNumberWithCommas(state1AccountingServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                            <td className="accounting-services-per-hour-rate-second-entity all-indicator-answers">
                                {state2AccountingServicesPerHourRate ? `${formatNumberWithCommas(state2AccountingServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="IT-support-services-per-hour-rate-first-entity all-indicator-answers">
                                {state1ITSupportServicesPerHourRate ? `${formatNumberWithCommas(state1ITSupportServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                            <td className="IT-support-services-per-hour-rate-second-entity all-indicator-answers">
                                {state2ITSupportServicesPerHourRate ? `${formatNumberWithCommas(state2ITSupportServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="technical-services-per-hour-rate-first-entity all-indicator-answers">
                                {state1TechnicianServicesPerHourRate ? `${formatNumberWithCommas(state1TechnicianServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                            <td className="technical-services-per-hour-rate-second-entity all-indicator-answers">
                                {state2TechnicianServicesPerHourRate ? `${formatNumberWithCommas(state2TechnicianServicesPerHourRate)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <p>
                        ...
                        Professional Services cost <strong>
                            <span className="professional-services-cost-calculation"> {costTimes} </span> times </strong> <span
                                className="professional-services-cost-more-or-less-calculation"> {moreOrLess} </span> in <span className="first-entity-name-pages-paragraph"> {state1}</span>, as compared to

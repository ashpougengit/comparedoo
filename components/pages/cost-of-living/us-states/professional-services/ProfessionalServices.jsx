...
function ProfessionalServices({
  ...
  const state1LegalConsultationPerHourRate =
    state1CostInfo.legalConsultationPerHourRate;
  const state1AccountingServicesPerHourRate =
    state1CostInfo.accountingServicesPerHourRate;
  const state1ITSupportServicesPerHourRate = parseFloat(
    state1CostInfo.ITSupportServicesPerHourRate
  );
  const state1TechnicianServicesPerHourRate =
    state1CostInfo.technicianServicesPerHourRate;
  const state1TotalCost =
    (state1LegalConsultationPerHourRate || 0) +
    (state1AccountingServicesPerHourRate || 0) +
    (state1ITSupportServicesPerHourRate || 0) +
    (state1TechnicianServicesPerHourRate || 0);

  const state2 = state2CostInfo.state;
  const state2LegalConsultationPerHourRate =
    state2CostInfo.legalConsultationPerHourRate;
  const state2AccountingServicesPerHourRate =
    state2CostInfo.accountingServicesPerHourRate;
  const state2ITSupportServicesPerHourRate = parseFloat(
    state2CostInfo.ITSupportServicesPerHourRate
  );
  const state2TechnicianServicesPerHourRate =
    state2CostInfo.technicianServicesPerHourRate;
  const state2TotalCost =
    (state2LegalConsultationPerHourRate || 0) +
    (state2AccountingServicesPerHourRate || 0) +
    (state2ITSupportServicesPerHourRate || 0) +
    (state2TechnicianServicesPerHourRate || 0);

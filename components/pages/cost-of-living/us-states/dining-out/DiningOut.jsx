...
function DiningOut({
  ...
  const state1MealAtInexpensiveRestaurant =
    state1CostInfo.mealAtInexpensiveRestaurant;
  ...
  const state1TotalCost =
    (state1MealAtInexpensiveRestaurant || 0) +
    (state1ThreeCourseMealForTwo || 0) +
    (state1FastFoodComboMeal || 0) +
    (state1Coffee || 0) +
    (state1SoftDrink || 0) +
    (state1Pizza || 0) +
    (state1TakeoutDeliveryMeal || 0) +
    (state1CigarettesPackOf20 || 0);

  const state2 = state2CostInfo.state;
  const state2MealAtInexpensiveRestaurant =
    state2CostInfo.mealAtInexpensiveRestaurant;
  ...
  const state2TotalCost =
    (state2MealAtInexpensiveRestaurant || 0) +
    (state2ThreeCourseMealForTwo || 0) +
    (state2FastFoodComboMeal || 0) +
    (state2Coffee || 0) +
    (state2SoftDrink || 0) +
    (state2Pizza || 0) +
    (state2TakeoutDeliveryMeal || 0) +
    (state2CigarettesPackOf20 || 0);
            ...
            <tr>
              ...
              <td className="three-course-meal-for-two-first-entity all-indicator-answers">
                {state1ThreeCourseMealForTwo
                  ? `${formatNumberWithCommas(state1ThreeCourseMealForTwo)} USD`
                  : 'Yet to Update'}
              </td>
              <td className="three-course-meal-for-two-second-entity all-indicator-answers">
                {state2ThreeCourseMealForTwo
                  ? `${formatNumberWithCommas(state2ThreeCourseMealForTwo)} USD`
                  : 'Yet to Update'}
              </td>
            </tr>

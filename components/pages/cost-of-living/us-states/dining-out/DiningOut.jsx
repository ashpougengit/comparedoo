                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="meal-at-a-resonable-restaurant-first-entity all-indicator-answers">
                                {state1MealAtInexpensiveRestaurant ? `${formatNumberWithCommas(state1MealAtInexpensiveRestaurant)} USD` : 'Yet to Update'}
                            </td>
                            <td className="meal-at-a-resonable-restaurant-second-entity all-indicator-answers">
                                {state2MealAtInexpensiveRestaurant ? `${formatNumberWithCommas(state2MealAtInexpensiveRestaurant)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="three-course-meal-for-two-first-entity all-indicator-answers">
                                {state1ThreeCourseMealForTwo ? `${formatNumberWithCommas(state1ThreeCourseMealForTwo)} USD` : 'Yet to Update'}
                            </td>
                            <td className="three-course-meal-for-two-second-entity all-indicator-answers">
                                {state2ThreeCourseMealForTwo ? `${formatNumberWithCommas(state2ThreeCourseMealForTwo)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="fast-food-combo-meal-first-entity all-indicator-answers">
                                {state1FastFoodComboMeal ? `${formatNumberWithCommas(state1FastFoodComboMeal)} USD` : 'Yet to Update'}
                            </td>
                            <td className="fast-food-combo-meal-second-entity all-indicator-answers">
                                {state2FastFoodComboMeal ? `${formatNumberWithCommas(state2FastFoodComboMeal)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="coffee-first-entity all-indicator-answers">
                                {state1Coffee ? `${formatNumberWithCommas(state1Coffee)} USD` : 'Yet to Update'}
                            </td>
                            <td className="coffee-second-entity all-indicator-answers">
                                {state2Coffee ? `${formatNumberWithCommas(state2Coffee)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="soft-drink-first-entity all-indicator-answers">
                                {state1SoftDrink ? `${formatNumberWithCommas(state1SoftDrink)} USD` : 'Yet to Update'}
                            </td>
                            <td className="soft-drink-second-entity all-indicator-answers">
                                {state2SoftDrink ? `${formatNumberWithCommas(state2SoftDrink)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="pizza-first-entity all-indicator-answers">
                                {state1Pizza ? `${formatNumberWithCommas(state1Pizza)} USD` : 'Yet to Update'}
                            </td>
                            <td className="pizza-second-entity all-indicator-answers">
                                {state2Pizza ? `${formatNumberWithCommas(state2Pizza)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="take-out-delivery-meal-first-entity all-indicator-answers">
                                {state1TakeoutDeliveryMeal ? `${formatNumberWithCommas(state1TakeoutDeliveryMeal)} USD` : 'Yet to Update'}
                            </td>
                            <td className="take-out-delivery-meal-second-entity all-indicator-answers">
                                {state2TakeoutDeliveryMeal ? `${formatNumberWithCommas(state2TakeoutDeliveryMeal)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="cigarettes-pack-first-entity all-indicator-answers">
                                {state1CigarettesPackOf20 ? `${formatNumberWithCommas(state1CigarettesPackOf20)} USD` : 'Yet to Update'}
                            </td>
                            <td className="cigarettes-pack-second-entity all-indicator-answers">
                                {state2CigarettesPackOf20 ? `${formatNumberWithCommas(state2CigarettesPackOf20)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <span className="dining-out-more-less-calculation"> {moreOrLess} </span> in

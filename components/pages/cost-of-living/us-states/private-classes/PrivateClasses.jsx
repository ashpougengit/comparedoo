...
function PrivateClasses({ state1CostInfo, state2CostInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1TotalCost = (state1LanguageClasses || 0) + (state1ParentingClasses || 0) + (state1ArtClasses || 0) + (state1FitnessClass || 0) + (state1MusicLessons || 0) + (state1DanceLessons || 0) + (state1ReadingMaterials || 0) + (state1EducationalSoftware || 0)
    ...
    const state2TotalCost = (state2LanguageClasses || 0) + (state2ParentingClasses || 0) + (state2ArtClasses || 0) + (state2FitnessClass || 0) + (state2MusicLessons || 0) + (state2DanceLessons || 0) + (state2ReadingMaterials || 0) + (state2EducationalSoftware || 0)
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="language-classes-first-entity all-indicator-answers">
                                {state1LanguageClasses ? `${formatNumberWithCommas(state1LanguageClasses)} USD` : 'Yet to Update'}
                            </td>
                            <td className="language-classes-second-entity all-indicator-answers">
                                {state2LanguageClasses ? `${formatNumberWithCommas(state2LanguageClasses)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="parenting-classes-first-entity all-indicator-answers">
                                {state1ParentingClasses ? `${formatNumberWithCommas(state1ParentingClasses)} USD` : 'Yet to Update'}
                            </td>
                            <td className="parenting-classes-second-entity all-indicator-answers">
                                {state2ParentingClasses ? `${formatNumberWithCommas(state2ParentingClasses)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="art-classes-first-entity all-indicator-answers">
                                {state1ArtClasses ? `${formatNumberWithCommas(state1ArtClasses)} USD` : 'Yet to Update'}
                            </td>
                            <td className="art-classes-second-entity all-indicator-answers">
                                {state2ArtClasses ? `${formatNumberWithCommas(state2ArtClasses)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="fitness-class-first-entity all-indicator-answers">
                                {state1FitnessClass ? `${formatNumberWithCommas(state1FitnessClass)} USD` : 'Yet to Update'}
                            </td>
                            <td className="fitness-class-second-entity all-indicator-answers">
                                {state2FitnessClass ? `${formatNumberWithCommas(state2FitnessClass)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="music-lessons-first-entity all-indicator-answers">
                                {state1MusicLessons ? `${formatNumberWithCommas(state1MusicLessons)} USD` : 'Yet to Update'}
                            </td>
                            <td className="music-lessons-second-entity all-indicator-answers">
                                {state2MusicLessons ? `${formatNumberWithCommas(state2MusicLessons)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="dance-lessons-first-entity all-indicator-answers">
                                {state1DanceLessons ? `${formatNumberWithCommas(state1DanceLessons)} USD` : 'Yet to Update'}
                            </td>
                            <td className="dance-lessons-second-entity all-indicator-answers">
                                {state2DanceLessons ? `${formatNumberWithCommas(state2DanceLessons)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td className="reading-materials-first-entity all-indicator-answers">
                                {state1ReadingMaterials ? `${formatNumberWithCommas(state1ReadingMaterials)} USD` : 'Yet to Update'}
                            </td>
                            <td className="reading-materials-second-entity all-indicator-answers">
                                {state2ReadingMaterials ? `${formatNumberWithCommas(state2ReadingMaterials)} USD` : 'Yet to Update'}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/educational-software-image.png"
                                        fill alt="Image Describing Educational Software" />
                                </div>
                            </td>

                            <td className="educational-software-first-entity all-indicator-answers">
                                {state1EducationalSoftware ? `${formatNumberWithCommas(state1EducationalSoftware)} USD` : 'Yet to Update'}
                            </td>
                            <td className="educational-software-second-entity all-indicator-answers">
                                {state2EducationalSoftware ? `${formatNumberWithCommas(state2EducationalSoftware)} USD` : 'Yet to Update'}
                            </td>
                        </tr>

...
function WagesAndTaxes({ state1CostInfo, state2CostInfo, entity1PropertyAndIncomeTaxInfo, entity2PropertyAndIncomeTaxInfo, state1LowerCase, state2LowerCase }) {
    ...
    const state1SocialSecurityContributions = state1CostInfo.socialSecurityContributions
    ...
    const state1TotalCost = (state1AverageGrossSalary || 0) + (state1AverageNetSalary || 0) + (state1MinimumWage || 0) + (state1AverageBonus || 0) + (state1MedianHouseholdIncome || 0)
    ...
    const state2SocialSecurityContributions = state2CostInfo.socialSecurityContributions
    ...
    const state2TotalCost = (state2AverageGrossSalary || 0) + (state2AverageNetSalary || 0) + (state2MinimumWage || 0) + (state2AverageBonus || 0) + (state2MedianHouseholdIncome || 0)

...
objectFit="contain"alt="Image indicating the major religion percentage of any country" />
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>The people of <span className="first-entity-name-pages-paragraph"> {country} </span>
                        are called <strong> <span className="demonyms-answer-first-entity"> {demonyms}</span></strong>.
                    </p>

                    <p>The major religion of <span className="first-entity-name-pages-paragraph"> {country} </span> is <strong><span
                        className="major-religion-answer-first-entity"> {majorReligion}</span></strong>. Around <span
                            className="major-religion-percentage-answer-first-entity"> {majorReligionPercentage}% </span> of people in <span
                                className="first-entity-name-pages-paragraph"> {country} </span> follow <span
                                    className="major-religion-answer-first-entity"> {majorReligion}</span>.
                    </p>
                </div>
            </div>

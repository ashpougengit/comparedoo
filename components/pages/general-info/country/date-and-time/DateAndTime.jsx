        ...
        <>
                ...
                <table className="indicators-single-country-divs">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="current-date-answer-first-entity all-indicator-answers">{currentDate ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="current-time-answer-first-entity all-indicator-answers">{currentTime ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/timezone-image.png" fill alt="Visual representation of timezones of any specific country" />
                                </div>
                            </td>
                            <td className="timezones-first-entity all-indicator-answers">{renderTimezones(totalTimezonesArray) ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="current-timezone-answer-first-entity all-indicator-answers">{renderTimezones(currentTimezoneArray) ?? 'Yet to Update'}
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="dst-timezone-answer-first-entity all-indicator-answers">{DST ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="dst-start-answer-first-entity all-indicator-answers">{DSTStart ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="dst-end-answer-first-entity all-indicator-answers">{DSTEnd ?? 'Yet to Update'}</td>
                        ...
                        <tr>
                            ...
                            <td className="dst-duration-answer-first-entity all-indicator-answers">{DSTDuration ?? 'Yet to Update'}</td>
            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    {weatherInfo &&
                        <p>The current time and date in <strong> <span className="first-entity-name-pages-paragraph"> {country} </span></strong>
                            is <strong> [ <span className="current-time-answer-first-entity">{currentTime}</span> ], [ <span
                                className="current-date-answer-first-entity">{currentDate}</span> ]. </strong>
                        </p>
                    }

                    {DST === "DST Not Observed" ? (
                        <>
                            <p><span className="first-entity-name-pages-paragraph">{country} </span> doesn&apos;t observe Daylight Saving Time. The current{' '}
                                {multipleTimezones ? 'timezones' : 'timezone'}{' '}
                                in {country} {multipleTimezones ? 'are' : 'is'} <strong><span className="current-timezone-answer-first-entity">{currentTimezone.replaceAll('<br />', 'and')}</span>.</strong>
                            </p>
                        </>
                    ) : (
                        <>
                            <p><span className="first-entity-name-pages-paragraph">{country} </span> observes Daylight Saving Time. The current{' '}
                                {multipleTimezones ? 'timezones' : 'timezone'}{' '}
                                in {country} {multipleTimezones ? 'are' : 'is'} <strong><span className="current-timezone-answer-first-entity">{currentTimezone.replaceAll('<br />', 'and')}</span>.</strong>{' '}
                                The Daylight Saving Time in <span className="first-entity-name-pages-paragraph"> {country} </span> starts on <strong>
                                    <span className="dst-start-answer-first-entity"> {DSTStart}</span></strong>, and ends on <strong><span
                                        className="dst-end-answer-second-entity"> {DSTEnd}</span></strong>. The total DST Duration is
                                <strong><span className="dst-duration-answer-first-entity"> {DSTDuration}</span></strong>.
                            </p>
                        </>
                    )}
                </div>

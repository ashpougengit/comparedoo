    ...
    <>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="fertility-ratio-answer-first-entity all-indicator-answers">
                {fertilityRate ? (
                  <>
                    {fertilityRate} <span><br /> (Births Per
                      Woman)</span>
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="death-rate-male-answer-first-entity all-indicator-answers">
                {mortalityRateMale ? (
                  <>
                    {mortalityRateMale} <span><br /> (Per 1000 Male
                      Adults)</span>
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="death-rate-female-answer-first-entity all-indicator-answers">
                {mortalityRateFemale ? (
                  <>
                    {mortalityRateFemale} <span><br /> (Per 1000 Female
                      Adults)</span>
                  </>
                ) : 'Yet to Update'}
              </td>
            ...
            <tr>
              ...
              <td className="infant-mortality-rate-answer-first-entity all-indicator-answers">
                {infantMortalityRate ? (
                  <>
                    {infantMortalityRate} <span><br /> (Per 1000 Live
                      Births)</span>
                  </>
                ) : 'Yet to Update'}
              </td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="leading-cause-of-death-answer-first-entity all-indicator-answers">
                {topCauseOfDeath ? (
                  <>
                    {topCauseOfDeath} <span> <br />
                      (</span>{topCauseOfDeathNumber ? (
                        <>
                          <span className="leading-cause-of-death-answer-number-first-entity">{topCauseOfDeathNumber}</span> people
                          per 100K
                          population
                        </>
                      ) : ''})
            ...
            <tr>
              ...
              <td className="least-cause-of-death-answer-first-entity all-indicator-answers">
                {lowestCauseOfDeath ? (
                  <>
                    {lowestCauseOfDeath} <span> <br />
                      (</span>{lowestCauseOfDeathNumber ? (
                        <>
                          <span className="least-cause-of-death-answer-number-first-entity">{lowestCauseOfDeathNumber}</span> people
                          per 100K
                          population
                        </>
                      ) : ''})
            ...
            <tr>
              ...
              <td className="suicide-death-answer-first-entity all-indicator-answers">{suicideDeaths ? (
                <>
                  {suicideDeaths} <br />(<span
            ...
            <tr>
              ...
              <td className="new-hiv-infections-answer-first-entity all-indicator-answers">{numberOfNewHIVInfections ? (
                <>
                  {numberOfNewHIVInfections} <br />(<span
      ...
      <div className="paragraph-for-pages-below-table">
        <div className="para-for-pages-single-div">
          <p>The leading cause of death in <strong><span className="first-entity-name-pages-paragraph"> {country}</span>,
          </strong>
            is <strong> [ <span className="leading-cause-of-death-answer-first-entity">{topCauseOfDeath}</span> ]. </strong> Around
            <strong> <span className="leading-cause-of-death-answer-number-first-entity"> {topCauseOfDeathNumber} </span> people per 100,000
              people </strong> in <strong><span className="first-entity-name-pages-paragraph"> {country}</span>,
            </strong> are dying of <span className="leading-cause-of-death-answer-first-entity"> {topCauseOfDeath}</span>.
          </p>
        ...
        <table className="indicators-single-country-divs">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="prevalence-of-hypertension-answer-first-entity all-indicator-answers">{prevalenceOfHypertensionPercentage ? (
                <>
                  {prevalenceOfHypertensionPercentage}% <br />(<span
            ...
            <tr>
              ...
              <td className="adult-obesity-answer-first-entity all-indicator-answers">{adultObesityPercentage ? (
                <>
                  {adultObesityPercentage}% <br />(<span
            ...
            <tr>
              ...
              <td className="tobacco-consumption-answer-first-entity all-indicator-answers">{tobaccoConsumptionPercentage ? (
                <>
                  {tobaccoConsumptionPercentage}%
                  <br />(<span className="tobacco-consumption-no-change">Used by people aged 15 and above)</span>
                </>
              ) : 'Yet to Update'}</td>
            </tr>
          </tbody>

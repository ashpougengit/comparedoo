            ...
            <div className="paragraph-for-pages-below-table">
                <div className="para-for-pages-single-div">
                    ...
                    <p>
                        ...
                        <strong>
                            <span className="first-entity-name-pages-paragraph"> {country} </span> </strong>as of {lastYear} is estimated to be
                        around
                        <strong>
                            <span className="population-of-first-entity-name"> {popString}</span></strong>.
                    </p>

                    <p>
                        Over the past decade, <span className="first-entity-name-pages-paragraph"> {country} </span> has experienced an average population growth rate of <strong><span className="population-growth-precentage-annually"> {popGrowthRate}</span>%.</strong>
                    </p>
            ...
            <div className="population-comparison-layout">
                <div className="first-entity-population-comparison">
                    <div className="first-entity-map-text-flag-population-comparison">
                        ...
                        <div className="first-entity-name-population-comparison">{country}</div>

                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/national-flower-image.png" fill alt="Visual representation of state flower of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/national-sport-image.png" fill alt="Visual representation of national sport of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/state-tree-image.png" fill alt="Visual representation of national colors of any specific country" />
                                </div>
                            </td>

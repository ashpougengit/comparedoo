                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/current-date-image.png" fill alt="Visual representation of current date of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/current-timezone-image.png" fill alt="Visual representation of current timezone of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/internet-tld-image.png" fill alt="Visual representation of Daylight Saving Time of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Daylight Saving Time Start</div>
                                <div className="basic-information-images">
                                    <Image src="/images/dst-start-image.png" fill alt="Visual representation of Daylight Saving Time Start of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/dst-end-image.png" fill alt="Visual representation of Daylight Saving Time End of any specific country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Daylight Saving Time Duration</div>
                                <div className="basic-information-images">
                                    <Image src="/images/dst-duration-image.png" fill alt="Visual representation of Daylight Saving Time Duration of any specific country" />
                                </div>
                            </td>
                ...
                <div className="para-for-pages-single-div">
                    {weatherInfo &&
                        <p>
                            ...
                            <strong>
                                [
                                <span className="current-time-answer-first-entity"> {currentTime}</span>
                                ], [
                    ...
                    {DSTStart === "DST Not Observed" && (
                        <>
                            <p>
                                ...
                                doesn&apos;t
                                observe Daylight Saving Time. The current {multipleTimezones ? 'timezones' : 'timezone'} in {' '}{state}{' '} {multipleTimezones ? 'are' : 'is'}{' '}
                                <strong>
                    ...
                    {DSTStart != "DST Not Observed" && (
                        <>
                            <p>
                                <span className="first-entity-name-pages-paragraph">{state}{' '} </span>
                                observes Daylight Saving Time. The current {multipleTimezones ? 'timezones' : 'timezone'} in {' '}{state}{' '} {multipleTimezones ? 'are' : 'is'}
                                <strong>
                                    <span className="current-timezone-answer-first-entity">
                                        {' '} {currentTimezone.replaceAll('<br />', 'and')}
                                    </span>

                    ...
                    <tbody>
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/motto-latin-image.png" fill alt="Visual representation of official name of any country" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/motto-english-image.png" fill alt="Visual representation of all continents in the world" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/national-anthem-native-image.png" fill alt="Image Depicting whether the status is landlocked or not." />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                ...
                                <div className="basic-information-images">
                                    <Image src="/images/largest-city-image.png" fill alt="Visual representation of a largest city of any specific state" />
                                </div>
                            </td>
                        ...
                        <tr>
                            <td className="basic-info">
                                <div className="all-indicators">Internet TLD or Official Website</div>
                                <div className="basic-information-images">
                                    <Image src="/images/internet-tld-image.png" fill alt="Image depicting Internet Top Level Domain also called tld of any specific country" />
                                </div>
                            </td>

...
export async function GET(request) {
  ...
  const weatherInfo = fetchWeatherInfo(city1, country1Code, city1Code, city2, country2Code, city2Code)
    return NextResponse.json({ weatherInfo: weatherInfo }, { status: 200 });
  }